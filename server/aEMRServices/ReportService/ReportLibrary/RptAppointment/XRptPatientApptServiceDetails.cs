...
{
    public partial class XRptPatientApptServiceDetails : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptPatientApptServiceDetails()
        {
            InitializeComponent();
        }

        private void XRptPatientApptServiceDetails_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            FillData();
        }

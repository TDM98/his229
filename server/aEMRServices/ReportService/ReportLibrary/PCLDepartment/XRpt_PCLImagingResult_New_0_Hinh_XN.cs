...
{
    public partial class XRpt_PCLImagingResult_New_0_Hinh_XN : DevExpress.XtraReports.UI.XtraReport
    {
        public XRpt_PCLImagingResult_New_0_Hinh_XN()
        {
            InitializeComponent();
        }
        ...
        {
            ((XRpt_PCLImagingResult_New_0_Hinh_XN_SubReport)((XRSubreport)sender).ReportSource).PCLImgResultID.Value = Convert.ToInt64(PCLImgResultID.Value);
            ((XRpt_PCLImagingResult_New_0_Hinh_XN_SubReport)((XRSubreport)sender).ReportSource).V_PCLRequestType.Value = Convert.ToInt64(V_PCLRequestType.Value);

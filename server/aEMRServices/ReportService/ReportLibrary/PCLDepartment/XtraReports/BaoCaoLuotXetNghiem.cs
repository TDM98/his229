...
{
    public partial class BaoCaoLuotXetNghiem : DevExpress.XtraReports.UI.XtraReport
    {
        public BaoCaoLuotXetNghiem()
        {
            InitializeComponent();
        }
        ...
        private void BaoCaoLuotXetNghiem_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            FillData();
        }
    }

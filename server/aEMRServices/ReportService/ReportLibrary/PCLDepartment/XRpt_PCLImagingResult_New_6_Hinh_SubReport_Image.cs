...
{
    public partial class XRpt_PCLImagingResult_New_6_Hinh_SubReport_Image : DevExpress.XtraReports.UI.XtraReport
    {
        public XRpt_PCLImagingResult_New_6_Hinh_SubReport_Image()
        {
            InitializeComponent();
        }

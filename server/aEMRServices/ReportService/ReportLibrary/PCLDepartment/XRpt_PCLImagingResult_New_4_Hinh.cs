...
{
    public partial class XRpt_PCLImagingResult_New_4_Hinh : DevExpress.XtraReports.UI.XtraReport
    {
        public XRpt_PCLImagingResult_New_4_Hinh()
        {
            InitializeComponent();
        }
        ...
        private void xrSubreport1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ((XRpt_PCLImagingResult_New_4_Hinh_SubReport_V2)((XRSubreport)sender).ReportSource).PCLImgResultID.Value = Convert.ToInt64(PCLImgResultID.Value);
            ((XRpt_PCLImagingResult_New_4_Hinh_SubReport_V2)((XRSubreport)sender).ReportSource).V_PCLRequestType.Value = Convert.ToInt64(V_PCLRequestType.Value);
        ...
        {
            ((XRpt_PCLImagingResult_New_4_Hinh_SubReport_Image)((XRSubreport)sender).ReportSource).PCLImgResultID.Value = Convert.ToInt64(PCLImgResultID.Value);
            ((XRpt_PCLImagingResult_New_4_Hinh_SubReport_Image)((XRSubreport)sender).ReportSource).V_PCLRequestType.Value = Convert.ToInt64(V_PCLRequestType.Value);
        }
    }
}

...
{
    public partial class XRpt_PCLImagingResult_New_1_Hinh_XN_SubReport_Image : DevExpress.XtraReports.UI.XtraReport
    {
        public XRpt_PCLImagingResult_New_1_Hinh_XN_SubReport_Image()
        {
            InitializeComponent();
        }

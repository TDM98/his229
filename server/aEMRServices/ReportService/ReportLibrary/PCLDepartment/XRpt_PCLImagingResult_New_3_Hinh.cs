...
{
    public partial class XRpt_PCLImagingResult_New_3_Hinh : DevExpress.XtraReports.UI.XtraReport
    {
        public XRpt_PCLImagingResult_New_3_Hinh()
        {
            InitializeComponent();
        }
        ...
        {
            ((XRpt_PCLImagingResult_New_3_Hinh_SubReport_Image)((XRSubreport)sender).ReportSource).PCLImgResultID.Value = Convert.ToInt64(PCLImgResultID.Value);
            ((XRpt_PCLImagingResult_New_3_Hinh_SubReport_Image)((XRSubreport)sender).ReportSource).V_PCLRequestType.Value = Convert.ToInt64(V_PCLRequestType.Value);
        }
    }
}

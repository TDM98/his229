...
{
    public partial class XRpt_PCLImagingResult_New_1_Hinh_XN_SubReport : DevExpress.XtraReports.UI.XtraReport
    {
        public XRpt_PCLImagingResult_New_1_Hinh_XN_SubReport()
        {
            InitializeComponent();
        }

...
{
    public partial class XRpt_PCLImagingResult_New_4_Hinh_SubReport_Image : DevExpress.XtraReports.UI.XtraReport
    {
        public XRpt_PCLImagingResult_New_4_Hinh_SubReport_Image()
        {
            InitializeComponent();
        }

...
{
    public partial class XRpt_PCLImagingResult_New_0_Hinh_XN_SubReport : DevExpress.XtraReports.UI.XtraReport
    {
        public XRpt_PCLImagingResult_New_0_Hinh_XN_SubReport()
        {
            InitializeComponent();
        }

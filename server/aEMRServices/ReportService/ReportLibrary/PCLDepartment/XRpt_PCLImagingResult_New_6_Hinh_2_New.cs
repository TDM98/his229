...
{
    public partial class XRpt_PCLImagingResult_New_6_Hinh_2_New : DevExpress.XtraReports.UI.XtraReport
    {
        public XRpt_PCLImagingResult_New_6_Hinh_2_New()
        {
            InitializeComponent();
        }
        ...
        private void xrSubreport1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ((XRpt_PCLImagingResult_New_6_Hinh_New_SubReport_V2_C1)((XRSubreport)sender).ReportSource).PCLImgResultID.Value = Convert.ToInt64(PCLImgResultID.Value);
            ((XRpt_PCLImagingResult_New_6_Hinh_New_SubReport_V2_C1)((XRSubreport)sender).ReportSource).V_PCLRequestType.Value = Convert.ToInt64(V_PCLRequestType.Value);
        }
        private void xrSubreport2_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ((XRpt_PCLImagingResult_New_6_Hinh_New_SubReport_V2_C2)((XRSubreport)sender).ReportSource).PCLImgResultID.Value = Convert.ToInt64(PCLImgResultID.Value);
            ((XRpt_PCLImagingResult_New_6_Hinh_New_SubReport_V2_C2)((XRSubreport)sender).ReportSource).V_PCLRequestType.Value = Convert.ToInt64(V_PCLRequestType.Value);
        }
        private void XRpt_PCLImagingResult_New_6_Hinh_New_AfterPrint(object sender, EventArgs e)
        {

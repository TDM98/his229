...
{
    public partial class XRpt_PCLImagingResult_New_1_Hinh_SubReport_V2 : DevExpress.XtraReports.UI.XtraReport
    {
        public XRpt_PCLImagingResult_New_1_Hinh_SubReport_V2()
        {
            InitializeComponent();
        }

...
{
    public partial class XRpt_PCLImagingResult_New_Xet_Nghiem_V2_SubReport : DevExpress.XtraReports.UI.XtraReport
    {
        public XRpt_PCLImagingResult_New_Xet_Nghiem_V2_SubReport()
        {
            InitializeComponent();
        }

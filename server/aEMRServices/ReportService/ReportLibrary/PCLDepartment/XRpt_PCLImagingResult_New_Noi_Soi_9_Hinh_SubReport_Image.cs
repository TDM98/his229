...
{
    public partial class XRpt_PCLImagingResult_New_Noi_Soi_9_Hinh_SubReport_Image : DevExpress.XtraReports.UI.XtraReport
    {
        public XRpt_PCLImagingResult_New_Noi_Soi_9_Hinh_SubReport_Image()
        {
            InitializeComponent();
        }

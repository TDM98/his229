...
{
    public partial class XRptBC_HoanTienTamUngNoiTru : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptBC_HoanTienTamUngNoiTru()
        {
            InitializeComponent();
        ...
        {
            dsXRptBC_HoanTienTamUngNoiTru1.EnforceConstraints = false;
            spXRptBC_HoanTienTamUngNoiTruTableAdapter.Fill(dsXRptBC_HoanTienTamUngNoiTru1.spXRptBC_HoanTienTamUngNoiTru

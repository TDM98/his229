...
{
    public partial class XRptBC_ThuTienVienPhiNgoaiTru : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptBC_ThuTienVienPhiNgoaiTru()
        {
            InitializeComponent();
        ...
        {
            dsXRptBC_ThuTienVienPhiNgoaiTru1.EnforceConstraints = false;
            spXRptBC_ThuTienVienPhiNgoaiTruTableAdapter.Fill(dsXRptBC_ThuTienVienPhiNgoaiTru1.spXRptBC_ThuTienVienPhiNgoaiTru

...
{
    public partial class XRptBC_HoanTienVienPhiNgoaiTru : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptBC_HoanTienVienPhiNgoaiTru()
        {
            InitializeComponent();
        ...
        {
            dsXRptBC_HoanTienVienPhiNgoaiTru1.EnforceConstraints = false;
            spXRptBC_HoanTienVienPhiNgoaiTruTableAdapter.Fill(dsXRptBC_HoanTienVienPhiNgoaiTru1.spXRptBC_HoanTienVienPhiNgoaiTru

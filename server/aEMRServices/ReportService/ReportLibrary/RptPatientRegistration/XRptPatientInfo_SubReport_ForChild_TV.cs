...
{
    public partial class XRptPatientInfo_SubReport_ForChild_TV : XtraReport
    {
        public XRptPatientInfo_SubReport_ForChild_TV()
        {
            InitializeComponent();
        }

        private void XRptPatientInfo_SubReport_ForChild_TV_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {

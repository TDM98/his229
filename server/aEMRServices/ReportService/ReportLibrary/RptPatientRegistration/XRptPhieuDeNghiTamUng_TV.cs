...
{
    public sealed partial class XRptPhieuDeNghiTamUng_TV : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptPhieuDeNghiTamUng_TV()
        {
            InitializeComponent();

            BeforePrint += XRptPhieuDeNghiTamUng_TV_BeforePrint;
            PrintingSystem.ShowPrintStatusDialog = false;
        }

        void XRptPhieuDeNghiTamUng_TV_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            FillData();
        }

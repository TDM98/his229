...
{
    public partial class XRptOutPatientReceiptAuto_V4 : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptOutPatientReceiptAuto_V4()
        {
        ...
        void XRptPatientPayment_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            Parameters["parTotalPTPaymentBeforeVAT"].Value = totalBN.ToString("N0") + string.Format(" {0}", eHCMSResources.G1616_G1_VND.ToLower());

...
{
    public partial class RptMedicalFilesList : DevExpress.XtraReports.UI.XtraReport
    {
        public RptMedicalFilesList()
        {
            InitializeComponent();
        }

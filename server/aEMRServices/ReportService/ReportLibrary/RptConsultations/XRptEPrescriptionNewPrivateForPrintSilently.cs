...
{
    public partial class XRptEPrescriptionNewPrivateForPrintSilently : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptEPrescriptionNewPrivateForPrintSilently()
        {
            InitializeComponent();
        }
        ...
        private void XRptEPrescriptionNewPrivateForPrintSilently_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            FillData();
        }

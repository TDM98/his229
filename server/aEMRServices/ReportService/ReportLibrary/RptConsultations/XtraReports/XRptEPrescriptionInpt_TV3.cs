...
{
    public partial class XRptEPrescriptionInpt_TV3 : XtraReport
    {
        public XRptEPrescriptionInpt_TV3()
        {
            InitializeComponent();
        }
        ...
        {
            ((XRptEPrescriptionNew_InPt_V2_TV)((XRSubreport)sender).ReportSource).Parameters["parIssueID"].Value = Convert.ToInt32(parIssueID.Value.ToString());
            ((XRptEPrescriptionNew_InPt_V2_TV)((XRSubreport)sender).ReportSource).FilterString = FilterString;
        }

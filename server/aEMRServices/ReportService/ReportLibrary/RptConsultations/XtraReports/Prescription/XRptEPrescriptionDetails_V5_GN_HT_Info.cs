...
{
    public partial class XRptEPrescriptionDetails_V5_GN_HT_Info : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptEPrescriptionDetails_V5_GN_HT_Info()
        {
            InitializeComponent();
        }
        ...
        private void FillData()
        {
            ...
            if (parIssueID.Value.ToString().Substring(parIssueID.Value.ToString().Length - 1, 1) == "4")
            {
        ...
        private void XRptEPrescription_TV_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (monthnew <= 1)
            {
                xrLabel40.Text = "" + DOB.Day.ToString() + " Ngày (NS:" + DOB.Year + ")";
            }
            else if(monthnew <= 72)
            {

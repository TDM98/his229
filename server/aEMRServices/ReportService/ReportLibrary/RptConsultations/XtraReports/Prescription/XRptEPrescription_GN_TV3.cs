...
{
    public partial class XRptEPrescription_GN_TV3 : XtraReport
    {
        public XRptEPrescription_GN_TV3()
        {
            InitializeComponent();
        }
        ...
        {
            ((XRptEPrescriptionDetails_GN_HT_TV)((XRSubreport)sender).ReportSource).Parameters["parIssueID"].Value = Convert.ToInt32(parIssueID.Value.ToString());
            ((XRptEPrescriptionDetails_GN_HT_TV)((XRSubreport)sender).ReportSource).FilterString = FilterString;
            ((XRptEPrescriptionDetails_GN_HT_TV)((XRSubreport)sender).ReportSource).parIsPsychotropicDrugs = parIsPsychotropicDrugs;
            ((XRptEPrescriptionDetails_GN_HT_TV)((XRSubreport)sender).ReportSource).parIsFuncfoodsOrCosmetics = parIsFuncfoodsOrCosmetics;
        }

...
{
    public partial class XRptEPrescription_V2_SubReport_TV3 : XtraReport
    {
        public XRptEPrescription_V2_SubReport_TV3()
        {
            InitializeComponent();
        }
        ...
        private void xrSubreport1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ((XRptEPrescription_TV3)((XRSubreport)sender).ReportSource).FilterString = "[RefGenDrugCatID_1] != 2 && [RefGenDrugCatID_1] != 4 && [RefGenDrugCatID_1] != 5 && [RefGenDrugCatID_1] != 6"; // toa thuốc gây nghiện, toa thuốc khác hướng thần
            ...
            ((XRptEPrescription_TV3)((XRSubreport)sender).ReportSource).parDepartmentOfHealth.Value = parDepartmentOfHealth.Value.ToString();
            ((XRptEPrescription_TV3)((XRSubreport)sender).ReportSource).parHospitalAddress.Value = parHospitalAddress.Value.ToString();
            ((XRptEPrescription_TV3)((XRSubreport)sender).ReportSource).parHospitalName.Value = parHospitalName.Value.ToString();
            ((XRptEPrescription_TV3)((XRSubreport)sender).ReportSource).parKBYTLink.Value = parKBYTLink.Value.ToString();
        }
        ...
        private void xrSubreport3_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ((XRptEPrescription_TV3)((XRSubreport)sender).ReportSource).Parameters["parIssueID"].Value = Convert.ToInt32(parIssueIDstr); // erro cast
            ((XRptEPrescription_TV3)((XRSubreport)sender).ReportSource).FilterString = "[RefGenDrugCatID_1] = 5 || [RefGenDrugCatID_1] = 6"; // toa thuốc chứa TPCN/MP
            //Set biến để report kiểm tra xem có thực phẩm chức năng/ mỹ phẩm không.
            ((XRptEPrescription_TV3)((XRSubreport)sender).ReportSource).parIsFuncfoodsOrCosmetics = parIsFuncfoodsOrCosmetics;
            ((XRptEPrescription_TV3)((XRSubreport)sender).ReportSource).parHospitalCode.Value = parHospitalCode.Value.ToString();
            ((XRptEPrescription_TV3)((XRSubreport)sender).ReportSource).parPrescriptionMainRightHeader.Value = parPrescriptionMainRightHeader.Value.ToString();
            ((XRptEPrescription_TV3)((XRSubreport)sender).ReportSource).parPrescriptionSubRightHeader.Value = parPrescriptionSubRightHeader.Value.ToString();
            ((XRptEPrescription_TV3)((XRSubreport)sender).ReportSource).parDepartmentOfHealth.Value = parDepartmentOfHealth.Value.ToString();

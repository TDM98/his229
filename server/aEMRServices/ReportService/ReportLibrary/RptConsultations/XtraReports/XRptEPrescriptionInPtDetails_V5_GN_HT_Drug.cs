...
{
    public partial class XRptEPrescriptionInPtDetails_V5_GN_HT_Drug : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptEPrescriptionInPtDetails_V5_GN_HT_Drug()
        {
            InitializeComponent();
        }
        ...
        private void FillData()
        {
            ...
            spPrescriptions_RptViewByPrescriptID_InPtTableAdapter.Fill(dsPrescriptionNew_InPt1.spPrescriptions_RptViewByPrescriptID_InPt, Convert.ToInt32(Str1), false, true);
        }

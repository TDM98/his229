...
{
    public partial class XRptEPrescriptionInpt_V4 : XtraReport
    {
        public XRptEPrescriptionInpt_V4()
        {
            InitializeComponent();
        }
        ...
        {
            ((XRptEPrescriptionInPtDetails_V4_Drug)((XRSubreport)sender).ReportSource).Parameters["parIssueID"].Value = Convert.ToInt32(parIssueID.Value.ToString());
            ((XRptEPrescriptionInPtDetails_V4_Drug)((XRSubreport)sender).ReportSource).FilterString = FilterString;
        }
        ...
        {
            ((XRptEPrescriptionInPtDetails_V4_Info)((XRSubreport)sender).ReportSource).Parameters["parIssueID"].Value = Convert.ToInt32(parIssueID.Value.ToString());
            ((XRptEPrescriptionInPtDetails_V4_Info)((XRSubreport)sender).ReportSource).FilterString = FilterString;
        }
    }
}

...
{
    public partial class XRptEPrescription_V6 : XtraReport
    {
        public XRptEPrescription_V6()
        {
            InitializeComponent();
        }
        ...
        private void XRptEPrescription_TV_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            else
            {
                ...
                //        break;
                //}
                if (!Convert.ToBoolean(parIsYHCTPrescript.Value))
                {
                    xrLabel3.Text = null;
                    xrLabel13.Text = null;
                    xrLabel11.Text = null;
                ...
                else
                {
                    ...
                    xrLabel21.Text = null;
                    xrLabel75.Text = null;
                    //xrLabel75.LocationF = new DevExpress.Utils.PointFloat(551.15F, 98F);
                    xrLabel75.LocationF = new DevExpress.Utils.PointFloat(534.02F, 46F);
        ...
        {
            ((XRptEPrescriptionDetails_V6_Drug)((XRSubreport)sender).ReportSource).Parameters["parIssueID"].Value = Convert.ToInt32(parIssueID.Value.ToString());
            ((XRptEPrescriptionDetails_V6_Drug)((XRSubreport)sender).ReportSource).FilterString = FilterString;
            ((XRptEPrescriptionDetails_V6_Drug)((XRSubreport)sender).ReportSource).parIsPsychotropicDrugs = parIsPsychotropicDrugs;
            ((XRptEPrescriptionDetails_V6_Drug)((XRSubreport)sender).ReportSource).parIsFuncfoodsOrCosmetics = parIsFuncfoodsOrCosmetics;
            ((XRptEPrescriptionDetails_V6_Drug)((XRSubreport)sender).ReportSource).parIsYHCTPrescript.Value = parIsYHCTPrescript.Value;
        }
        ...
        {
            ((XRptEPrescriptionDetails_V6_Info)((XRSubreport)sender).ReportSource).Parameters["parIssueID"].Value = Convert.ToInt32(parIssueID.Value.ToString());
            ((XRptEPrescriptionDetails_V6_Info)((XRSubreport)sender).ReportSource).FilterString = FilterString;
            ((XRptEPrescriptionDetails_V6_Info)((XRSubreport)sender).ReportSource).parIsPsychotropicDrugs = parIsPsychotropicDrugs;
            ((XRptEPrescriptionDetails_V6_Info)((XRSubreport)sender).ReportSource).parIsFuncfoodsOrCosmetics = parIsFuncfoodsOrCosmetics;
            ((XRptEPrescriptionDetails_V6_Info)((XRSubreport)sender).ReportSource).parHospitalCode.Value = parHospitalCode;
            ((XRptEPrescriptionDetails_V6_Info)((XRSubreport)sender).ReportSource).parIsYHCTPrescript.Value = parIsYHCTPrescript.Value;
        }
        ...
        private void xrTable1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (IsOutCatConfirmed && IsHIPatient)
            {
                xrTableCell4.Text = "BỆNH NHÂN ĐỒNG Ý CHI TRẢ THUỐC NGOÀI DANH MỤC BHYT.";
            }
            else
            {
                xrTableCell4.Text = "";

...
{
    public partial class XRptEPrescriptionInpt_V5 : XtraReport
    {
        public XRptEPrescriptionInpt_V5()
        {
            InitializeComponent();
        }
        ...
        {
            ((XRptEPrescriptionInPtDetails_V5_Drug)((XRSubreport)sender).ReportSource).Parameters["parIssueID"].Value = Convert.ToInt32(parIssueID.Value.ToString());
            ((XRptEPrescriptionInPtDetails_V5_Drug)((XRSubreport)sender).ReportSource).FilterString = FilterString;
            ...
            {
                ((XRptEPrescriptionInPtDetails_V5_Drug)((XRSubreport)sender).ReportSource).Parameters["parIsBHYT"].Value = true;
            }
        }
        ...
        {
            ((XRptEPrescriptionInPtDetails_V5_Info)((XRSubreport)sender).ReportSource).Parameters["parIssueID"].Value = Convert.ToInt32(parIssueID.Value.ToString());
            ((XRptEPrescriptionInPtDetails_V5_Info)((XRSubreport)sender).ReportSource).FilterString = FilterString;
        }
    }
}

...
{
    public partial class SupplierDrugDeptPaymentReqs : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        {
            spSupplierDrugDeptPaymentReqDetails_IDTableAdapter.Fill((this.DataSource as DataSchema.SupplierDrugDeptPaymentReqs.SupplierDrugDeptPaymentReqs).spSupplierDrugDeptPaymentReqDetails_ID, 0);
            spSupplierDrugDeptPaymentReqs_IDTableAdapter.Fill((this.DataSource as DataSchema.SupplierDrugDeptPaymentReqs.SupplierDrugDeptPaymentReqs).spSupplierDrugDeptPaymentReqs_ID, 0);
        }

...
{
    public partial class XRptRequestDrugDeptDetailApproved : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptRequestDrugDeptDetailApproved()
        {
            InitializeComponent();
        }

        private void XRptRequestDrugDeptDetailApproved_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {

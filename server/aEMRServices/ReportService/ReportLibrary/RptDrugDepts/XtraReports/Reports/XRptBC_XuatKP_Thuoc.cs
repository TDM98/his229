...
{
    public partial class XRptBC_XuatKP_Thuoc : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptBC_XuatKP_Thuoc()
        {
            InitializeComponent();
        }
        ...
        private void XRptBC_XuatKP_Thuoc_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            FillData();
        }
    }

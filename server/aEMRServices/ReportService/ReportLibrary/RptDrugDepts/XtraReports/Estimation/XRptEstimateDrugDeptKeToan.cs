...
{
    public partial class XRptEstimateDrugDeptKeToan : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptEstimateDrugDeptKeToan()
        {
            InitializeComponent();
        }
        ...
        private void XRptEstimateDrugDeptKeToan_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            FillData();
        }
    }

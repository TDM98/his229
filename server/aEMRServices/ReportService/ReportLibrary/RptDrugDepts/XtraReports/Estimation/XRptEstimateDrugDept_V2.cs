...
{
    public partial class XRptEstimateDrugDept_V2 : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptEstimateDrugDept_V2()
        {
            InitializeComponent();
        ...
        private void XRptEstimateDrugDept_V2_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            PrintingSystem.PageSettings.Landscape = true;
            FillData();
        }

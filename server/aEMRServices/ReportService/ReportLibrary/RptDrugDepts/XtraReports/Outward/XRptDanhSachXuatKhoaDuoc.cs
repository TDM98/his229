...
{
    public partial class XRptDanhSachXuatKhoaDuoc : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptDanhSachXuatKhoaDuoc()
        {
            InitializeComponent();
        }

        private void XRptDanhSachXuatKhoaDuoc_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            FillData();
        }
        ...
        private void FillData()
        {
            ...
            this.dsRpt_DanhSachXuatKhoaDuoc1.EnforceConstraints = false;
            this.spRpt_DanhSachXuatKhoaDuocTableAdapter.Fill(this.dsRpt_DanhSachXuatKhoaDuoc1.spRpt_DanhSachXuatKhoaDuoc, Convert.ToInt32(this.parV_MedProductType.Value), FromDate, ToDate, Quy, Thang, Nam, Convert.ToInt32(this.parViewBy.Value), Convert.ToInt64(this.parStoreID.Value), Convert.ToInt64(this.pTypID.Value));
        }
    }
}
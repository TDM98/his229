...
{
    public partial class XRptInwardVTYTTHSupplierTrongNuoc : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptInwardVTYTTHSupplierTrongNuoc()
        {
            InitializeComponent();
        }
        ...
        public void FillData()
        {
            ...
            if (dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTHInvoice_ByID != null && dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTHInvoice_ByID.Rows.Count > 0)
            {
                total = Convert.ToDecimal(dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTHInvoice_ByID.Rows[0]["TotalHaveDicounting"])
                        ...
                        - Convert.ToDecimal(dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTHInvoice_ByID.Rows[0]["Discounting"])
                        - Convert.ToDecimal(dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTHInvoice_ByID.Rows[0]["DiscountingOnProduct"]);

                VATDifference = Convert.ToDecimal(dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTHInvoice_ByID.Rows[0]["TotalVATDifferenceAmount"]);
                TotalNotVAT = Convert.ToDecimal(dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTHInvoice_ByID.Rows[0]["TotalNotVAT"]);
                DiscountingOnProduct = Convert.ToDecimal(dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTHInvoice_ByID.Rows[0]["DiscountingOnProduct"]);
                DiscountingInvoice = Convert.ToDecimal(dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTHInvoice_ByID.Rows[0]["DiscountingInvoice"]);
                CustomTax = Convert.ToDecimal(dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTHInvoice_ByID.Rows[0]["CustomTax"]);
                DifferenceValue = Convert.ToDecimal(dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTHInvoice_ByID.Rows[0]["DifferenceValue"]);
            ...
            {
                Row = dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTH_ByID.Rows.Count;
                for (int i = 0; i < dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTH_ByID.Rows.Count; i++)
                {
                    ...
                    CountRow++;
                    Qty = Convert.ToDecimal(dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTH_ByID.Rows[i]["InQuantity"]);
                    InBuyingPrice = Convert.ToDecimal(dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTH_ByID.Rows[i]["InBuyingPrice"]);
                    if (dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTH_ByID.Rows[i]["VAT"] != DBNull.Value)
                    {
                        VAT = Convert.ToDecimal(dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTH_ByID.Rows[i]["VAT"]);
                    }
                    else
                    {
                        VAT = 0;
                    }
                    TotalPriceNotVAT = Convert.ToDecimal(dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTH_ByID.Rows[i]["TotalPriceNotVAT"]);
                    Discounting = Convert.ToDecimal(dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTH_ByID.Rows[i]["Discounting"]);
            ...
            if (dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTH_ByID != null && dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTH_ByID.Rows.Count > 0)
            {
                for (int i = 0; i < dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTH_ByID.Rows.Count; i++)
                {
                    if (dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTH_ByID.Rows[i]["VAT"] != DBNull.Value)
                    {
                        VATForEqual = Convert.ToDecimal(dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTH_ByID.Rows[i]["VAT"]);
                    }
                    else
                    {
                        VATForEqual = null;
                    ...
                    if (dsInwardVTYTTHSupplier1.spRpt_InwardDrugVTYTTH_ByID.Rows.Count == ncount)
                    {
        ...
        private void XRptInwardVTYTTHSupplierTrongNuoc_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            FillData();
        }
    }

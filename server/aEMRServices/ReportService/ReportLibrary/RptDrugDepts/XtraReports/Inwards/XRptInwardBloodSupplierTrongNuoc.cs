...
{
    public partial class XRptInwardBloodSupplierTrongNuoc : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptInwardBloodSupplierTrongNuoc()
        {
            InitializeComponent();
        }
        ...
        public void FillData()
        {
            ...
            if (dsInwardBloodSupplier1.spRpt_InwardBloodInvoice_ByID != null && dsInwardBloodSupplier1.spRpt_InwardBloodInvoice_ByID.Rows.Count > 0)
            {
                total = Convert.ToDecimal(dsInwardBloodSupplier1.spRpt_InwardBloodInvoice_ByID.Rows[0]["TotalHaveDicounting"])
                        ...
                        - Convert.ToDecimal(dsInwardBloodSupplier1.spRpt_InwardBloodInvoice_ByID.Rows[0]["Discounting"])
                        - Convert.ToDecimal(dsInwardBloodSupplier1.spRpt_InwardBloodInvoice_ByID.Rows[0]["DiscountingOnProduct"]);

                VATDifference = Convert.ToDecimal(dsInwardBloodSupplier1.spRpt_InwardBloodInvoice_ByID.Rows[0]["TotalVATDifferenceAmount"]);
                TotalNotVAT = Convert.ToDecimal(dsInwardBloodSupplier1.spRpt_InwardBloodInvoice_ByID.Rows[0]["TotalNotVAT"]);
                DiscountingOnProduct = Convert.ToDecimal(dsInwardBloodSupplier1.spRpt_InwardBloodInvoice_ByID.Rows[0]["DiscountingOnProduct"]);
                DiscountingInvoice = Convert.ToDecimal(dsInwardBloodSupplier1.spRpt_InwardBloodInvoice_ByID.Rows[0]["DiscountingInvoice"]);
                CustomTax = Convert.ToDecimal(dsInwardBloodSupplier1.spRpt_InwardBloodInvoice_ByID.Rows[0]["CustomTax"]);
                DifferenceValue = Convert.ToDecimal(dsInwardBloodSupplier1.spRpt_InwardBloodInvoice_ByID.Rows[0]["DifferenceValue"]);
            ...
            {
                Row = dsInwardBloodSupplier1.spRpt_InwardBlood_ByID.Rows.Count;
                for (int i = 0; i < dsInwardBloodSupplier1.spRpt_InwardBlood_ByID.Rows.Count; i++)
                {
                    decimal DiscountingRow = 0;
                    decimal Discounting = 0;
                    Qty = Convert.ToDecimal(dsInwardBloodSupplier1.spRpt_InwardBlood_ByID.Rows[i]["InQuantity"]);
                    InBuyingPrice = Convert.ToDecimal(dsInwardBloodSupplier1.spRpt_InwardBlood_ByID.Rows[i]["InBuyingPrice"]);
                    if (dsInwardBloodSupplier1.spRpt_InwardBlood_ByID.Rows[i]["VAT"] != DBNull.Value)
                    {
                        VAT = Convert.ToDecimal(dsInwardBloodSupplier1.spRpt_InwardBlood_ByID.Rows[i]["VAT"]);
                    }
                    else
                    {
                        VAT = 0;
                    }
                    TotalPriceNotVAT = Convert.ToDecimal(dsInwardBloodSupplier1.spRpt_InwardBlood_ByID.Rows[i]["TotalPriceNotVAT"]);
                    Discounting = Convert.ToDecimal(dsInwardBloodSupplier1.spRpt_InwardBlood_ByID.Rows[i]["Discounting"]);
            ...
            if (dsInwardBloodSupplier1.spRpt_InwardBlood_ByID != null && dsInwardBloodSupplier1.spRpt_InwardBlood_ByID.Rows.Count > 0)
            {
                for (int i = 0; i < dsInwardBloodSupplier1.spRpt_InwardBlood_ByID.Rows.Count; i++)
                {
                    if (dsInwardBloodSupplier1.spRpt_InwardBlood_ByID.Rows[i]["VAT"] != DBNull.Value)
                    {
                        VATForEqual = Convert.ToDecimal(dsInwardBloodSupplier1.spRpt_InwardBlood_ByID.Rows[i]["VAT"]);
                    }
                    else
                    {
                        VATForEqual = null;
                    ...
                    if (dsInwardBloodSupplier1.spRpt_InwardBlood_ByID.Rows.Count == ncount)
                    {
        ...
        private void XRptInwardBloodSupplierTrongNuoc_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            FillData();
        }
    }

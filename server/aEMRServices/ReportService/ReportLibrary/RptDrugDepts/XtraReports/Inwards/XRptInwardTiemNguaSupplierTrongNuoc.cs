...
{
    public partial class XRptInwardTiemNguaSupplierTrongNuoc : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptInwardTiemNguaSupplierTrongNuoc()
        {
            InitializeComponent();
        }
        ...
        public void FillData()
        {
            ...
            if (dsInwardVaccineSupplier1.spRpt_InwardVaccineInvoice_ByID != null && dsInwardVaccineSupplier1.spRpt_InwardVaccineInvoice_ByID.Rows.Count > 0)
            {
                total = Convert.ToDecimal(dsInwardVaccineSupplier1.spRpt_InwardVaccineInvoice_ByID.Rows[0]["TotalHaveDicounting"])
                        ...
                        - Convert.ToDecimal(dsInwardVaccineSupplier1.spRpt_InwardVaccineInvoice_ByID.Rows[0]["Discounting"])
                        - Convert.ToDecimal(dsInwardVaccineSupplier1.spRpt_InwardVaccineInvoice_ByID.Rows[0]["DiscountingOnProduct"]);

                VATDifference = Convert.ToDecimal(dsInwardVaccineSupplier1.spRpt_InwardVaccineInvoice_ByID.Rows[0]["TotalVATDifferenceAmount"]);
                TotalNotVAT = Convert.ToDecimal(dsInwardVaccineSupplier1.spRpt_InwardVaccineInvoice_ByID.Rows[0]["TotalNotVAT"]);
                DiscountingOnProduct = Convert.ToDecimal(dsInwardVaccineSupplier1.spRpt_InwardVaccineInvoice_ByID.Rows[0]["DiscountingOnProduct"]);
                DiscountingInvoice = Convert.ToDecimal(dsInwardVaccineSupplier1.spRpt_InwardVaccineInvoice_ByID.Rows[0]["DiscountingInvoice"]);
                CustomTax = Convert.ToDecimal(dsInwardVaccineSupplier1.spRpt_InwardVaccineInvoice_ByID.Rows[0]["CustomTax"]);
                DifferenceValue = Convert.ToDecimal(dsInwardVaccineSupplier1.spRpt_InwardVaccineInvoice_ByID.Rows[0]["DifferenceValue"]);
            ...
            {
                Row = dsInwardVaccineSupplier1.spRpt_InwardVaccine_ByID.Rows.Count;
                for (int i = 0; i < dsInwardVaccineSupplier1.spRpt_InwardVaccine_ByID.Rows.Count; i++)
                {
                    ...
                    CountRow++;
                    Qty = Convert.ToDecimal(dsInwardVaccineSupplier1.spRpt_InwardVaccine_ByID.Rows[i]["InQuantity"]);
                    InBuyingPrice = Convert.ToDecimal(dsInwardVaccineSupplier1.spRpt_InwardVaccine_ByID.Rows[i]["InBuyingPrice"]);
                    if (dsInwardVaccineSupplier1.spRpt_InwardVaccine_ByID.Rows[i]["VAT"] != DBNull.Value)
                    {
                        VAT = Convert.ToDecimal(dsInwardVaccineSupplier1.spRpt_InwardVaccine_ByID.Rows[i]["VAT"]);
                    }
                    else
                    {
                        VAT = 0;
                    }
                    TotalPriceNotVAT = Convert.ToDecimal(dsInwardVaccineSupplier1.spRpt_InwardVaccine_ByID.Rows[i]["TotalPriceNotVAT"]);
                    Discounting = Convert.ToDecimal(dsInwardVaccineSupplier1.spRpt_InwardVaccine_ByID.Rows[i]["Discounting"]);
            ...
            if (dsInwardVaccineSupplier1.spRpt_InwardVaccine_ByID != null && dsInwardVaccineSupplier1.spRpt_InwardVaccine_ByID.Rows.Count > 0)
            {
                for (int i = 0; i < dsInwardVaccineSupplier1.spRpt_InwardVaccine_ByID.Rows.Count; i++)
                {
                    if (dsInwardVaccineSupplier1.spRpt_InwardVaccine_ByID.Rows[i]["VAT"] != DBNull.Value)
                    {
                        VATForEqual = Convert.ToDecimal(dsInwardVaccineSupplier1.spRpt_InwardVaccine_ByID.Rows[i]["VAT"]);
                    }
                    else
                    {
                        VATForEqual = null;
                    ...
                    if (dsInwardVaccineSupplier1.spRpt_InwardVaccine_ByID.Rows.Count == ncount)
                    {
        ...
        private void XRptInwardTiemNguaSupplierTrongNuoc_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            FillData();
        }
    }

...
{
    public partial class XRptDrugDeptStockTakes_Get_HoaChat : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptDrugDeptStockTakes_Get_HoaChat()
        {
            InitializeComponent();
        }

        private void XRptDrugDeptStockTakes_Get_HoaChat_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            FillData();
        }

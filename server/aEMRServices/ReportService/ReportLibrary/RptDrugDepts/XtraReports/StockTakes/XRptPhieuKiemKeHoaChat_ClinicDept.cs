...
{
    public partial class XRptPhieuKiemKeHoaChat_ClinicDept : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptPhieuKiemKeHoaChat_ClinicDept()
        {
            InitializeComponent();
        }

        private void XRptPhieuKiemKeHoaChat_ClinicDept_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            FillData();
        }

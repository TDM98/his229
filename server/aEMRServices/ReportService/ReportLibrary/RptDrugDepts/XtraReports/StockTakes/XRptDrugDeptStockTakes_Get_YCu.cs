...
{
    public partial class XRptDrugDeptStockTakes_Get_YCu : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptDrugDeptStockTakes_Get_YCu()
        {
            InitializeComponent();
        }

        private void XRptDrugDeptStockTakes_Get_YCu_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            FillData();
        }

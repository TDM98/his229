...
{
    public partial class XRptOutDemageDrugDept : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptOutDemageDrugDept()
        {
            InitializeComponent();
        }
        ...
        private void XRptOutDemageDrugDept_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            FillData();
        }
    }

...
{
    public partial class XRptDrugDeptSellingPriceListYCuHoaChat_Detail_AutoCreate : DevExpress.XtraReports.UI.XtraReport
    {
        public XRptDrugDeptSellingPriceListYCuHoaChat_Detail_AutoCreate()
        {
            InitializeComponent();
        }
        ...
        private void XRptDrugDeptSellingPriceListYCuHoaChat_Detail_AutoCreate_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            FillData();
        }

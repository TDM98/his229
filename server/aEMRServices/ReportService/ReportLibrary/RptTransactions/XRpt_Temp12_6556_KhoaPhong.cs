...
{
    public partial class XRpt_Temp12_6556_KhoaPhong : DevExpress.XtraReports.UI.XtraReport
    {
        public XRpt_Temp12_6556_KhoaPhong()
        {
            InitializeComponent();
        }
        ...
        public void FillData()
        {
            ...
            spRpt_CreateTemp02NoiTruNewTableAdapter.Fill(dsTemp02NoiTruNew1.spRpt_CreateTemp02NoiTruNew
                ...
                , Convert.ToDateTime(ToDate.Value), Convert.ToInt32(DeptID.Value), Convert.ToBoolean(ViewByDate.Value)
                , Convert.ToBoolean(PrintNoChargeItem.Value), 1, Convert.ToInt64(RegistrationType.Value)
                , Convert.ToInt64(TransactionID.Value), ref DefaultNumFilmsRecvStr, false, true, false, true);

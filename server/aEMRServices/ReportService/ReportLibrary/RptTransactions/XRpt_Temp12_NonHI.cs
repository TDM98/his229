...
{
    public partial class XRpt_Temp12_NonHI : DevExpress.XtraReports.UI.XtraReport
    {
        public XRpt_Temp12_NonHI()
        {
            InitializeComponent();
        }
        ...
        public void FillData()
        {
            ...
            spRpt_CreateTemp02NoiTruNewTableAdapter.Fill(dsTemp02NoiTruNew1.spRpt_CreateTemp02NoiTruNew
                ...
                , ref DefaultNumFilmsRecvStr, true, false, false, false);
            spHealthInsuranceHistory_InPtTableAdapter.Fill(dsTemp02NoiTruNew1.spHealthInsuranceHistory_InPt
                ...
                , Convert.ToInt64(DeptID.Value), false, false);
        ...
        private void ReportFooter1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                TotalPatientCoPayAmount = dsTemp02NoiTruNew1.spRpt_CreateTemp02NoiTruNew.Rows.Cast<DataRow>().Where(x => x["TotalPatientCoPayAmount"] != null).Sum(x => Convert.ToDecimal(x["TotalPatientCoPayAmount"]));
            }
            if (Convert.ToInt32(RegistrationType.Value) == 24001)
            {
                totalBNTra = totalCP - totalBHTra;
            }
            TotalPtPmtWithoutCoPay = Math.Round(totalBNTra) - TotalPatientCoPayAmount;


            //totalBNPhaiDongThem = totalBNTra - (totalTamUng + totalNguonKhac);
            totalBNPhaiDongThem = TotalPtPmtWithoutCoPay + totalNguonKhac;

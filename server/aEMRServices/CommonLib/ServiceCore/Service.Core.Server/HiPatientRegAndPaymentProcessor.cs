...
namespace CommonServices
{
    public class HiPatientRegAndPaymentProcessor : RegAndPaymentProcessorBase
    {
        ...
        public double CalcPatientHiBenefit(PatientRegistration regInfo, HealthInsurance hPatientHiProfile, out bool isConsideredAsCrossRegion)
        {
            var hiBenefit = 0.0;
            ...
            //mac dinh theo lan kham benh truoc,ko dung.lan nao xet lan do thoi
            ...
            if (hPatientHiProfile.isDoing
                && !hPatientHiProfile.EditLocked)//neu la chinh sua tu tren dua xuong--dinh
            {
            ...
            //if (regInfo.EmergencyRecord != null)
        ...
        protected override void OnInit()
        {
            ...
            var hiBenefit = CalcPatientHiBenefit(CurrentRegistration, CurrentRegistration.HealthInsurance, out bConsiderAsCrossRegion);

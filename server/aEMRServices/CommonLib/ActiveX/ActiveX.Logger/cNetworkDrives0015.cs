...
namespace aejw.Network
{
	...
	public class NetworkDrive{
		...
		#region API
		[DllImport("mpr.dll")] private static extern int WNetAddConnection2(ref structNetResource pstNetRes, string psPassword, string psUsername, int piFlags);
		[DllImport("mpr.dll")] private static extern int WNetCancelConnection2(string psName, int piFlags, int pfForce);
		...
		private const int RESOURCETYPE_DISK = 0x0;

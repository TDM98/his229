...
using System.Data;
//Create By Ny  Date 03/21/2011
/*
 * 20171214 #001 CMN: Added AgeString for display on form
*/
namespace eHCMS.DAL
{
    public class SqlPtRegistrationProvider:PtRegistrationProvider
    {

        public override DateTime GetMaxExamDate()
        {
        ...
        public override bool UpdatePatientRegistration(long PtRegistrationID, long V_RegistrationStatus)
        {
            using (SqlConnection cn =new SqlConnection(this.ConnectionString))
            {
        ...
        public override bool UpdatePatientRegistrationPayStatus(long PtRegistrationID, long V_RegistrationPaymentStatus)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
        ...
        public override bool PatientRegistration_Close(long PtRegistrationID, int FindPatient, long V_RegistrationClosingStatus)
        {
            string Result = "";
        ...
        public override List<PatientRegistration> SearchPtRegistration(SeachPtRegistrationCriteria criteria, int pageSize, int pageIndex, bool bcount, out int Totalcount)
        {
            Totalcount = 0;
            if (criteria == null)
            {
        ...
        public override Patient GetPatientInfoByPtRegistration(long? PtRegistrationID,long? PatientID,int FindPatient)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
        ...
        public override List<PatientRegistration> GetAllPatientRegistration_ByRegType(long PatientID ,long V_RegistrationType)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {

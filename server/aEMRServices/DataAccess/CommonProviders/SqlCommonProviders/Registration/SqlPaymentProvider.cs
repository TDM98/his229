 ...
 * 20170619 #003 CMN: Service for payment report OutPt with large data
*/
using System;
...
namespace eHCMS.DAL
{
    public class SqlPaymentProvider : PaymentProvider
    {
        public SqlPaymentProvider()
            : base()
        {

        }

        public override List<PatientTransactionPayment> GetAllPayments_New(long transactionID)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                return GetAllPayments_New(transactionID, cn, null);
            }
        }

        public override List<PatientTransactionPayment> GetAllPayments_InPt(long transactionID)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                return GetAllPayments_InPt(transactionID, cn, null);
            }
        }

        public override PatientTransaction GetAllPaymentByRegistrationID_InPt(long registrationID)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
        ...
        public override List<PatientTransactionPayment> GetPatientPaymentByDay_New(PatientPaymentSearchCriteria PatientPaymentSearch, int FindPatient)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
        ...
        public override List<PatientTransactionPayment> GetPatientPaymentByDay_New(PatientPaymentSearchCriteria PatientPaymentSearch, int FindPatient, DbConnection connection, DbTransaction tran)
        {
        ...
        public override List<ReportPaymentReceiptByStaff> GetReportPaymentReceiptByStaff(DateTime FromDate, DateTime ToDate, bool bFilterByStaffID, Int64 nStaffID, long loggedStaffID, DbConnection connection, DbTransaction tran)
        {
            if (connection.State != ConnectionState.Open)
            {
                connection.Open();
        ...
        public override ReportPaymentReceiptByStaffDetails GetReportPaymentReceiptByStaffDetails(long RepPaymentRecvID, DbConnection connection, DbTransaction tran)
        {
            if (connection.State != ConnectionState.Open)
            {
                connection.Open();
        ...
        public override List<ReportPaymentReceiptByStaff> GetReportPaymentReceiptByStaff(DateTime FromDate, DateTime ToDate, bool bFilterByStaffID, Int64 nStaffID, long loggedStaffID)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
        ...
        public override ReportPaymentReceiptByStaffDetails GetReportPaymentReceiptByStaffDetails(long RepPaymentRecvID)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
        ...
        public override List<PatientTransactionPayment> GetAllPayments_New(long transactionID, DbConnection connection, DbTransaction tran)
        {
            if (connection.State != ConnectionState.Open)
            {
                connection.Open();
        ...
        public override IList<OutPatientCashAdvance> GetAllOutPatientCashAdvance(long PtRegistrationID)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        public override PatientTransaction GetAllPaymentByRegistrationID_InPt(long registrationID, DbConnection connection, DbTransaction tran)
        {
            try
            {
                if (connection.State != ConnectionState.Open)
        ...
        public override List<PatientTransactionPayment> GetAllPayments_InPt(long transactionID, DbConnection connection, DbTransaction tran)
        {
            if (connection.State != ConnectionState.Open)
            {
                connection.Open();
        ...
        public override bool AddTransactionForDrug(PatientTransactionPayment payment, long outiID, long V_TranRefType, out long PaymentID)//PatientPayment payment,
        {
            PaymentID = 0;
            bool results = false;
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        public override bool ThanhToanTienChoBenhNhan(PatientTransactionPayment payment, PatientTransactionDetail TrDetail, long PtRegistrationID, long V_RegistrationType, out long PtTranPaymtID)//PatientPayment payment,
        {
            try
            {
                PtTranPaymtID = 0;
        ...
        public override bool RptPatientCashAdvReminder_Insert(RptPatientCashAdvReminder payment, out long RptPtCashAdvRemID)
        {
            try
            {
                RptPtCashAdvRemID = 0;
        ...
        public override bool RptPatientCashAdvReminder_Update(RptPatientCashAdvReminder payment)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        public override bool RptPatientCashAdvReminder_Delete(long RptPtCashAdvRemID)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        public override List<RptPatientCashAdvReminder> RptPatientCashAdvReminder_GetAll(long PtRegistrationID)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        public override List<RefDepartmentReqCashAdv> RefDepartmentReqCashAdv_DeptID(long DeptID)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        public override bool PatientCashAdvance_Insert(PatientCashAdvance payment, out long PtCashAdvanceID)
        {
            try
            {
                PtCashAdvanceID = 0;
        ...
        public override bool PatientCashAdvance_Delete(PatientCashAdvance payment, long staffID)
        {
            try
            {
                bool results = false;
        ...
        public override bool GenericPayment_FullOperation(GenericPayment GenPayment, out long OutGenericPaymentID)
        {
            try
            {
        ...
        public override GenericPayment GetGenericPaymentByID(long GenericPaymentID)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        public override List<GenericPayment> GenericPayment_GetAll(DateTime? FromDate, DateTime? ToDate, long? V_GenericPaymentType, long? StaffID)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
                {
                    ...
                    //cmd.Transaction = (SqlTransaction)tran;
                    cmd.CommandText = "spGenericPayment_GetAllByCreatedDate";
                    cmd.CommandType = CommandType.StoredProcedure;
                    ...
                    cmd.AddParameter("@V_GenericPaymentType", SqlDbType.BigInt, ConvertNullObjectToDBNull(V_GenericPaymentType));
                    cmd.AddParameter("@StaffID", SqlDbType.BigInt, ConvertNullObjectToDBNull(StaffID));
                    IDataReader reader = ExecuteReader(cmd);
                    if (reader == null)
                    {
                    ...
                    reader.Close();
                    return retVal;
                    //return GenericPayment_GetAll(FromDate, ToDate, V_GenericPaymentType, cn, null);
                }
            }
            catch(Exception ex)
            {
        ...
        public override GenericPayment GenericPayment_SearchByCode(string GenPaymtCode, long StaffID)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        public override List<PatientCashAdvance> PatientCashAdvance_GetAll(long PtRegistrationID, long V_RegistrationType)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        public override List<PatientCashAdvance> PatientCashAdvance_GetAll(long PtRegistrationID, long V_RegistrationType, DbConnection connection, DbTransaction tran)
        {
            try
            {
                if (connection.State != ConnectionState.Open)
        ...
        public override List<PatientCashAdvance> GetCashAdvanceBill(long PtRegistrationID, long V_RegistrationType)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        public override List<TransactionFinalization> GetPatientSettlement(long PtRegistrationID, long V_RegistrationType)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        public override bool PatientTransactionPayment_UpdateNote(List<PatientTransactionPayment> allPayment)//List<PatientPayment> allPayment,
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        public override bool PatientTransactionPayment_UpdateID(PatientTransactionPayment Payment)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
        ...
        public override List<PatientTransactionPayment> PatientTransactionPayment_Load(long TransactionID)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
        ...
        public override bool AddReportPaymentReceiptByStaff(ReportPaymentReceiptByStaff curReportPaymentReceiptByStaff,
        ...
        public override bool UpdateReportPaymentReceiptByStaff(ReportPaymentReceiptByStaff curReportPaymentReceiptByStaff)
        {
            bool results = false;
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
        ...
        public override List<ReportOutPatientCashReceipt_Payments> GetReportOutPatientCashReceipt(SearchOutwardReport Searchcriate)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
        ...
        public override List<ReportOutPatientCashReceipt_Payments> GetReportOutPatientCashReceipt_TongHop(SearchOutwardReport Searchcriate, bool? IsTongHop, long loggedStaffID, out List<PatientTransactionPayment> OutPaymentLst)
        {
            try
            {
                OutPaymentLst = null;
        ...
        public override List<ReportOutPatientCashReceipt_Payments> GetReportOutPatientCashReceipt_TongHop_Async(SearchOutwardReport Searchcriate, bool? IsTongHop, long loggedStaffID, out List<PatientTransactionPayment> OutPaymentLst, out int AsyncKey)
        {
            try
            {
                OutPaymentLst = null;
        ...
        public override List<ReportOutPatientCashReceipt_Payments> GetMoreReportOutPatientCashReceipt_TongHop_Async(int RefAsyncKey, out List<PatientTransactionPayment> OutPaymentLst, out int AsyncKey)
        {
            OutPaymentLst = null;
        ...
        public override List<CharityOrganization> GetAllCharityOrganization()
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        //public override List<CharitySupportFund> GetCharitySupportFundForInPt(long PtRegistrationID, long? BillingInvID)
        public override List<CharitySupportFund> GetCharitySupportFundForInPt(long PtRegistrationID, long? BillingInvID, bool? IsHighTechServiceBill = null)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        //public override List<CharitySupportFund> SaveCharitySupportFundForInPt(long PtRegistrationID, long StaffID, long? BillingInvID, List<CharitySupportFund> SupportFunds)
        public override List<CharitySupportFund> SaveCharitySupportFundForInPt(long PtRegistrationID, long StaffID, long? BillingInvID, List<CharitySupportFund> SupportFunds, bool IsHighTechServiceBill = false)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        public override bool Recal15PercentHIBenefit(long PtRegistrationID, long StaffID)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        public override bool RecalRegistrationHIBenefit(long PtRegistrationID, long StaffID, out string OutputBalanceServicesXML)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        public override bool CancelConfirmHIBenefit(long PtRegistrationID, long StaffID)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        public override bool ConfirmRegistrationHIBenefit(long PtRegistrationID, long? StaffID, bool IsUpdateHisID, long? HisID, double PtInsuranceBenefit)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
        ...
        public override bool AddOutPtTransactionFinalization(OutPtTransactionFinalization TransactionFinalizationObj, out long TransactionFinalizationSummaryInfoID)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))
                {
                    ...
                    {
                        TransactionFinalizationSummaryInfoID = (long)cmd.Parameters.Cast<SqlParameter>().FirstOrDefault(x => x.ParameterName == "@TransactionFinalizationSummaryInfoID" && x.Direction == ParameterDirection.Output).Value;
                    }
                    return RelVal;
                }
            }
        ...
        public override OutPtTransactionFinalization RptOutPtTransactionFinalization(long aPtRegistrationID, long V_RegistrationType, long TranFinalizationID)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(this.ConnectionString))

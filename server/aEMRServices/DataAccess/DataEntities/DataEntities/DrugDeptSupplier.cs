...
{
    public partial class DrugDeptSupplier : NotifyChangedBase
    {
        ...
        public static DrugDeptSupplier CreateDrugDeptSupplier(long supplierID, String supplierName, String address, String cityStateZipCode, String telephoneNumber, Boolean active)
        {
            DrugDeptSupplier supplier = new DrugDeptSupplier();
        ...
        [Required(ErrorMessage = "Bạn phải nhập Code NCC")]
        [StringLength(128, MinimumLength = 0, ErrorMessage = "Code NCC quá dài")]
        [DataMemberAttribute()]
        public String SupplierCode
        {
            ...
            set
            {
                ValidateProperty("SupplierCode", value);
                _SupplierCode = value;
        ...
        {
            DrugDeptSupplier seletedSupplier = obj as DrugDeptSupplier;

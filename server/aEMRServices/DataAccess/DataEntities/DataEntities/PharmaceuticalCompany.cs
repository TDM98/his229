...
{
    public partial class PharmaceuticalCompany : NotifyChangedBase
    {
        ...
        public static PharmaceuticalCompany CreatePharmaceuticalCompany(long pCOID, String pCOName)
        {
            PharmaceuticalCompany pharmaceuticalCompany = new PharmaceuticalCompany();
            pharmaceuticalCompany.PCOID = pCOID;
            pharmaceuticalCompany.PCOName = pCOName;
        ...
        {
            PharmaceuticalCompany seletedStore = obj as PharmaceuticalCompany;

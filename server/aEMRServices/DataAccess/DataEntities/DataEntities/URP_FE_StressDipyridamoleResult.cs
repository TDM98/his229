...
{
    public partial class URP_FE_StressDipyridamoleResult : NotifyChangedBase, IEditableObject
    {
        public URP_FE_StressDipyridamoleResult()
            : base()
        {
        ...
        {
            URP_FE_StressDipyridamoleResult info = obj as URP_FE_StressDipyridamoleResult;
            if (info == null)
                return false;
            ...
            return this.URP_FE_StressDipyridamoleResultID > 0 && this.URP_FE_StressDipyridamoleResultID == info.URP_FE_StressDipyridamoleResultID;
        }
        ...
        {
            _tempURP_FE_StressDipyridamoleResult = (URP_FE_StressDipyridamoleResult)this.MemberwiseClone();
        }

        public void CancelEdit()
        {
            if (null != _tempURP_FE_StressDipyridamoleResult)
                CopyFrom(_tempURP_FE_StressDipyridamoleResult);
            //_tempPatient = null;
        }
        ...
        public void CopyFrom(URP_FE_StressDipyridamoleResult p)
        {
        ...
        /// Create a new URP_FE_StressDipyridamoleResult object.

        /// <param name="URP_FE_StressDipyridamoleResultID">Initial value of the URP_FE_StressDipyridamoleResultID property.</param>
        /// <param name="URP_FE_StressDipyridamoleResultName">Initial value of the URP_FE_StressDipyridamoleResultName property.</param>
        public static URP_FE_StressDipyridamoleResult CreateURP_FE_StressDipyridamoleResult(Byte URP_FE_StressDipyridamoleResultID, String URP_FE_StressDipyridamoleResultName)
        {
            URP_FE_StressDipyridamoleResult URP_FE_StressDipyridamoleResult = new URP_FE_StressDipyridamoleResult();
            URP_FE_StressDipyridamoleResult.URP_FE_StressDipyridamoleResultID = URP_FE_StressDipyridamoleResultID;
            
            return URP_FE_StressDipyridamoleResult;
        }
        ...
        [DataMemberAttribute()]
        public long URP_FE_StressDipyridamoleResultID
        {
            get
            {
                return _URP_FE_StressDipyridamoleResultID;
            }
            set
            {
                if (_URP_FE_StressDipyridamoleResultID != value)
                {
                    OnURP_FE_StressDipyridamoleResultIDChanging(value);
                    _URP_FE_StressDipyridamoleResultID = value;
                    RaisePropertyChanged("URP_FE_StressDipyridamoleResultID");
                    OnURP_FE_StressDipyridamoleResultIDChanged();
                }
            }
        }
        private long _URP_FE_StressDipyridamoleResultID;
        partial void OnURP_FE_StressDipyridamoleResultIDChanging(long value);
        partial void OnURP_FE_StressDipyridamoleResultIDChanged();
        ...
        public int TDPHayBienChung
        {
            ...
            set
            {
                ...
                V_ConDauThatNguc = (AllLookupValues.ChoiceEnum)TDPHayBienChung;

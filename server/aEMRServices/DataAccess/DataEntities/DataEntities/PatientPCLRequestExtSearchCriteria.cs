...
{
    public class PatientPCLRequestExtSearchCriteria : SearchCriteriaBase
    {
        public PatientPCLRequestExtSearchCriteria()
        {
        }
        ...
        private Int64 _PatientPCLReqExtID;
        public Int64 PatientPCLReqExtID
        {
            get
            {

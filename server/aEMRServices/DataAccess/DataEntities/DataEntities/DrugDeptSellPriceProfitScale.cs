...
{
    public partial class DrugDeptSellPriceProfitScale : NotifyChangedBase
    {
        [DataMemberAttribute()]
        public Int64 DrugDeptSellPriceProfitScaleID
        {
            get
            {
                return _DrugDeptSellPriceProfitScaleID;
            }
            set
            {
                if (_DrugDeptSellPriceProfitScaleID != value)
                {
                    OnDrugDeptSellPriceProfitScaleIDChanging(value);
                    _DrugDeptSellPriceProfitScaleID = value;
                    RaisePropertyChanged("DrugDeptSellPriceProfitScaleID");
                    OnDrugDeptSellPriceProfitScaleIDChanged();
                }
            }
        }
        private Int64 _DrugDeptSellPriceProfitScaleID;
        partial void OnDrugDeptSellPriceProfitScaleIDChanging(Int64 value);
        partial void OnDrugDeptSellPriceProfitScaleIDChanged();

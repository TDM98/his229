...
{
    [DataContract]
    public partial class PharmacySellingItemPrices : NotifyChangedBase
    {
        #region Primitive Properties
        [DataMemberAttribute()]
        public Int64 PharmacySellingItemPriceID
        {
            get
            {
                return _PharmacySellingItemPriceID;
            }
            set
            {
                if (_PharmacySellingItemPriceID != value)
                {
                    OnPharmacySellingItemPriceIDChanging(value);
                    _PharmacySellingItemPriceID = value;
                    RaisePropertyChanged("PharmacySellingItemPriceID");
                    OnPharmacySellingItemPriceIDChanged();
                }
            }
        }
        private Int64 _PharmacySellingItemPriceID;
        partial void OnPharmacySellingItemPriceIDChanging(Int64 value);
        partial void OnPharmacySellingItemPriceIDChanged();
        ...
        [DataMemberAttribute()]
        public decimal SuggestPriceForHI
        {
            get { return _SuggestPriceForHI; }
            set
            {
                if (_SuggestPriceForHI != value)
                {
                    _SuggestPriceForHI = value;
                    RaisePropertyChanged("SuggestPriceForHI");
                }
            }
        }
        private decimal _SuggestPriceForHI;
        ...
        #region These properties are used for new price list

        [DataMemberAttribute()]
        public decimal ContractPriceBeforeVAT
        {
            get { return _ContractPriceBeforeVAT; }
            set
            {
                if (_ContractPriceBeforeVAT != value)
                {
                    _ContractPriceBeforeVAT = value;
                    RaisePropertyChanged("ContractPriceBeforeVAT");
                }
            }
        }
        private decimal _ContractPriceBeforeVAT;
        ...
        [DataMemberAttribute()]
        public decimal RefHIAllowedPrice
        {
            get { return _RefHIAllowedPrice; }
            set
            {
                if (_RefHIAllowedPrice != value)
                {
                    _RefHIAllowedPrice = value;
                    RaisePropertyChanged("RefHIAllowedPrice");
                }
            }
        }
        private decimal _RefHIAllowedPrice;
        ...
        {
            get { return _HIDrugCode; }
            set
            {
                if (_HIDrugCode != value)
                {
                    _HIDrugCode = value;

...
{
    public interface IPatientPCLImagingResult
    {
        ...
        //▲====== #001
        IPatientPCLGeneralResult UCPatientPCLGeneralResult { get; }
        ...
        PatientPCLImagingResult CurrentPCLImagingResult { get; set; }
    }
}
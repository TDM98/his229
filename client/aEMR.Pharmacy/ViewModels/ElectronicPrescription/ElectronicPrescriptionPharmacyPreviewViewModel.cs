...
{
    [Export(typeof(IElectronicPrescriptionPharmacyPreview)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class ElectronicPrescriptionPharmacyPreviewViewModel : ViewModelBase, IElectronicPrescriptionPharmacyPreview
    {
        [ImportingConstructor]
        public ElectronicPrescriptionPharmacyPreviewViewModel(IWindsorContainer aContainer, INavigationService aNavigation, ISalePosCaching aCaching)
        {
        }
        ...
        //    ErrText = aErrText;
        //}
        private List<DQG_don_thuoc> _ListDQG_don_thuoc;
        public List<DQG_don_thuoc> ListDQG_don_thuoc
        {
            get => _ListDQG_don_thuoc;
            set
            {
                _ListDQG_don_thuoc = value;
                NotifyOfPropertyChange(() => ListDQG_don_thuoc);
            }
        }

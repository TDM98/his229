...
{
    [Export(typeof(IPrescriptionSearch)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class PrescriptionSearchViewModel : ViewModelBase, IPrescriptionSearch
    {
        ...
        public PrescriptionSearchViewModel(IWindsorContainer container, INavigationService navigationService, ISalePosCaching salePosCaching)
        {
        ...
        private byte _FormType;//1: Form Ban Goi,2:Form Cap Nhat Goi
        ...
        public void dataGrid1_DblClick(object sender, Common.EventArgs<object> e)
        {
            ...
            if (FormType == 1)
            {
                Globals.EventAggregator.Publish(new PharmacyCloseSearchPrescriptionEvent { SelectedPrescription = e.Value });
            }
            else
            {
                Globals.EventAggregator.Publish(new PharmacyCloseSearchEditPrescriptionEvent { SelectedPrescription = e.Value });
            }
        }

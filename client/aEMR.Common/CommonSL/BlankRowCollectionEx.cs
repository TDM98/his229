...
{
    public class BlankRowCollectionEx<T> : ObservableCollection<T> where T : EntityBase, new()
    {
        private T t;
        public BlankRowCollectionEx()
        {
            t = new T();
            base.InsertItem(0, t);
        ...
        public BlankRowCollectionEx(IEnumerable<T> collection)
        {
            if (collection != null)
            {

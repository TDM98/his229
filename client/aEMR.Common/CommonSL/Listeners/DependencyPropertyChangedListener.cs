...
namespace aEMR.Common
{
    ...
    public class DependencyPropertyChangedListener
    {
        ...
        public DependencyObject GetSourceElement()
        {
            return _sourceElem;
        }
        private DependencyObject _sourceElem;
        #region Ctor
        ...
        private DependencyPropertyChangedListener(DependencyObject sourceElem)
        {
            this._sourceElem = sourceElem;
        }
        ...
        //public static DependencyPropertyChangedListener Create(DependencyObject sourceElement, DependencyProperty property)
        {
            ...
            DependencyPropertyChangedListener listener = new DependencyPropertyChangedListener(sourceElement);

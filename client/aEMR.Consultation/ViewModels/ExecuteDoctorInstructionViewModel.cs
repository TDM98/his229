...
{
    [Export(typeof(IExecuteDoctorInstruction)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class ExecuteDoctorInstructionViewModel : ViewModelBase, IExecuteDoctorInstruction
        ...
        , IHandle<SaveExecuteDrugCompleted>
    {
        ...
        public ExecuteDoctorInstructionViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventAggregator, ISalePosCaching salePosCaching)
        {

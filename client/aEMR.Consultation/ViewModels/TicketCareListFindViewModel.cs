...
{
    [Export(typeof(ITicketCareListFind)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class TicketCareListFindViewModel : ViewModelBase, ITicketCareListFind
        ...
        //, IHandle<SaveExecuteDrugCompleted>
    {
        ...
        public TicketCareListFindViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventAggregator, ISalePosCaching salePosCaching)
        {
        ...
        public void AddTicketCareCmd()
        {
            ...
            if (Registration_DataStorage.CurrentPatientRegistration.InPatientInstruction != null
                && Registration_DataStorage.CurrentPatientRegistration.InPatientInstruction.V_LevelCare != null)
            {
        ...
        public void AddTicketCareByInstructionCmd()
        {
            if (Registration_DataStorage.CurrentPatientRegistration == null)
            {
                return;
            }
            IInstructionList mDialogView = Globals.GetViewModel<IInstructionList>();
            mDialogView.PtRegistrationID = Registration_DataStorage.CurrentPatientRegistration.PtRegistrationID;
            mDialogView.GetInstructionList();
            GlobalsNAV.ShowDialog_V3<IInstructionList>(mDialogView, null, null, false, true, new Size(420, 600));
        }

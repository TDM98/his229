...
{
    [Export(typeof(IConsultRoomTree)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class ConsultRoomTreeViewModel : Conductor<object>, IConsultRoomTree, IHandle<AddNewRoomTargetEvent>
    {
        ...
        public ConsultRoomTreeViewModel(IWindsorContainer container, INavigationService navigationService, ISalePosCaching salePosCaching)
        {
        ...
        public void treeView_SelectedItemChanged(RoutedPropertyChangedEventArgs<object> e)
        {
                ...
                && e.NewValue != null)
            {
                ...
                if (((RefDepartmentsTree)e.NewValue).HasDeptLocation == true)
                {

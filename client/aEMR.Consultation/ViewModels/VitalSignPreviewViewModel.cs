...
{
    [Export(typeof(IVitalSignPreview)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class VitalSignPreviewViewModel : ViewModelBase, IVitalSignPreview
        ...
        //, IHandle<SaveExecuteDrugCompleted>
    {
        ...
        public VitalSignPreviewViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventAggregator, ISalePosCaching salePosCaching)
        {
        ...
        private void GetReport(long PtRegistrationID)
        {
            ...
            ReportModel = null;
            ReportModel = new GenericReportModel("eHCMS.ReportLib.InPatient.Reports.XRptVitalSign_InPt_Paging").PreviewModel;
            ...
            rParams["parHospitalName"].Value = Globals.ServerConfigSection.CommonItems.ReportHospitalNameShort;

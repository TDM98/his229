...
{
    [Export(typeof(ISieuAmTim_Droppler_Consultation)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class SieuAmTim_DropplerViewModel : Conductor<object>, ISieuAmTim_Droppler_Consultation
    {
        ...
        public SieuAmTim_DropplerViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventAggregator, ISalePosCaching salePosCaching)
        {

...
{
    [Export(typeof (ISieuAmTim_TM_Consultation)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class SieuAmTim_TMViewModel : Conductor<object>, ISieuAmTim_TM_Consultation
    {

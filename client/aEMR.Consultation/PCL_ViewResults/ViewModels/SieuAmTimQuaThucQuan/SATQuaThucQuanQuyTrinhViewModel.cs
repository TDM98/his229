...
{
    [Export(typeof (ISATQuaThucQuanQuyTrinh_Consultation)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class SATQuaThucQuanQuyTrinhViewModel : Conductor<object>, ISATQuaThucQuanQuyTrinh_Consultation
    {
        ...
        public SATQuaThucQuanQuyTrinhViewModel(IWindsorContainer container, INavigationService navigationService, ISalePosCaching salePosCaching)
        {

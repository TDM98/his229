...
{
    [Export(typeof (ISieuAmTT_TimKiem_Consultation)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class SieuAmTT_TimKiemViewModel : Conductor<object>, ISieuAmTT_TimKiem_Consultation
    {
        ...
        public SieuAmTT_TimKiemViewModel(IWindsorContainer container, INavigationService navigationService, ISalePosCaching salePosCaching)
        {

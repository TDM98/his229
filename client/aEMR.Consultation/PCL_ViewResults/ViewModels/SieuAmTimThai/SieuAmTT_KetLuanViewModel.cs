...
{
    [Export(typeof (ISieuAmTT_KetLuan_Consultation)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class SieuAmTT_KetLuanViewModel : Conductor<object>, ISieuAmTT_KetLuan_Consultation
    {
        ...
        public SieuAmTT_KetLuanViewModel(IWindsorContainer container, INavigationService navigationService, ISalePosCaching salePosCaching)
        {

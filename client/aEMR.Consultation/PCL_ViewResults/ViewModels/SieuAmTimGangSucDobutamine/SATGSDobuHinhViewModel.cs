...
{
    [Export(typeof (ISATGSDobuHinh_Consultation)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class SATGSDobuHinhViewModel : Conductor<object>, ISATGSDobuHinh_Consultation
    {
        ...
        public SATGSDobuHinhViewModel(IWindsorContainer container, INavigationService navigationService, ISalePosCaching salePosCaching)
        {

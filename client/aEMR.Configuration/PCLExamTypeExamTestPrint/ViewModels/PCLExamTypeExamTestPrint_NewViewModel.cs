...
{
    [Export(typeof(IPCLExamTypeExamTestPrint_New)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class PCLExamTypeExamTestPrint_NewViewModel : Conductor<object>, IPCLExamTypeExamTestPrint_New
    {
        ...
        public PCLExamTypeExamTestPrint_NewViewModel(IWindsorContainer container, INavigationService navigationService, ISalePosCaching salePosCaching)
        {

...
{
    [Export(typeof(PackageTechnicalServices_AddEditView)), PartCreationPolicy(CreationPolicy.NonShared)]
    public partial class PackageTechnicalServices_AddEditView : UserControl
    {
        public PackageTechnicalServices_AddEditView()
        {
            InitializeComponent();
        }

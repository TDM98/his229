...
{
    [Export(typeof(IDrugList)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class DrugListViewModel : Conductor<object>, IDrugList
        , IHandle<Drug_AddEditViewModel_Save_Event>
    {
        ...
        public DrugListViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventAggregator, ISalePosCaching salePosCaching)
        {

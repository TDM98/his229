...
/*
 * 07082018 #001 TTM:
 * 20191113 #002 TTM: BM 0019561: Giới hạn độ dài các trường trong phiếu nhập (Mã hoá đơn, số serial). Vì chương trình cho phép tối đa 16 nhưng FAST chỉ lấy được 12 kí tự.
 * 20200411 #003 TTM: BM 0029095: Thêm điều kiện kiểm tra để không lưu thông tin giá bán dv, giá BH và giá cho BNBH < 0
 * 20211101 #004 QTD: Lọc kho theo cấu hình trách nhiệm
 */

namespace aEMR.DrugDept.ViewModels
{
    [Export(typeof(ITiemNguaMedDeptInwardSupplier)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class InwardTiemNguaMedDeptSupplierViewModel : ViewModelBase, ITiemNguaMedDeptInwardSupplier
        ...
        , IHandle<DrugDeptCloseEditInwardEvent>
    {
        ...
        public InwardTiemNguaMedDeptSupplierViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventAggregator, ISalePosCaching salePosCaching)
        {
            ...
            InwardTiemNguaMedDeptList = new PagedSortableCollectionView<InwardDrugMedDept>();
            InwardTiemNguaMedDeptList.OnRefresh += new EventHandler<RefreshEventArgs>(InwardTiemNguaMedDeptList_OnRefresh);
            InwardTiemNguaMedDeptList.PageSize = Globals.PageSize;
        ...
        void InwardTiemNguaMedDeptList_OnRefresh(object sender, RefreshEventArgs e)
        {
            InwardTiemNguaDetails_ByID(inviID, InwardTiemNguaMedDeptList.PageIndex, InwardTiemNguaMedDeptList.PageSize);
        }
        ...
        private InwardDrugMedDeptInvoice _CurrentInwardTiemNguaMedDeptInvoice;
        public InwardDrugMedDeptInvoice CurrentInwardTiemNguaMedDeptInvoice
        {
            get
            {
                return _CurrentInwardTiemNguaMedDeptInvoice;
            }
            set
            {
                if (_CurrentInwardTiemNguaMedDeptInvoice != value)
                {
                    _CurrentInwardTiemNguaMedDeptInvoice = value;
                    ...
                    NotifyOfPropertyChange(() => CurrentInwardTiemNguaMedDeptInvoice);
                }
            }
        }
        ...
        private PagedSortableCollectionView<InwardDrugMedDept> _InwardTiemNguaMedDeptList;
        public PagedSortableCollectionView<InwardDrugMedDept> InwardTiemNguaMedDeptList
        {
            get
            {
                return _InwardTiemNguaMedDeptList;
            }
            set
            {
                if (_InwardTiemNguaMedDeptList != value)
                {
                    _InwardTiemNguaMedDeptList = value;
                    NotifyOfPropertyChange(() => InwardTiemNguaMedDeptList);
                }
            }
        }
        ...
        private long _V_MedProductType = (long)AllLookupValues.MedProductType.TIEM_NGUA;
                    ...
                    using (var serviceFactory = new CommonService_V2Client())
                    {
                        ...
                        contract.BeginGetAllCurrency(value, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                ...
                                CurrentInwardTiemNguaMedDeptInvoice.SelectedCurrency = Currencies.FirstOrDefault();
                            }
                            catch (Exception ex)
                            {
        ...
        private IEnumerator<IResult> DoGetStore_MedDept()
        {
            ...
            {
                CurrentInwardTiemNguaMedDeptInvoice.SelectedStorage = StoreCbx.FirstOrDefault();
            }
            else
            {
        ...
        {
            CurrentInwardTiemNguaMedDeptInvoice = new InwardDrugMedDeptInvoice
            {
            ...
            CurrentInwardTiemNguaMedDeptInvoice.SelectedCurrency.CurrencyID = (long)AllLookupValues.CurrencyTable.VND;
            ...
            IsHideAuSupplier = true;
            if (InwardTiemNguaMedDeptList != null)
            {
                InwardTiemNguaMedDeptList.Clear();
            }
            DeepCopyInvoice();
            InitDetailInward();
            TotalPercent = 0;
        ...
        {
            CurrentInwardInvoiceCopy = CurrentInwardTiemNguaMedDeptInvoice.DeepCopy();
        }
        ...
        private void DeleteInwardInvoice()
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginDeleteInwardTiemNguaMedDeptInvoice(CurrentInwardTiemNguaMedDeptInvoice.inviID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndDeleteInwardTiemNguaMedDeptInvoice(asyncResult);
                                if (results == 0)
                                {
                                    InitializeInvoice();
        ...
        {
            if (CurrentInwardTiemNguaMedDeptInvoice.SelectedCurrency == null || CurrentInwardTiemNguaMedDeptInvoice.SelectedCurrency.CurrencyID == 0)
            {
            ...
            if (CurrentInwardTiemNguaMedDeptInvoice.SelectedCurrency.CurrencyID != (long)AllLookupValues.CurrencyTable.VND)
            {
                if (CurrentInwardTiemNguaMedDeptInvoice.ExchangeRates <= 0)
                {
            ...
            this.ShowBusyIndicator(eHCMSResources.Z0125_G1_DangXuLi);
            CurrentInwardTiemNguaMedDeptInvoice.TypID = TypID;
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginUpdateInwardTiemNguaMedDeptInvoice(CurrentInwardTiemNguaMedDeptInvoice, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndUpdateInwardTiemNguaMedDeptInvoice(asyncResult);
                                if (results == 0)
                                {
                                    DeepCopyInvoice();
                                    CheckIsPercentAll();
                                    Load_InwardTiemNguaDetails(CurrentInwardTiemNguaMedDeptInvoice.inviID);
                                    InwardTiemNguaMedDeptInvoice_GetListCost(CurrentInwardTiemNguaMedDeptInvoice.inviID);
        ...
        public void BtnEdit(object sender, RoutedEventArgs e)
        {
            if (MessageBox.Show(string.Format(eHCMSResources.Z0583_G1_CoMuonChinhSuaKg, eHCMSResources.Z0578_G1_PhNhap), eHCMSResources.G0442_G1_TBao, MessageBoxButton.OKCancel) == MessageBoxResult.OK)
            {
                if (CheckValidate())
                {
                    //▼===== #002
                    string ErrorMsg = "";
                    if (!Globals.CheckLimitCharaterOfInwardInvoice(out ErrorMsg, CurrentInwardTiemNguaMedDeptInvoice.InvInvoiceNumber, CurrentInwardTiemNguaMedDeptInvoice.SerialNumber))
                    {
                        MessageBox.Show(ErrorMsg, eHCMSResources.G0449_G1_TBaoLoi);
                        return;
                    }
                    //▲===== #002
                    if (CurrentInwardTiemNguaMedDeptInvoice.SelectedStorage != null)
                    {
                        CurrentInwardTiemNguaMedDeptInvoice.StoreID = CurrentInwardTiemNguaMedDeptInvoice.SelectedStorage.StoreID;
                    }
                    if (CurrentInwardTiemNguaMedDeptInvoice.SelectedCurrency != null)
                    {
                        CurrentInwardTiemNguaMedDeptInvoice.CurrencyID = CurrentInwardTiemNguaMedDeptInvoice.SelectedCurrency.CurrencyID;
                    }
        ...
        {
            CurrentInwardTiemNguaMedDeptInvoice.TotalPriceNotVAT = TongTienSPChuaVAT;
            CurrentInwardTiemNguaMedDeptInvoice.TotalDiscountOnProduct = CKTrenSP;//tong ck tren hoan don
            CurrentInwardTiemNguaMedDeptInvoice.TotalDiscountInvoice = CKTrenSP + TongCKTrenHoaDon;
            CurrentInwardTiemNguaMedDeptInvoice.TotalPrice = TongTienSPChuaVAT - (CKTrenSP + TongCKTrenHoaDon);
            CurrentInwardTiemNguaMedDeptInvoice.TotalHaveCustomTax = TongTienHoaDonCoThueNK;
            CurrentInwardTiemNguaMedDeptInvoice.TotalPriceVAT = TongTienHoaDonCoVAT;
            CurrentInwardTiemNguaMedDeptInvoice.TotalVATDifferenceAmount = TotalVATDifferenceAmount;
            CurrentInwardTiemNguaMedDeptInvoice.TotalVATAmountActual = CurrentInwardTiemNguaMedDeptInvoice.TotalVATAmount + CurrentInwardTiemNguaMedDeptInvoice.TotalVATDifferenceAmount;
        }

        private void Load_InwardTiemNguaDetails(long ID)
        {
            inviID = ID;
            InwardTiemNguaMedDeptList.PageIndex = 0;
            InwardTiemNguaDetails_ByID(CurrentInwardTiemNguaMedDeptInvoice.inviID, 0, Globals.PageSize);
        }

        private void InwardTiemNguaDetails_ByID(long ID, int PageIndex, int PageSize)
        {
            this.ShowBusyIndicator(eHCMSResources.Z0125_G1_DangXuLi);
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginGetInwardTiemNguaMedDept_ByIDInvoice(ID, PageSize, PageIndex, true, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                var results = contract.EndGetInwardTiemNguaMedDept_ByIDInvoice(out int total, out decimal TongTienSPChuaVAT, out decimal CKTrenSP
                                ...
                                InwardTiemNguaMedDeptList.Clear();
                                InwardTiemNguaMedDeptList.TotalItemCount = total;
                                if (results != null)
                                {
                                    foreach (InwardDrugMedDept p in results)
                                    {
                                        InwardTiemNguaMedDeptList.Add(p);
                                    }
                                }
        ...
        {
            if (CurrentInwardTiemNguaMedDeptInvoice.SelectedSupplier != null)
            {
                PharmacyPurchaseOrder_BySupplierID(CurrentInwardTiemNguaMedDeptInvoice.SelectedSupplier.SupplierID);
            }
            else
            {
        ...
        private void GetInwardInvoiceDrugByID(long ID)
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginGetInwardTiemNguaMedDeptInvoice_ByID(ID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                CurrentInwardTiemNguaMedDeptInvoice = contract.EndGetInwardTiemNguaMedDeptInvoice_ByID(asyncResult);
                                DeepCopyInvoice();
                            }
                            catch (Exception ex)
                            {
        ...
        private void AddInwardInvoiceDrug()
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginAddInwardTiemNguaMedDeptInvoice(CurrentInwardTiemNguaMedDeptInvoice, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndAddInwardTiemNguaMedDeptInvoice(out long ID, asyncResult);
                                if (results == 0)
                                {
        ...
        {
            if (CurrentInwardTiemNguaMedDeptInvoice == null)
            {
                return false;
            }
            return CurrentInwardTiemNguaMedDeptInvoice.Validate();
        }
        ...
        public void BtnAdd(object sender, RoutedEventArgs e)
        {
            ...
            if (CheckValidate())
            {
                ...
                if (CurrentInwardTiemNguaMedDeptInvoice.VAT < 1 && CurrentInwardTiemNguaMedDeptInvoice.VAT > 0)
                {
                    Globals.ShowMessage(eHCMSResources.K0262_G1_VATKhongHopLe, eHCMSResources.G0442_G1_TBao);
                    return;
                }
                if (CurrentInwardTiemNguaMedDeptInvoice.DiscountingByPercent < 1 && CurrentInwardTiemNguaMedDeptInvoice.DiscountingByPercent > 0)
                {
                ...
                CurrentInwardTiemNguaMedDeptInvoice.CurrencyID = CurrentInwardTiemNguaMedDeptInvoice.SelectedCurrency.CurrencyID;
                CurrentInwardTiemNguaMedDeptInvoice.V_MedProductType = V_MedProductType;
        ...
        {
            CurrentInwardTiemNguaMedDeptInvoice.IsForeign = false;
        }
        public void rdtNgoaiNuoc_Checked(object sender, RoutedEventArgs e)
        {
            CurrentInwardTiemNguaMedDeptInvoice.IsForeign = true;
        }
        ...
        {
            if (CurrentInwardTiemNguaMedDeptInvoice == null || CurrentInwardTiemNguaMedDeptInvoice.SelectedSupplier == null || CurrentInwardInvoiceCopy == null || CurrentInwardInvoiceCopy.SelectedSupplier == null)
            {
                MessageBox.Show(string.Format("{0}!", eHCMSResources.Z0585_G1_PhNhapKgDuTTin), eHCMSResources.G0442_G1_TBao, MessageBoxButton.OK);
                return false;
            }

            if (CurrentInwardTiemNguaMedDeptInvoice.SelectedSupplier.SupplierID != CurrentInwardInvoiceCopy.SelectedSupplier.SupplierID)
            {
                MessageBox.Show(string.Format("{0}!", eHCMSResources.Z0586_G1_NCCDaThayDoi), eHCMSResources.G0442_G1_TBao, MessageBoxButton.OK);
                return false;
            }

            if (CurrentInwardTiemNguaMedDeptInvoice.CurrencyID != CurrentInwardInvoiceCopy.CurrencyID || CurrentInwardTiemNguaMedDeptInvoice.ExchangeRates != CurrentInwardInvoiceCopy.ExchangeRates || CurrentInwardTiemNguaMedDeptInvoice.VAT != CurrentInwardInvoiceCopy.VAT || CurrentInwardTiemNguaMedDeptInvoice.IsForeign != CurrentInwardInvoiceCopy.IsForeign || CurrentInwardTiemNguaMedDeptInvoice.Notes != CurrentInwardInvoiceCopy.Notes)
            {
                if (MessageBox.Show(eHCMSResources.Z0587_G1_CoMuonCNhatHD, eHCMSResources.G0442_G1_TBao, MessageBoxButton.OKCancel) == MessageBoxResult.OK)
                {
                    ...
                    {
                        CurrentInwardTiemNguaMedDeptInvoice = CurrentInwardInvoiceCopy;
                    }
                }
                else
                {
        ...
        private void InwardDrug_InsertList()
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginInwardTiemNguaMedDept_InsertList(DrugDeptPurchaseOrderDetailList.ToList(), CurrentInwardTiemNguaMedDeptInvoice.inviID, DrugDeptPoID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                contract.EndInwardTiemNguaMedDept_InsertList(asyncResult);
        ...
        private void AddBlankRow()
        {
            if (CheckBlankRow())
            {
                ...
                //    p.VAT = CurrentInwardTiemNguaMedDeptInvoice.VAT - 1;
                //}
        ...
        {
            long? SupplierID = 0;
            if (CurrentInwardTiemNguaMedDeptInvoice != null && CurrentInwardTiemNguaMedDeptInvoice.SelectedSupplier != null)
            {
                SupplierID = CurrentInwardTiemNguaMedDeptInvoice.SelectedSupplier.SupplierID;
            }
            int totalCount = 0;
            var t = new Thread(() =>
            {
        ...
        private void DeleteInwardDrug(long InID)
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginDeleteInwardTiemNguaMedDept(InID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndDeleteInwardTiemNguaMedDept(asyncResult);
                                if (results == 0)
                                {
                                    Load_InwardTiemNguaDetails(CurrentInwardTiemNguaMedDeptInvoice.inviID);
                                    InwardTiemNguaMedDeptInvoice_GetListCost(CurrentInwardTiemNguaMedDeptInvoice.inviID);
        ...
        {
            if (CurrentInwardTiemNguaMedDeptInvoice.CanEditAndDelete)
            {
                if (MessageBox.Show(eHCMSResources.A0118_G1_Msg_ConfXoaDong, eHCMSResources.G0442_G1_TBao, MessageBoxButton.OKCancel) == MessageBoxResult.OK)
                {
        ...
        {
            if (CurrentInwardTiemNguaMedDeptInvoice.DrugDeptSupplierPaymentReqID != null && CurrentInwardTiemNguaMedDeptInvoice.DrugDeptSupplierPaymentReqID > 0)
            {
            ...
            {
                if (CurrentInwardTiemNguaMedDeptInvoice.SelectedCurrency != null && CurrentInwardTiemNguaMedDeptInvoice.SelectedCurrency.CurrencyID != (long)AllLookupValues.CurrencyTable.VND)
                {
                ...
                if (CurrentInwardTiemNguaMedDeptInvoice.CheckedPoint)
                {
        ...
        private void CheckEnableSupplier()
        {
            if ((DrugDeptPurchaseOrderDetailList != null && DrugDeptPurchaseOrderDetailList.Count > 0
                ...
                || (InwardTiemNguaMedDeptList != null && InwardTiemNguaMedDeptList.Count > 0))
            {
        ...
        public void OpenPopUpSearchInwardInvoice(IList<InwardDrugMedDeptInvoice> results, int Totalcount)
        {
            ...
            void onInitDlg(IDrugDeptInwardDrugSupplierSearch proAlloc)
            {
                ...
                {
                    proAlloc.strHienThi = eHCMSResources.Z2464_G1_TiemNgua.ToUpper();
                }
                else
                {
        ...
        private void SearchInwardInvoiceTiemNgua(int PageIndex, int PageSize)
        {
            if (SearchCriteria == null)
            {
                return;
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginSearchInwardTiemNguaMedDeptInvoice(SearchCriteria, TypID, V_MedProductType, PageIndex, PageSize, true, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                var results = contract.EndSearchInwardTiemNguaMedDeptInvoice(out int Totalcount, asyncResult);
                                if (results != null && results.Count > 0)
                                {
                                    if (results.Count > 1)
                                    {
                                    ...
                                    {
                                        CurrentInwardTiemNguaMedDeptInvoice = results.FirstOrDefault();
                                        InitDetailInward();
                                        DeepCopyInvoice();
        ...
        public void tbx_Search_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                ...
                SearchInwardInvoiceTiemNgua(0, Globals.PageSize);
            }
        }
        ...
        public void Handle(DrugDeptCloseSearchSupplierEvent message)
        {
            ...
            {
                CurrentInwardTiemNguaMedDeptInvoice.SelectedSupplier = message.SelectedSupplier as DrugDeptSupplier;
                PharmacyPurchaseOrder_BySupplierID();
            }
        }
        ...
        public void btnPreview()
        {
            Action<IDrugDeptReportDocumentPreview> onInitDlg = delegate (IDrugDeptReportDocumentPreview proAlloc)
            {
                ...
                {
                    proAlloc.eItem = ReportName.DRUGDEPT_INWARD_TIEM_NGUA_SUPPLIER;
                }
                else
                {
                    proAlloc.eItem = ReportName.DRUGDEPT_INWARD_TIEM_NGUA_SUPPLIER_TRONGNUOC;
                }
                ...
                if (CurrentInwardTiemNguaMedDeptInvoice != null && CurrentInwardTiemNguaMedDeptInvoice.SelectedStaff != null)
                {
                    proAlloc.StaffFullName = CurrentInwardTiemNguaMedDeptInvoice.SelectedStaff.FullName;
                }
            };
        ...
        public void btnPrint()
        {
            ...
            var t = new Thread(() =>
            {
                using (var serviceFactory = new ReportServiceClient())
                {
                    ...
                    contract.BeginGetInWardVaccineInPdfFormat(CurrentInwardTiemNguaMedDeptInvoice.inviID, Globals.DispatchCallback((asyncResult) =>
                    {
                        try
                        {
                            var results = contract.EndGetInWardVaccineInPdfFormat(asyncResult);
        ...
        public void Handle(DrugDeptCloseSearchInwardIncoiceEvent message)
        {
            if (message != null && this.IsActive)
            {
                CurrentInwardTiemNguaMedDeptInvoice = message.SelectedInwardInvoice as InwardDrugMedDeptInvoice;
                InitDetailInward();
                DeepCopyInvoice();
                LoadInfoThenSelectedInvoice();
        ...
        private void InwardTiemNguaMedDeptInvoice_GetListCost(long inviID)
        {
            this.ShowBusyIndicator(eHCMSResources.Z0125_G1_DangXuLi);
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginInwardTiemNguaMedDeptInvoice_GetListCost(inviID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                var results = contract.EndInwardTiemNguaMedDeptInvoice_GetListCost(asyncResult);
                                CurrentInwardTiemNguaMedDeptInvoice.CostTableMedDeptLists = results.ToObservableCollection();
                                SumTotalPercent();
                            }
                            catch (Exception ex)
                            {
        ...
        {
            TotalPercent = 0;
            if (CurrentInwardTiemNguaMedDeptInvoice != null && CurrentInwardTiemNguaMedDeptInvoice.CostTableMedDeptLists != null)
            {
                for (int i = 0; i < CurrentInwardTiemNguaMedDeptInvoice.CostTableMedDeptLists.Count; i++)
                {
                    TotalPercent += CurrentInwardTiemNguaMedDeptInvoice.CostTableMedDeptLists[i].Rates;
                }
            }
        }
        #endregion
        ...
        public void ActualQD_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                if (CurrentInwardTiemNguaMedDeptInvoice != null && CurrentInwardTiemNguaMedDeptInvoice.ExchangeRates != 0)
                {
                    try
                    {
                        CurrentInwardTiemNguaMedDeptInvoice.TotalPriceActual_QĐ = Convert.ToDecimal((sender as TextBox).Text);
                    }
                    catch
                    {
                        Globals.ShowMessage(eHCMSResources.A0559_G1_Msg_InfoGTriKhHopLe, eHCMSResources.T0074_G1_I);
                    }
                    CurrentInwardTiemNguaMedDeptInvoice.TotalPriceActual = CurrentInwardTiemNguaMedDeptInvoice.TotalPriceActual_QĐ / (decimal)CurrentInwardTiemNguaMedDeptInvoice.ExchangeRates;
                }
            }
        }
        ...
        public void Actual_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                if (CurrentInwardTiemNguaMedDeptInvoice != null)
                {
                    try
                    {
                        CurrentInwardTiemNguaMedDeptInvoice.TotalPriceActual = Convert.ToDecimal((sender as TextBox).Text);
                    }
                    catch
                    {
                        Globals.ShowMessage(eHCMSResources.A0559_G1_Msg_InfoGTriKhHopLe, eHCMSResources.T0074_G1_I);

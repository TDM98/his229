...
{
    [Export(typeof(IVTTHMedDeptInwardSupplier)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class InwardVTYTMedDeptSupplierViewModel : ViewModelBase, IVTTHMedDeptInwardSupplier
        ...
        , IHandle<DrugDeptCloseEditInwardEvent>
    {
        ...
        public InwardVTYTMedDeptSupplierViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventAggregator, ISalePosCaching salePosCaching)
        {
            ...
            InwardVTYTMedDeptList = new PagedSortableCollectionView<InwardDrugMedDept>();
            InwardVTYTMedDeptList.OnRefresh += new EventHandler<RefreshEventArgs>(InwardVTYTMedDeptList_OnRefresh);
            InwardVTYTMedDeptList.PageSize = Globals.PageSize;
        ...
        void InwardVTYTMedDeptList_OnRefresh(object sender, RefreshEventArgs e)
        {
            InwardVTYTDetails_ByID(inviID, InwardVTYTMedDeptList.PageIndex, InwardVTYTMedDeptList.PageSize);
        }
        ...
        private InwardDrugMedDeptInvoice _CurrentInwardVTYTMedDeptInvoice;
        public InwardDrugMedDeptInvoice CurrentInwardVTYTMedDeptInvoice
        {
            get
            {
                return _CurrentInwardVTYTMedDeptInvoice;
            }
            set
            {
                if (_CurrentInwardVTYTMedDeptInvoice != value)
                {
                    _CurrentInwardVTYTMedDeptInvoice = value;
                    ...
                    NotifyOfPropertyChange(() => CurrentInwardVTYTMedDeptInvoice);
                }
            }
        }
        ...
        private PagedSortableCollectionView<InwardDrugMedDept> _InwardVTYTMedDeptList;
        public PagedSortableCollectionView<InwardDrugMedDept> InwardVTYTMedDeptList
        {
            get
            {
                return _InwardVTYTMedDeptList;
            }
            set
            {
                if (_InwardVTYTMedDeptList != value)
                {
                    _InwardVTYTMedDeptList = value;
                    NotifyOfPropertyChange(() => InwardVTYTMedDeptList);
                }
            }
        }
        ...
        private InwardDrugMedDept _CurrentInwardVTYTMedDept;
        public InwardDrugMedDept CurrentInwardVTYTMedDept
        {
            get
            {
                return _CurrentInwardVTYTMedDept;
            }
            set
            {
                if (_CurrentInwardVTYTMedDept != value)
                {
                    _CurrentInwardVTYTMedDept = value;
                    NotifyOfPropertyChange(() => CurrentInwardVTYTMedDept);
                }
            }
        }
        ...
        private long _V_MedProductType = (long)AllLookupValues.MedProductType.VATTU_TIEUHAO;
                    ...
                    using (var serviceFactory = new CommonService_V2Client())
                    {
                        ...
                        contract.BeginGetAllCurrency(value, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                ...
                                CurrentInwardVTYTMedDeptInvoice.SelectedCurrency = Currencies.FirstOrDefault();
                            }
                            catch (Exception ex)
                            {
        ...
        {
            this.ShowBusyIndicator(eHCMSResources.Z0125_G1_DangXuLi);
            var paymentTypeTask = new LoadStoreListTask((long)AllLookupValues.StoreType.STORAGE_PHARMACY, false, null, false, false);
            yield return paymentTypeTask;
            StoreCbx = paymentTypeTask.LookupList;
            if (StoreCbx != null)
            {
                CurrentInwardVTYTMedDeptInvoice.SelectedStorage = StoreCbx.FirstOrDefault();
            }
            this.HideBusyIndicator();
            yield break;
        }
        ...
        {
            CurrentInwardVTYTMedDeptInvoice = new InwardDrugMedDeptInvoice
            {
            ...
            CurrentInwardVTYTMedDeptInvoice.SelectedCurrency.CurrencyID = (long)AllLookupValues.CurrencyTable.VND;
            ...
            IsHideAuSupplier = true;
            if (InwardVTYTMedDeptList != null)
            {
                InwardVTYTMedDeptList.Clear();
            }
            DeepCopyInvoice();
            InitDetailInward();
            TotalPercent = 0;
        ...
        {
            CurrentInwardInvoiceCopy = CurrentInwardVTYTMedDeptInvoice.DeepCopy();
        }
        ...
        private void DeleteInwardInvoice()
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginDeleteInwardVTYTMedDeptInvoice(CurrentInwardVTYTMedDeptInvoice.inviID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndDeleteInwardVTYTMedDeptInvoice(asyncResult);
                                if (results == 0)
                                {
                                    InitializeInvoice();
        ...
        {
            if (CurrentInwardVTYTMedDeptInvoice.SelectedCurrency == null || CurrentInwardVTYTMedDeptInvoice.SelectedCurrency.CurrencyID == 0)
            {
            ...
            if (CurrentInwardVTYTMedDeptInvoice.SelectedCurrency.CurrencyID != (long)AllLookupValues.CurrencyTable.VND)
            {
                if (CurrentInwardVTYTMedDeptInvoice.ExchangeRates <= 0)
                {
            ...
            this.ShowBusyIndicator(eHCMSResources.Z0125_G1_DangXuLi);
            CurrentInwardVTYTMedDeptInvoice.TypID = TypID;
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginUpdateInwardVTYTMedDeptInvoice(CurrentInwardVTYTMedDeptInvoice, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndUpdateInwardVTYTMedDeptInvoice(asyncResult);
                                if (results == 0)
                                {
                                    DeepCopyInvoice();
                                    CheckIsPercentAll();
                                    Load_InwardVTYTDetails(CurrentInwardVTYTMedDeptInvoice.inviID);
                                    InwardVTYTMedDeptInvoice_GetListCost(CurrentInwardVTYTMedDeptInvoice.inviID);
        ...
        public void BtnEdit(object sender, RoutedEventArgs e)
        {
            if (MessageBox.Show(string.Format(eHCMSResources.Z0583_G1_CoMuonChinhSuaKg, eHCMSResources.Z0578_G1_PhNhap), eHCMSResources.G0442_G1_TBao, MessageBoxButton.OKCancel) == MessageBoxResult.OK)
            {
                if (CheckValidate())
                {
                    if (CurrentInwardVTYTMedDeptInvoice.SelectedStorage != null)
                    {
                        CurrentInwardVTYTMedDeptInvoice.StoreID = CurrentInwardVTYTMedDeptInvoice.SelectedStorage.StoreID;
                    }
                    if (CurrentInwardVTYTMedDeptInvoice.SelectedCurrency != null)
                    {
                        CurrentInwardVTYTMedDeptInvoice.CurrencyID = CurrentInwardVTYTMedDeptInvoice.SelectedCurrency.CurrencyID;
                    }
        ...
        {
            CurrentInwardVTYTMedDeptInvoice.TotalPriceNotVAT = TongTienSPChuaVAT;
            CurrentInwardVTYTMedDeptInvoice.TotalDiscountOnProduct = CKTrenSP;//tong ck tren hoan don
            CurrentInwardVTYTMedDeptInvoice.TotalDiscountInvoice = CKTrenSP + TongCKTrenHoaDon;
            CurrentInwardVTYTMedDeptInvoice.TotalPrice = TongTienSPChuaVAT - (CKTrenSP + TongCKTrenHoaDon);
            CurrentInwardVTYTMedDeptInvoice.TotalHaveCustomTax = TongTienHoaDonCoThueNK;
            CurrentInwardVTYTMedDeptInvoice.TotalPriceVAT = TongTienHoaDonCoVAT;
            CurrentInwardVTYTMedDeptInvoice.TotalVATDifferenceAmount = TotalVATDifferenceAmount;
            CurrentInwardVTYTMedDeptInvoice.TotalVATAmountActual = CurrentInwardVTYTMedDeptInvoice.TotalVATAmount + CurrentInwardVTYTMedDeptInvoice.TotalVATDifferenceAmount;
        }

        private void Load_InwardVTYTDetails(long ID)
        {
            inviID = ID;
            InwardVTYTMedDeptList.PageIndex = 0;
            InwardVTYTDetails_ByID(CurrentInwardVTYTMedDeptInvoice.inviID, 0, Globals.PageSize);
        }

        private void InwardVTYTDetails_ByID(long ID, int PageIndex, int PageSize)
        {
            this.ShowBusyIndicator(eHCMSResources.Z0125_G1_DangXuLi);
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginGetInwardVTYTMedDept_ByIDInvoice(ID, PageSize, PageIndex, true, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                var results = contract.EndGetInwardVTYTMedDept_ByIDInvoice(out int total, out decimal TongTienSPChuaVAT, out decimal CKTrenSP
                                ...
                                InwardVTYTMedDeptList.Clear();
                                InwardVTYTMedDeptList.TotalItemCount = total;
                                if (results != null)
                                {
                                    foreach (InwardDrugMedDept p in results)
                                    {
                                        InwardVTYTMedDeptList.Add(p);
                                    }
                                }
        ...
        {
            if (CurrentInwardVTYTMedDeptInvoice.SelectedSupplier != null)
            {
                PharmacyPurchaseOrder_BySupplierID(CurrentInwardVTYTMedDeptInvoice.SelectedSupplier.SupplierID);
            }
            else
            {
        ...
        private void PharmacyPurchaseOrder_BySupplierID(long SupplierID)
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginDrugDeptPurchaseOrder_BySupplierID(SupplierID, (long)AllLookupValues.MedProductType.TIEM_NGUA, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
        ...
        private void GetInwardInvoiceDrugByID(long ID)
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginGetInwardVTYTMedDeptInvoice_ByID(ID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                CurrentInwardVTYTMedDeptInvoice = contract.EndGetInwardVTYTMedDeptInvoice_ByID(asyncResult);
                                DeepCopyInvoice();
                            }
                            catch (Exception ex)
                            {
        ...
        private void AddInwardInvoiceDrug()
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginAddInwardVTYTMedDeptInvoice(CurrentInwardVTYTMedDeptInvoice, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndAddInwardVTYTMedDeptInvoice(out long ID, asyncResult);
                                if (results == 0)
                                {
        ...
        {
            if (CurrentInwardVTYTMedDeptInvoice == null)
            {
                return false;
            }
            return CurrentInwardVTYTMedDeptInvoice.Validate();
        }
        ...
        public void BtnAdd(object sender, RoutedEventArgs e)
        {
            if (CheckValidate())
            {
                ...
                if (CurrentInwardVTYTMedDeptInvoice.VAT < 1 && CurrentInwardVTYTMedDeptInvoice.VAT > 0)
                {
                    Globals.ShowMessage(eHCMSResources.K0262_G1_VATKhongHopLe, eHCMSResources.G0442_G1_TBao);
                    return;
                }
                if (CurrentInwardVTYTMedDeptInvoice.DiscountingByPercent < 1 && CurrentInwardVTYTMedDeptInvoice.DiscountingByPercent > 0)
                {
                ...
                CurrentInwardVTYTMedDeptInvoice.CurrencyID = CurrentInwardVTYTMedDeptInvoice.SelectedCurrency.CurrencyID;
                CurrentInwardVTYTMedDeptInvoice.V_MedProductType = V_MedProductType;
        ...
        {
            if (CurrentInwardVTYTMedDept == null || CurrentInwardVTYTMedDept.GenMedProductID == null || CurrentInwardVTYTMedDept.GenMedProductID <= 0)
            {
                return;
            }

            GetRefGenMedProductDetails(CurrentInwardVTYTMedDept.GenMedProductID.GetValueOrDefault(), CurrentInwardVTYTMedDept.GenMedVersionID);
        }
        ...
        {
            CurrentInwardVTYTMedDeptInvoice.IsForeign = false;
        }
        public void rdtNgoaiNuoc_Checked(object sender, RoutedEventArgs e)
        {
            CurrentInwardVTYTMedDeptInvoice.IsForeign = true;
        }
        ...
        private void DrugDeptPurchaseOrderDetail_ByParentID(long PharmacyPoID)
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginDrugDeptPurchaseOrderDetail_ByParentID(PharmacyPoID, 1, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
        ...
        {
            if (CurrentInwardVTYTMedDeptInvoice == null || CurrentInwardVTYTMedDeptInvoice.SelectedSupplier == null || CurrentInwardInvoiceCopy == null || CurrentInwardInvoiceCopy.SelectedSupplier == null)
            {
                MessageBox.Show(string.Format("{0}!", eHCMSResources.Z0585_G1_PhNhapKgDuTTin), eHCMSResources.G0442_G1_TBao, MessageBoxButton.OK);
                return false;
            }

            if (CurrentInwardVTYTMedDeptInvoice.SelectedSupplier.SupplierID != CurrentInwardInvoiceCopy.SelectedSupplier.SupplierID)
            {
                MessageBox.Show(string.Format("{0}!", eHCMSResources.Z0586_G1_NCCDaThayDoi), eHCMSResources.G0442_G1_TBao, MessageBoxButton.OK);
                return false;
            }

            if (CurrentInwardVTYTMedDeptInvoice.CurrencyID != CurrentInwardInvoiceCopy.CurrencyID || CurrentInwardVTYTMedDeptInvoice.ExchangeRates != CurrentInwardInvoiceCopy.ExchangeRates || CurrentInwardVTYTMedDeptInvoice.VAT != CurrentInwardInvoiceCopy.VAT || CurrentInwardVTYTMedDeptInvoice.IsForeign != CurrentInwardInvoiceCopy.IsForeign || CurrentInwardVTYTMedDeptInvoice.Notes != CurrentInwardInvoiceCopy.Notes)
            {
                if (MessageBox.Show(eHCMSResources.Z0587_G1_CoMuonCNhatHD, eHCMSResources.G0442_G1_TBao, MessageBoxButton.OKCancel) == MessageBoxResult.OK)
                {
                    ...
                    {
                        CurrentInwardVTYTMedDeptInvoice = CurrentInwardInvoiceCopy;
                    }
                }
                else
                {
        ...
        private void InwardDrug_InsertList()
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginInwardVTYTMedDept_InsertList(DrugDeptPurchaseOrderDetailList.ToList(), CurrentInwardVTYTMedDeptInvoice.inviID, DrugDeptPoID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                contract.EndInwardVTYTMedDept_InsertList(asyncResult);
        ...
        private void ResetCurrentDrugDeptPurchaseOrderDetail()
        {
            if (CurrentDrugDeptPurchaseOrderDetail != null)
            {
                ...
                CurrentDrugDeptPurchaseOrderDetail.IsUnitPackage = true;
        ...
        {
            long? SupplierID = 0;
            if (CurrentInwardVTYTMedDeptInvoice != null && CurrentInwardVTYTMedDeptInvoice.SelectedSupplier != null)
            {
                SupplierID = CurrentInwardVTYTMedDeptInvoice.SelectedSupplier.SupplierID;
            }
            int totalCount = 0;
            var t = new Thread(() =>
            {
                ...
                {
                    var contract = serviceFactory.ServiceInstance;
                    contract.BeginRefGenMedProductDetails_SearchAutoPaging(IsCode, Name, SupplierID, V_MedProductType, null, PageSize, PageIndex, Globals.DispatchCallback((asyncResult) =>
                    {
        ...
        {
            Action<ISupplierProduct> onInitDlg = delegate (ISupplierProduct proAlloc)
            {
                proAlloc.IsChildWindow = true;
            };
            GlobalsNAV.ShowDialog<ISupplierProduct>(onInitDlg);
        }
        ...
        private void DeleteInwardDrug(long InID)
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginDeleteInwardVTYTMedDept(InID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndDeleteInwardVTYTMedDept(asyncResult);
                                if (results == 0)
                                {
                                    Load_InwardVTYTDetails(CurrentInwardVTYTMedDeptInvoice.inviID);
                                    InwardVTYTMedDeptInvoice_GetListCost(CurrentInwardVTYTMedDeptInvoice.inviID);
        ...
        {
            if (CurrentInwardVTYTMedDeptInvoice.CanEditAndDelete)
            {
                if (MessageBox.Show(eHCMSResources.A0118_G1_Msg_ConfXoaDong, eHCMSResources.G0442_G1_TBao, MessageBoxButton.OKCancel) == MessageBoxResult.OK)
                {
                    if (CurrentInwardVTYTMedDept != null)
                    {
                        DeleteInwardDrug(CurrentInwardVTYTMedDept.InID);
                    }
                }
            }
            else
        ...
        {
            CurrentInwardDrugMedDeptCopy = CurrentInwardVTYTMedDept.DeepCopy();
        }

        public void lnkEdit_Click(object sender, RoutedEventArgs e)
        {
            if (CurrentInwardVTYTMedDeptInvoice.DrugDeptSupplierPaymentReqID != null && CurrentInwardVTYTMedDeptInvoice.DrugDeptSupplierPaymentReqID > 0)
            {
            ...
            {
                if (CurrentInwardVTYTMedDeptInvoice.SelectedCurrency != null && CurrentInwardVTYTMedDeptInvoice.SelectedCurrency.CurrencyID != (long)AllLookupValues.CurrencyTable.VND)
                {
                ...
                proAlloc.CurrentInwardDrugMedDeptCopy = CurrentInwardVTYTMedDept.DeepCopy();
                proAlloc.SetValueForProperty();

                if (CurrentInwardVTYTMedDeptInvoice.CheckedPoint)
                {
        ...
        private void CheckEnableSupplier()
        {
            if ((DrugDeptPurchaseOrderDetailList != null && DrugDeptPurchaseOrderDetailList.Count > 0
                ...
                || (InwardVTYTMedDeptList != null && InwardVTYTMedDeptList.Count > 0))
            {
        ...
        public void OpenPopUpSearchInwardInvoice(IList<InwardDrugMedDeptInvoice> results, int Totalcount)
        {
            ...
            void onInitDlg(IDrugDeptInwardDrugSupplierSearch proAlloc)
            {
                ...
                proAlloc.V_MedProductType = V_MedProductType;
                 if (V_MedProductType == (long)AllLookupValues.MedProductType.MAU)
                {
                    proAlloc.strHienThi = eHCMSResources.T3709_G1_Mau.ToUpper();
                }
                else
                {
        ...
        private void SearchInwardInvoiceVTYT(int PageIndex, int PageSize)
        {
            if (SearchCriteria == null)
            {
                return;
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginSearchInwardVTYTMedDeptInvoice(SearchCriteria, TypID, V_MedProductType, PageIndex, PageSize, true, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                var results = contract.EndSearchInwardVTYTMedDeptInvoice(out int Totalcount, asyncResult);
                                if (results != null && results.Count > 0)
                                {
                                    if (results.Count > 1)
                                    {
                                    ...
                                    {
                                        CurrentInwardVTYTMedDeptInvoice = results.FirstOrDefault();
                                        InitDetailInward();
                                        DeepCopyInvoice();
        ...
        public void tbx_Search_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                ...
                SearchInwardInvoiceVTYT(0, Globals.PageSize);
            }
        }
        ...
        public void Handle(DrugDeptCloseSearchSupplierEvent message)
        {
            ...
            {
                CurrentInwardVTYTMedDeptInvoice.SelectedSupplier = message.SelectedSupplier as DrugDeptSupplier;
                PharmacyPurchaseOrder_BySupplierID();
            }
        }
        ...
        public void btnPreview()
        {
            Action<IDrugDeptReportDocumentPreview> onInitDlg = delegate (IDrugDeptReportDocumentPreview proAlloc)
            {
                ...
                {
                    proAlloc.eItem = ReportName.DRUGDEPT_INWARD_VTTH_SUPPLIER;
                }
                else
                {
                    proAlloc.eItem = ReportName.DRUGDEPT_INWARD_VTTH_SUPPLIER_TRONGNUOC;
                }

                if (V_MedProductType == (long)AllLookupValues.MedProductType.VATTU_TIEUHAO)
                {
                ...
                if (CurrentInwardVTYTMedDeptInvoice != null && CurrentInwardVTYTMedDeptInvoice.SelectedStaff != null)
                {
                    proAlloc.StaffFullName = CurrentInwardVTYTMedDeptInvoice.SelectedStaff.FullName;
                }
            };
        ...
        public void btnPrint()
        {
            ...
            var t = new Thread(() =>
            {
                using (var serviceFactory = new ReportServiceClient())
                {
                    ...
                    contract.BeginGetInWardVTTHInPdfFormat(CurrentInwardVTYTMedDeptInvoice.inviID, Globals.DispatchCallback((asyncResult) =>
                    {
                        try
                        {
                            var results = contract.EndGetInWardVTTHInPdfFormat(asyncResult);
        ...
        public void Handle(DrugDeptCloseSearchInwardIncoiceEvent message)
        {
            if (message != null && this.IsActive)
            {
                CurrentInwardVTYTMedDeptInvoice = message.SelectedInwardInvoice as InwardDrugMedDeptInvoice;
                InitDetailInward();
                DeepCopyInvoice();
                LoadInfoThenSelectedInvoice();
        ...
        private void InwardVTYTMedDeptInvoice_GetListCost(long inviID)
        {
            this.ShowBusyIndicator(eHCMSResources.Z0125_G1_DangXuLi);
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginInwardVTYTMedDeptInvoice_GetListCost(inviID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                var results = contract.EndInwardVTYTMedDeptInvoice_GetListCost(asyncResult);
                                CurrentInwardVTYTMedDeptInvoice.CostTableMedDeptLists = results.ToObservableCollection();
                                SumTotalPercent();
                            }
                            catch (Exception ex)
                            {
        ...
        {
            TotalPercent = 0;
            if (CurrentInwardVTYTMedDeptInvoice != null && CurrentInwardVTYTMedDeptInvoice.CostTableMedDeptLists != null)
            {
                for (int i = 0; i < CurrentInwardVTYTMedDeptInvoice.CostTableMedDeptLists.Count; i++)
                {
                    TotalPercent += CurrentInwardVTYTMedDeptInvoice.CostTableMedDeptLists[i].Rates;
                }
            }
        }
        #endregion
        ...
        public void ActualQD_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                if (CurrentInwardVTYTMedDeptInvoice != null && CurrentInwardVTYTMedDeptInvoice.ExchangeRates != 0)
                {
                    try
                    {
                        CurrentInwardVTYTMedDeptInvoice.TotalPriceActual_QĐ = Convert.ToDecimal((sender as TextBox).Text);
                    }
                    catch
                    {
                        Globals.ShowMessage(eHCMSResources.A0559_G1_Msg_InfoGTriKhHopLe, eHCMSResources.T0074_G1_I);
                    }
                    CurrentInwardVTYTMedDeptInvoice.TotalPriceActual = CurrentInwardVTYTMedDeptInvoice.TotalPriceActual_QĐ / (decimal)CurrentInwardVTYTMedDeptInvoice.ExchangeRates;
                }
            }
        }
        ...
        public void Actual_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                if (CurrentInwardVTYTMedDeptInvoice != null)
                {
                    try
                    {
                        CurrentInwardVTYTMedDeptInvoice.TotalPriceActual = Convert.ToDecimal((sender as TextBox).Text);
                    }
                    catch
                    {
                        Globals.ShowMessage(eHCMSResources.A0559_G1_Msg_InfoGTriKhHopLe, eHCMSResources.T0074_G1_I);

...
{
    [Export(typeof(IBloodMedDeptInwardSupplier)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class InwardBloodMedDeptSupplierViewModel : ViewModelBase, IBloodMedDeptInwardSupplier
        ...
        , IHandle<DrugDeptCloseEditInwardEvent>
    {
        ...
        public InwardBloodMedDeptSupplierViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventAggregator, ISalePosCaching salePosCaching)
        {
            ...
            InwardBloodMedDeptList = new PagedSortableCollectionView<InwardDrugMedDept>();
            InwardBloodMedDeptList.OnRefresh += new EventHandler<RefreshEventArgs>(InwardBloodMedDeptList_OnRefresh);
            InwardBloodMedDeptList.PageSize = Globals.PageSize;
        ...
        void InwardBloodMedDeptList_OnRefresh(object sender, RefreshEventArgs e)
        {
            InwardBloodDetails_ByID(inviID, InwardBloodMedDeptList.PageIndex, InwardBloodMedDeptList.PageSize);
        }
        ...
        private InwardDrugMedDeptInvoice _CurrentInwardBloodMedDeptInvoice;
        public InwardDrugMedDeptInvoice CurrentInwardBloodMedDeptInvoice
        {
            get
            {
                return _CurrentInwardBloodMedDeptInvoice;
            }
            set
            {
                if (_CurrentInwardBloodMedDeptInvoice != value)
                {
                    _CurrentInwardBloodMedDeptInvoice = value;
                    ...
                    NotifyOfPropertyChange(() => CurrentInwardBloodMedDeptInvoice);
                }
            }
        }
        ...
        private PagedSortableCollectionView<InwardDrugMedDept> _InwardBloodMedDeptList;
        public PagedSortableCollectionView<InwardDrugMedDept> InwardBloodMedDeptList
        {
            get
            {
                return _InwardBloodMedDeptList;
            }
            set
            {
                if (_InwardBloodMedDeptList != value)
                {
                    _InwardBloodMedDeptList = value;
                    NotifyOfPropertyChange(() => InwardBloodMedDeptList);
                }
            }
        }
        ...
        private InwardDrugMedDept _CurrentInwardBloodMedDept;
        public InwardDrugMedDept CurrentInwardBloodMedDept
        {
            get
            {
                return _CurrentInwardBloodMedDept;
            }
            set
            {
                if (_CurrentInwardBloodMedDept != value)
                {
                    _CurrentInwardBloodMedDept = value;
                    NotifyOfPropertyChange(() => CurrentInwardBloodMedDept);
                }
            }
        }
        ...
        private long _V_MedProductType = (long)AllLookupValues.MedProductType.MAU;
                    ...
                    using (var serviceFactory = new CommonService_V2Client())
                    {
                        ...
                        contract.BeginGetAllCurrency(value, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                ...
                                CurrentInwardBloodMedDeptInvoice.SelectedCurrency = Currencies.FirstOrDefault();
                            }
                            catch (Exception ex)
                            {
        ...
        private IEnumerator<IResult> DoGetStore_MedDept()
        {
            ...
            {
                CurrentInwardBloodMedDeptInvoice.SelectedStorage = StoreCbx.FirstOrDefault();
            }
            else
            {
        ...
        {
            CurrentInwardBloodMedDeptInvoice = new InwardDrugMedDeptInvoice
            {
            ...
            CurrentInwardBloodMedDeptInvoice.SelectedCurrency.CurrencyID = (long)AllLookupValues.CurrencyTable.VND;
            ...
            IsHideAuSupplier = true;
            if (InwardBloodMedDeptList != null)
            {
                InwardBloodMedDeptList.Clear();
            }
            DeepCopyInvoice();
            InitDetailInward();
            TotalPercent = 0;
        ...
        {
            CurrentInwardInvoiceCopy = CurrentInwardBloodMedDeptInvoice.DeepCopy();
        }
        ...
        private void DeleteInwardInvoice()
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginDeleteInwardBloodMedDeptInvoice(CurrentInwardBloodMedDeptInvoice.inviID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndDeleteInwardBloodMedDeptInvoice(asyncResult);
                                if (results == 0)
                                {
                                    InitializeInvoice();
        ...
        {
            if (CurrentInwardBloodMedDeptInvoice.SelectedCurrency == null || CurrentInwardBloodMedDeptInvoice.SelectedCurrency.CurrencyID == 0)
            {
            ...
            if (CurrentInwardBloodMedDeptInvoice.SelectedCurrency.CurrencyID != (long)AllLookupValues.CurrencyTable.VND)
            {
                if (CurrentInwardBloodMedDeptInvoice.ExchangeRates <= 0)
                {
            ...
            this.ShowBusyIndicator(eHCMSResources.Z0125_G1_DangXuLi);
            CurrentInwardBloodMedDeptInvoice.TypID = TypID;
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginUpdateInwardBloodMedDeptInvoice(CurrentInwardBloodMedDeptInvoice, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndUpdateInwardBloodMedDeptInvoice(asyncResult);
                                if (results == 0)
                                {
                                    DeepCopyInvoice();
                                    CheckIsPercentAll();
                                    Load_InwardBloodDetails(CurrentInwardBloodMedDeptInvoice.inviID);
                                    InwardBloodMedDeptInvoice_GetListCost(CurrentInwardBloodMedDeptInvoice.inviID);
        ...
        public void BtnEdit(object sender, RoutedEventArgs e)
        {
            if (MessageBox.Show(string.Format(eHCMSResources.Z0583_G1_CoMuonChinhSuaKg, eHCMSResources.Z0578_G1_PhNhap), eHCMSResources.G0442_G1_TBao, MessageBoxButton.OKCancel) == MessageBoxResult.OK)
            {
                if (CheckValidate())
                {
                    //▼===== #003
                    string ErrorMsg = "";
                    if (!Globals.CheckLimitCharaterOfInwardInvoice(out ErrorMsg, CurrentInwardBloodMedDeptInvoice.InvInvoiceNumber, CurrentInwardBloodMedDeptInvoice.SerialNumber))
                    {
                        MessageBox.Show(ErrorMsg, eHCMSResources.G0449_G1_TBaoLoi);
                        return;
                    }
                    //▲===== #003
                    if (CurrentInwardBloodMedDeptInvoice.SelectedStorage != null)
                    {
                        CurrentInwardBloodMedDeptInvoice.StoreID = CurrentInwardBloodMedDeptInvoice.SelectedStorage.StoreID;
                    }
                    if (CurrentInwardBloodMedDeptInvoice.SelectedCurrency != null)
                    {
                        CurrentInwardBloodMedDeptInvoice.CurrencyID = CurrentInwardBloodMedDeptInvoice.SelectedCurrency.CurrencyID;
                    }
        ...
        {
            CurrentInwardBloodMedDeptInvoice.TotalPriceNotVAT = TongTienSPChuaVAT;
            CurrentInwardBloodMedDeptInvoice.TotalDiscountOnProduct = CKTrenSP;//tong ck tren hoan don
            CurrentInwardBloodMedDeptInvoice.TotalDiscountInvoice = CKTrenSP + TongCKTrenHoaDon;
            CurrentInwardBloodMedDeptInvoice.TotalPrice = TongTienSPChuaVAT - (CKTrenSP + TongCKTrenHoaDon);
            CurrentInwardBloodMedDeptInvoice.TotalHaveCustomTax = TongTienHoaDonCoThueNK;
            CurrentInwardBloodMedDeptInvoice.TotalPriceVAT = TongTienHoaDonCoVAT;
            CurrentInwardBloodMedDeptInvoice.TotalVATDifferenceAmount = TotalVATDifferenceAmount;
            CurrentInwardBloodMedDeptInvoice.TotalVATAmountActual = CurrentInwardBloodMedDeptInvoice.TotalVATAmount + CurrentInwardBloodMedDeptInvoice.TotalVATDifferenceAmount;
        }

        private void Load_InwardBloodDetails(long ID)
        {
            inviID = ID;
            InwardBloodMedDeptList.PageIndex = 0;
            InwardBloodDetails_ByID(CurrentInwardBloodMedDeptInvoice.inviID, 0, Globals.PageSize);
        }

        private void InwardBloodDetails_ByID(long ID, int PageIndex, int PageSize)
        {
            this.ShowBusyIndicator(eHCMSResources.Z0125_G1_DangXuLi);
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginGetInwardBloodMedDept_ByIDInvoice(ID, PageSize, PageIndex, true, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                var results = contract.EndGetInwardBloodMedDept_ByIDInvoice(out int total, out decimal TongTienSPChuaVAT, out decimal CKTrenSP
                                ...
                                InwardBloodMedDeptList.Clear();
                                InwardBloodMedDeptList.TotalItemCount = total;
                                if (results != null)
                                {
                                    foreach (InwardDrugMedDept p in results)
                                    {
                                        InwardBloodMedDeptList.Add(p);
                                    }
                                }
        ...
        {
            if (CurrentInwardBloodMedDeptInvoice.SelectedSupplier != null)
            {
                PharmacyPurchaseOrder_BySupplierID(CurrentInwardBloodMedDeptInvoice.SelectedSupplier.SupplierID);
            }
            else
            {
        ...
        private void GetInwardInvoiceDrugByID(long ID)
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginGetInwardBloodMedDeptInvoice_ByID(ID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                CurrentInwardBloodMedDeptInvoice = contract.EndGetInwardBloodMedDeptInvoice_ByID(asyncResult);
                                DeepCopyInvoice();
                            }
                            catch (Exception ex)
                            {
        ...
        private void AddInwardInvoiceDrug()
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginAddInwardBloodMedDeptInvoice(CurrentInwardBloodMedDeptInvoice, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndAddInwardBloodMedDeptInvoice(out long ID, asyncResult);
                                if (results == 0)
                                {
        ...
        {
            if (CurrentInwardBloodMedDeptInvoice == null)
            {
                return false;
            }
            return CurrentInwardBloodMedDeptInvoice.Validate();
        }
        ...
        public void BtnAdd(object sender, RoutedEventArgs e)
        {
            ...
            if (CheckValidate())
            {
                ...
                if (CurrentInwardBloodMedDeptInvoice.VAT < 1 && CurrentInwardBloodMedDeptInvoice.VAT > 0)
                {
                    Globals.ShowMessage(eHCMSResources.K0262_G1_VATKhongHopLe, eHCMSResources.G0442_G1_TBao);
                    return;
                }
                if (CurrentInwardBloodMedDeptInvoice.DiscountingByPercent < 1 && CurrentInwardBloodMedDeptInvoice.DiscountingByPercent > 0)
                {
                ...
                //▲===== #001
                CurrentInwardBloodMedDeptInvoice.CurrencyID = CurrentInwardBloodMedDeptInvoice.SelectedCurrency.CurrencyID;
                CurrentInwardBloodMedDeptInvoice.V_MedProductType = V_MedProductType;
        ...
        {
            if (CurrentInwardBloodMedDept == null || CurrentInwardBloodMedDept.GenMedProductID == null || CurrentInwardBloodMedDept.GenMedProductID <= 0)
            {
                return;
            }

            GetRefGenMedProductDetails(CurrentInwardBloodMedDept.GenMedProductID.GetValueOrDefault(), CurrentInwardBloodMedDept.GenMedVersionID);
        }
        ...
        {
            CurrentInwardBloodMedDeptInvoice.IsForeign = false;
        }
        public void rdtNgoaiNuoc_Checked(object sender, RoutedEventArgs e)
        {
            CurrentInwardBloodMedDeptInvoice.IsForeign = true;
        }
        ...
        {
            if (CurrentInwardBloodMedDeptInvoice == null || CurrentInwardBloodMedDeptInvoice.SelectedSupplier == null || CurrentInwardInvoiceCopy == null || CurrentInwardInvoiceCopy.SelectedSupplier == null)
            {
                MessageBox.Show(string.Format("{0}!", eHCMSResources.Z0585_G1_PhNhapKgDuTTin), eHCMSResources.G0442_G1_TBao, MessageBoxButton.OK);
                return false;
            }

            if (CurrentInwardBloodMedDeptInvoice.SelectedSupplier.SupplierID != CurrentInwardInvoiceCopy.SelectedSupplier.SupplierID)
            {
                MessageBox.Show(string.Format("{0}!", eHCMSResources.Z0586_G1_NCCDaThayDoi), eHCMSResources.G0442_G1_TBao, MessageBoxButton.OK);
                return false;
            }

            if (CurrentInwardBloodMedDeptInvoice.CurrencyID != CurrentInwardInvoiceCopy.CurrencyID || CurrentInwardBloodMedDeptInvoice.ExchangeRates != CurrentInwardInvoiceCopy.ExchangeRates || CurrentInwardBloodMedDeptInvoice.VAT != CurrentInwardInvoiceCopy.VAT || CurrentInwardBloodMedDeptInvoice.IsForeign != CurrentInwardInvoiceCopy.IsForeign || CurrentInwardBloodMedDeptInvoice.Notes != CurrentInwardInvoiceCopy.Notes)
            {
                if (MessageBox.Show(eHCMSResources.Z0587_G1_CoMuonCNhatHD, eHCMSResources.G0442_G1_TBao, MessageBoxButton.OKCancel) == MessageBoxResult.OK)
                {
                    ...
                    {
                        CurrentInwardBloodMedDeptInvoice = CurrentInwardInvoiceCopy;
                    }
                }
                else
                {
        ...
        private void InwardDrug_InsertList()
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginInwardBloodMedDept_InsertList(DrugDeptPurchaseOrderDetailList.ToList(), CurrentInwardBloodMedDeptInvoice.inviID, DrugDeptPoID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                contract.EndInwardBloodMedDept_InsertList(asyncResult);
        ...
        private void AddBlankRow()
        {
            if (CheckBlankRow())
            {
                ...
                //    p.VAT = CurrentInwardBloodMedDeptInvoice.VAT - 1;
                //}
        ...
        {
            long? SupplierID = 0;
            if (CurrentInwardBloodMedDeptInvoice != null && CurrentInwardBloodMedDeptInvoice.SelectedSupplier != null)
            {
                SupplierID = CurrentInwardBloodMedDeptInvoice.SelectedSupplier.SupplierID;
            }
            int totalCount = 0;
            var t = new Thread(() =>
            {
        ...
        private void DeleteInwardDrug(long InID)
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginDeleteInwardBloodMedDept(InID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndDeleteInwardBloodMedDept(asyncResult);
                                if (results == 0)
                                {
                                    Load_InwardBloodDetails(CurrentInwardBloodMedDeptInvoice.inviID);
                                    InwardBloodMedDeptInvoice_GetListCost(CurrentInwardBloodMedDeptInvoice.inviID);
        ...
        {
            if (CurrentInwardBloodMedDeptInvoice.CanEditAndDelete)
            {
                if (MessageBox.Show(eHCMSResources.A0118_G1_Msg_ConfXoaDong, eHCMSResources.G0442_G1_TBao, MessageBoxButton.OKCancel) == MessageBoxResult.OK)
                {
                    if (CurrentInwardBloodMedDept != null)
                    {
                        DeleteInwardDrug(CurrentInwardBloodMedDept.InID);
                    }
                }
            }
            else
        ...
        {
            CurrentInwardDrugMedDeptCopy = CurrentInwardBloodMedDept.DeepCopy();
        }

        public void lnkEdit_Click(object sender, RoutedEventArgs e)
        {
            if (CurrentInwardBloodMedDeptInvoice.DrugDeptSupplierPaymentReqID != null && CurrentInwardBloodMedDeptInvoice.DrugDeptSupplierPaymentReqID > 0)
            {
            ...
            {
                if (CurrentInwardBloodMedDeptInvoice.SelectedCurrency != null && CurrentInwardBloodMedDeptInvoice.SelectedCurrency.CurrencyID != (long)AllLookupValues.CurrencyTable.VND)
                {
                ...
                proAlloc.CurrentInwardDrugMedDeptCopy = CurrentInwardBloodMedDept.DeepCopy();
                proAlloc.SetValueForProperty();

                if (CurrentInwardBloodMedDeptInvoice.CheckedPoint)
                {
        ...
        private void CheckEnableSupplier()
        {
            if ((DrugDeptPurchaseOrderDetailList != null && DrugDeptPurchaseOrderDetailList.Count > 0
                ...
                || (InwardBloodMedDeptList != null && InwardBloodMedDeptList.Count > 0))
            {
        ...
        private void SearchInwardInvoiceBlood(int PageIndex, int PageSize)
        {
            if (SearchCriteria == null)
            {
                return;
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginSearchInwardBloodMedDeptInvoice(SearchCriteria, TypID, V_MedProductType, PageIndex, PageSize, true, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                var results = contract.EndSearchInwardBloodMedDeptInvoice(out int Totalcount, asyncResult);
                                if (results != null && results.Count > 0)
                                {
                                    if (results.Count > 1)
                                    {
                                    ...
                                    {
                                        CurrentInwardBloodMedDeptInvoice = results.FirstOrDefault();
                                        InitDetailInward();
                                        DeepCopyInvoice();
        ...
        public void tbx_Search_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                ...
                SearchInwardInvoiceBlood(0, Globals.PageSize);
            }
        }
        ...
        public void Handle(DrugDeptCloseSearchSupplierEvent message)
        {
            ...
            {
                CurrentInwardBloodMedDeptInvoice.SelectedSupplier = message.SelectedSupplier as DrugDeptSupplier;
                PharmacyPurchaseOrder_BySupplierID();
            }
        }
        ...
        public void btnPreview()
        {
            Action<IDrugDeptReportDocumentPreview> onInitDlg = delegate (IDrugDeptReportDocumentPreview proAlloc)
            {
                ...
                {
                    proAlloc.eItem = ReportName.DRUGDEPT_INWARD_MAU_SUPPLIER;
                }
                else
                {
                    proAlloc.eItem = ReportName.DRUGDEPT_INWARD_MAU_SUPPLIER_TRONGNUOC;
                }
                ...
                if (CurrentInwardBloodMedDeptInvoice != null && CurrentInwardBloodMedDeptInvoice.SelectedStaff != null)
                {
                    proAlloc.StaffFullName = CurrentInwardBloodMedDeptInvoice.SelectedStaff.FullName;
                }
            };
        ...
        public void btnPrint()
        {
            ...
            var t = new Thread(() =>
            {
                using (var serviceFactory = new ReportServiceClient())
                {
                    ...
                    contract.BeginGetInWardBloodInPdfFormat(CurrentInwardBloodMedDeptInvoice.inviID, Globals.DispatchCallback((asyncResult) =>
                    {
                        try
                        {
                            var results = contract.EndGetInWardBloodInPdfFormat(asyncResult);
        ...
        public void Handle(DrugDeptCloseSearchInwardIncoiceEvent message)
        {
            if (message != null && this.IsActive)
            {
                CurrentInwardBloodMedDeptInvoice = message.SelectedInwardInvoice as InwardDrugMedDeptInvoice;
                InitDetailInward();
                DeepCopyInvoice();
                LoadInfoThenSelectedInvoice();
        ...
        private void InwardBloodMedDeptInvoice_GetListCost(long inviID)
        {
            this.ShowBusyIndicator(eHCMSResources.Z0125_G1_DangXuLi);
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginInwardBloodMedDeptInvoice_GetListCost(inviID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                var results = contract.EndInwardBloodMedDeptInvoice_GetListCost(asyncResult);
                                CurrentInwardBloodMedDeptInvoice.CostTableMedDeptLists = results.ToObservableCollection();
                                SumTotalPercent();
                            }
                            catch (Exception ex)
                            {
        ...
        {
            TotalPercent = 0;
            if (CurrentInwardBloodMedDeptInvoice != null && CurrentInwardBloodMedDeptInvoice.CostTableMedDeptLists != null)
            {
                for (int i = 0; i < CurrentInwardBloodMedDeptInvoice.CostTableMedDeptLists.Count; i++)
                {
                    TotalPercent += CurrentInwardBloodMedDeptInvoice.CostTableMedDeptLists[i].Rates;
                }
            }
        }
        #endregion
        ...
        public void ActualQD_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                if (CurrentInwardBloodMedDeptInvoice != null && CurrentInwardBloodMedDeptInvoice.ExchangeRates != 0)
                {
                    try
                    {
                        CurrentInwardBloodMedDeptInvoice.TotalPriceActual_QĐ = Convert.ToDecimal((sender as TextBox).Text);
                    }
                    catch
                    {
                        Globals.ShowMessage(eHCMSResources.A0559_G1_Msg_InfoGTriKhHopLe, eHCMSResources.T0074_G1_I);
                    }
                    CurrentInwardBloodMedDeptInvoice.TotalPriceActual = CurrentInwardBloodMedDeptInvoice.TotalPriceActual_QĐ / (decimal)CurrentInwardBloodMedDeptInvoice.ExchangeRates;
                }
            }
        }
        ...
        public void Actual_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                if (CurrentInwardBloodMedDeptInvoice != null)
                {
                    try
                    {
                        CurrentInwardBloodMedDeptInvoice.TotalPriceActual = Convert.ToDecimal((sender as TextBox).Text);
                    }
                    catch
                    {
                        Globals.ShowMessage(eHCMSResources.A0559_G1_Msg_InfoGTriKhHopLe, eHCMSResources.T0074_G1_I);

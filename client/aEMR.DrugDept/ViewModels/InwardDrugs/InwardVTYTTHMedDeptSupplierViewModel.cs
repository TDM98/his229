...
{
    [Export(typeof(IVTYTTHMedDeptInwardSupplier)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class InwardVTYTTHMedDeptSupplierViewModel : ViewModelBase, IVTYTTHMedDeptInwardSupplier
        ...
        , IHandle<DrugDeptCloseEditInwardEvent>
    {
        ...
        public InwardVTYTTHMedDeptSupplierViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventAggregator, ISalePosCaching salePosCaching)
        {
            ...
            InwardVTYTTHMedDeptList = new PagedSortableCollectionView<InwardDrugMedDept>();
            InwardVTYTTHMedDeptList.OnRefresh += new EventHandler<RefreshEventArgs>(InwardVTYTTHMedDeptList_OnRefresh);
            InwardVTYTTHMedDeptList.PageSize = Globals.PageSize;
        ...
        void InwardVTYTTHMedDeptList_OnRefresh(object sender, RefreshEventArgs e)
        {
            InwardVTYTTHDetails_ByID(inviID, InwardVTYTTHMedDeptList.PageIndex, InwardVTYTTHMedDeptList.PageSize);
        }
        ...
        private InwardDrugMedDeptInvoice _CurrentInwardVTYTTHMedDeptInvoice;
        public InwardDrugMedDeptInvoice CurrentInwardVTYTTHMedDeptInvoice
        {
            get
            {
                return _CurrentInwardVTYTTHMedDeptInvoice;
            }
            set
            {
                if (_CurrentInwardVTYTTHMedDeptInvoice != value)
                {
                    _CurrentInwardVTYTTHMedDeptInvoice = value;
                    ...
                    NotifyOfPropertyChange(() => CurrentInwardVTYTTHMedDeptInvoice);
                }
            }
        }
        ...
        private PagedSortableCollectionView<InwardDrugMedDept> _InwardVTYTTHMedDeptList;
        public PagedSortableCollectionView<InwardDrugMedDept> InwardVTYTTHMedDeptList
        {
            get
            {
                return _InwardVTYTTHMedDeptList;
            }
            set
            {
                if (_InwardVTYTTHMedDeptList != value)
                {
                    _InwardVTYTTHMedDeptList = value;
                    NotifyOfPropertyChange(() => InwardVTYTTHMedDeptList);
                }
            }
        }
        ...
        private long _V_MedProductType = (long)AllLookupValues.MedProductType.VTYT_TIEUHAO;
                    ...
                    using (var serviceFactory = new CommonService_V2Client())
                    {
                        ...
                        contract.BeginGetAllCurrency(value, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                ...
                                CurrentInwardVTYTTHMedDeptInvoice.SelectedCurrency = Currencies.FirstOrDefault();
                            }
                            catch (Exception ex)
                            {
        ...
        private IEnumerator<IResult> DoGetStore_MedDept()
        {
            ...
            {
                CurrentInwardVTYTTHMedDeptInvoice.SelectedStorage = StoreCbx.FirstOrDefault();
            }
            else
            {
        ...
        {
            CurrentInwardVTYTTHMedDeptInvoice = new InwardDrugMedDeptInvoice
            {
            ...
            CurrentInwardVTYTTHMedDeptInvoice.SelectedCurrency.CurrencyID = (long)AllLookupValues.CurrencyTable.VND;
            ...
            IsHideAuSupplier = true;
            if (InwardVTYTTHMedDeptList != null)
            {
                InwardVTYTTHMedDeptList.Clear();
            }
            DeepCopyInvoice();
            InitDetailInward();
            TotalPercent = 0;
        ...
        {
            CurrentInwardInvoiceCopy = CurrentInwardVTYTTHMedDeptInvoice.DeepCopy();
        }
        ...
        private void DeleteInwardInvoiceDrug()
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginDeleteInwardVTYTTHMedDeptInvoice(CurrentInwardVTYTTHMedDeptInvoice.inviID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndDeleteInwardVTYTTHMedDeptInvoice(asyncResult);
                                if (results == 0)
                                {
                                    InitializeInvoiceDrug();
        ...
        {
            if (CurrentInwardVTYTTHMedDeptInvoice.SelectedCurrency == null || CurrentInwardVTYTTHMedDeptInvoice.SelectedCurrency.CurrencyID == 0)
            {
            ...
            if (CurrentInwardVTYTTHMedDeptInvoice.SelectedCurrency.CurrencyID != (long)AllLookupValues.CurrencyTable.VND)
            {
                if (CurrentInwardVTYTTHMedDeptInvoice.ExchangeRates <= 0)
                {
            ...
            this.ShowBusyIndicator(eHCMSResources.Z0125_G1_DangXuLi);
            CurrentInwardVTYTTHMedDeptInvoice.TypID = TypID;
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginUpdateInwardVTYTTHMedDeptInvoice(CurrentInwardVTYTTHMedDeptInvoice, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndUpdateInwardVTYTTHMedDeptInvoice(asyncResult);
                                if (results == 0)
                                {
                                    DeepCopyInvoice();
                                    CheckIsPercentAll();
                                    Load_InwardVTYTTHDetails(CurrentInwardVTYTTHMedDeptInvoice.inviID);
                                    InwardVTYTTHMedDeptInvoice_GetListCost(CurrentInwardVTYTTHMedDeptInvoice.inviID);
        ...
        public void BtnEdit(object sender, RoutedEventArgs e)
        {
            if (MessageBox.Show(string.Format(eHCMSResources.Z0583_G1_CoMuonChinhSuaKg, eHCMSResources.Z0578_G1_PhNhap), eHCMSResources.G0442_G1_TBao, MessageBoxButton.OKCancel) == MessageBoxResult.OK)
            {
                if (CheckValidate())
                {
                    //▼===== #002
                    string ErrorMsg = "";
                    if (!Globals.CheckLimitCharaterOfInwardInvoice(out ErrorMsg, CurrentInwardVTYTTHMedDeptInvoice.InvInvoiceNumber, CurrentInwardVTYTTHMedDeptInvoice.SerialNumber))
                    {
                        MessageBox.Show(ErrorMsg, eHCMSResources.G0449_G1_TBaoLoi);
                        return;
                    }
                    //▲===== #002
                    if (CurrentInwardVTYTTHMedDeptInvoice.SelectedStorage != null)
                    {
                        CurrentInwardVTYTTHMedDeptInvoice.StoreID = CurrentInwardVTYTTHMedDeptInvoice.SelectedStorage.StoreID;
                    }
                    if (CurrentInwardVTYTTHMedDeptInvoice.SelectedCurrency != null)
                    {
                        CurrentInwardVTYTTHMedDeptInvoice.CurrencyID = CurrentInwardVTYTTHMedDeptInvoice.SelectedCurrency.CurrencyID;
                    }
        ...
        {
            CurrentInwardVTYTTHMedDeptInvoice.TotalPriceNotVAT = TongTienSPChuaVAT;
            CurrentInwardVTYTTHMedDeptInvoice.TotalDiscountOnProduct = CKTrenSP;//tong ck tren hoan don
            CurrentInwardVTYTTHMedDeptInvoice.TotalDiscountInvoice = CKTrenSP + TongCKTrenHoaDon;
            CurrentInwardVTYTTHMedDeptInvoice.TotalPrice = TongTienSPChuaVAT - (CKTrenSP + TongCKTrenHoaDon);
            CurrentInwardVTYTTHMedDeptInvoice.TotalHaveCustomTax = TongTienHoaDonCoThueNK;
            CurrentInwardVTYTTHMedDeptInvoice.TotalPriceVAT = TongTienHoaDonCoVAT;
            CurrentInwardVTYTTHMedDeptInvoice.TotalVATDifferenceAmount = TotalVATDifferenceAmount;
            CurrentInwardVTYTTHMedDeptInvoice.TotalVATAmountActual = CurrentInwardVTYTTHMedDeptInvoice.TotalVATAmount + CurrentInwardVTYTTHMedDeptInvoice.TotalVATDifferenceAmount;
        }

        private void Load_InwardVTYTTHDetails(long ID)
        {
            inviID = ID;
            InwardVTYTTHMedDeptList.PageIndex = 0;
            InwardVTYTTHDetails_ByID(CurrentInwardVTYTTHMedDeptInvoice.inviID, 0, Globals.PageSize);
        }

        private void InwardVTYTTHDetails_ByID(long ID, int PageIndex, int PageSize)
        {
            this.ShowBusyIndicator(eHCMSResources.Z0125_G1_DangXuLi);
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginGetInwardVTYTTHMedDept_ByIDInvoice(ID, PageSize, PageIndex, true, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                var results = contract.EndGetInwardVTYTTHMedDept_ByIDInvoice(out int total, out decimal TongTienSPChuaVAT, out decimal CKTrenSP
                                ...
                                InwardVTYTTHMedDeptList.Clear();
                                InwardVTYTTHMedDeptList.TotalItemCount = total;
                                if (results != null)
                                {
                                    foreach (InwardDrugMedDept p in results)
                                    {
                                        InwardVTYTTHMedDeptList.Add(p);
                                    }
                                }
        ...
        {
            if (CurrentInwardVTYTTHMedDeptInvoice.SelectedSupplier != null)
            {
                PharmacyPurchaseOrder_BySupplierID(CurrentInwardVTYTTHMedDeptInvoice.SelectedSupplier.SupplierID);
            }
            else
            {
        ...
        private void GetInwardInvoiceDrugByID(long ID)
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginGetInwardVTYTTHMedDeptInvoice_ByID(ID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                CurrentInwardVTYTTHMedDeptInvoice = contract.EndGetInwardVTYTTHMedDeptInvoice_ByID(asyncResult);
                                DeepCopyInvoice();
                            }
                            catch (Exception ex)
                            {
        ...
        private void AddInwardInvoiceDrug()
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginAddInwardVTYTTHMedDeptInvoice(CurrentInwardVTYTTHMedDeptInvoice, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndAddInwardVTYTTHMedDeptInvoice(out long ID, asyncResult);
                                if (results == 0)
                                {
        ...
        {
            if (CurrentInwardVTYTTHMedDeptInvoice == null)
            {
                return false;
            }
            return CurrentInwardVTYTTHMedDeptInvoice.Validate();
        }
        ...
        public void BtnAdd(object sender, RoutedEventArgs e)
        {
            ...
            if (CheckValidate())
            {
                ...
                if (CurrentInwardVTYTTHMedDeptInvoice.VAT < 1 && CurrentInwardVTYTTHMedDeptInvoice.VAT > 0)
                {
                    Globals.ShowMessage(eHCMSResources.K0262_G1_VATKhongHopLe, eHCMSResources.G0442_G1_TBao);
                    return;
                }
                if (CurrentInwardVTYTTHMedDeptInvoice.DiscountingByPercent < 1 && CurrentInwardVTYTTHMedDeptInvoice.DiscountingByPercent > 0)
                {
                ...
                CurrentInwardVTYTTHMedDeptInvoice.CurrencyID = CurrentInwardVTYTTHMedDeptInvoice.SelectedCurrency.CurrencyID;
                CurrentInwardVTYTTHMedDeptInvoice.V_MedProductType = V_MedProductType;
        ...
        {
            CurrentInwardVTYTTHMedDeptInvoice.IsForeign = false;
        }
        public void rdtNgoaiNuoc_Checked(object sender, RoutedEventArgs e)
        {
            CurrentInwardVTYTTHMedDeptInvoice.IsForeign = true;
        }
        ...
        {
            if (CurrentInwardVTYTTHMedDeptInvoice == null || CurrentInwardVTYTTHMedDeptInvoice.SelectedSupplier == null || CurrentInwardInvoiceCopy == null || CurrentInwardInvoiceCopy.SelectedSupplier == null)
            {
                MessageBox.Show(string.Format("{0}!", eHCMSResources.Z0585_G1_PhNhapKgDuTTin), eHCMSResources.G0442_G1_TBao, MessageBoxButton.OK);
                return false;
            }

            if (CurrentInwardVTYTTHMedDeptInvoice.SelectedSupplier.SupplierID != CurrentInwardInvoiceCopy.SelectedSupplier.SupplierID)
            {
                MessageBox.Show(string.Format("{0}!", eHCMSResources.Z0586_G1_NCCDaThayDoi), eHCMSResources.G0442_G1_TBao, MessageBoxButton.OK);
                return false;
            }

            if (CurrentInwardVTYTTHMedDeptInvoice.CurrencyID != CurrentInwardInvoiceCopy.CurrencyID || CurrentInwardVTYTTHMedDeptInvoice.ExchangeRates != CurrentInwardInvoiceCopy.ExchangeRates || CurrentInwardVTYTTHMedDeptInvoice.VAT != CurrentInwardInvoiceCopy.VAT || CurrentInwardVTYTTHMedDeptInvoice.IsForeign != CurrentInwardInvoiceCopy.IsForeign || CurrentInwardVTYTTHMedDeptInvoice.Notes != CurrentInwardInvoiceCopy.Notes)
            {
                if (MessageBox.Show(eHCMSResources.Z0587_G1_CoMuonCNhatHD, eHCMSResources.G0442_G1_TBao, MessageBoxButton.OKCancel) == MessageBoxResult.OK)
                {
                    ...
                    {
                        CurrentInwardVTYTTHMedDeptInvoice = CurrentInwardInvoiceCopy;
                    }
                }
                else
                {
        ...
        private void InwardDrug_InsertList()
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginInwardVTYTTHMedDept_InsertList(DrugDeptPurchaseOrderDetailList.ToList(), CurrentInwardVTYTTHMedDeptInvoice.inviID, DrugDeptPoID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                contract.EndInwardVTYTTHMedDept_InsertList(asyncResult);
        ...
        private void AddBlankRow()
        {
            if (CheckBlankRow())
            {
                ...
                //    p.VAT = CurrentInwardVTYTTHMedDeptInvoice.VAT - 1;
                //}
        ...
        {
            long? SupplierID = 0;
            if (CurrentInwardVTYTTHMedDeptInvoice != null && CurrentInwardVTYTTHMedDeptInvoice.SelectedSupplier != null)
            {
                SupplierID = CurrentInwardVTYTTHMedDeptInvoice.SelectedSupplier.SupplierID;
            }
            int totalCount = 0;
            var t = new Thread(() =>
            {
        ...
        private void DeleteInwardDrug(long InID)
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginDeleteInwardVTYTTHMedDept(InID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndDeleteInwardVTYTTHMedDept(asyncResult);
                                if (results == 0)
                                {
                                    Load_InwardVTYTTHDetails(CurrentInwardVTYTTHMedDeptInvoice.inviID);
                                    InwardVTYTTHMedDeptInvoice_GetListCost(CurrentInwardVTYTTHMedDeptInvoice.inviID);
        ...
        {
            if (CurrentInwardVTYTTHMedDeptInvoice.CanEditAndDelete)
            {
                if (MessageBox.Show(eHCMSResources.A0118_G1_Msg_ConfXoaDong, eHCMSResources.G0442_G1_TBao, MessageBoxButton.OKCancel) == MessageBoxResult.OK)
                {
        ...
        {
            if (CurrentInwardVTYTTHMedDeptInvoice.DrugDeptSupplierPaymentReqID != null && CurrentInwardVTYTTHMedDeptInvoice.DrugDeptSupplierPaymentReqID > 0)
            {
            ...
            Action<IVTYTTHEditInward> onInitDlg = delegate (IVTYTTHEditInward proAlloc)
            {
                if (CurrentInwardVTYTTHMedDeptInvoice.SelectedCurrency != null && CurrentInwardVTYTTHMedDeptInvoice.SelectedCurrency.CurrencyID != (long)AllLookupValues.CurrencyTable.VND)
                {
                ...
                if (CurrentInwardVTYTTHMedDeptInvoice.CheckedPoint)
                {
            ...
            GlobalsNAV.ShowDialog<IVTYTTHEditInward>(onInitDlg);
        }
        ...
        private void CheckEnableSupplier()
        {
            if ((DrugDeptPurchaseOrderDetailList != null && DrugDeptPurchaseOrderDetailList.Count > 0
                ...
                || (InwardVTYTTHMedDeptList != null && InwardVTYTTHMedDeptList.Count > 0))
            {
        ...
        private void SearchInwardInvoiceVTYTTH(int PageIndex, int PageSize)
        {
            if (SearchCriteria == null)
            {
                return;
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginSearchInwardVTYTTHMedDeptInvoice(SearchCriteria, TypID, V_MedProductType, PageIndex, PageSize, true, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                var results = contract.EndSearchInwardVTYTTHMedDeptInvoice(out int Totalcount, asyncResult);
                                if (results != null && results.Count > 0)
                                {
                                    if (results.Count > 1)
                                    {
                                    ...
                                    {
                                        CurrentInwardVTYTTHMedDeptInvoice = results.FirstOrDefault();
                                        InitDetailInward();
                                        DeepCopyInvoice();
        ...
        public void tbx_Search_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                ...
                SearchInwardInvoiceVTYTTH(0, Globals.PageSize);
            }
        }
        ...
        public void Handle(DrugDeptCloseSearchSupplierEvent message)
        {
            ...
            {
                CurrentInwardVTYTTHMedDeptInvoice.SelectedSupplier = message.SelectedSupplier as DrugDeptSupplier;
                PharmacyPurchaseOrder_BySupplierID();
            }
        }
        ...
        public void btnPreview()
        {
            Action<IDrugDeptReportDocumentPreview> onInitDlg = delegate (IDrugDeptReportDocumentPreview proAlloc)
            {
                ...
                {
                    proAlloc.eItem = ReportName.DRUGDEPT_INWARD_VTYTTHSUPPLIER;
                }
                else
                {
                    proAlloc.eItem = ReportName.DRUGDEPT_INWARD_VTYTTHSUPPLIER_TRONGNUOC;
                }
                ...
                if (CurrentInwardVTYTTHMedDeptInvoice != null && CurrentInwardVTYTTHMedDeptInvoice.SelectedStaff != null)
                {
                    proAlloc.StaffFullName = CurrentInwardVTYTTHMedDeptInvoice.SelectedStaff.FullName;
                }
            };
        ...
        public void btnPrint()
        {
            ...
            var t = new Thread(() =>
            {
                using (var serviceFactory = new ReportServiceClient())
                {
                    ...
                    contract.BeginGetInWardVTYTTHInPdfFormat(CurrentInwardVTYTTHMedDeptInvoice.inviID, Globals.DispatchCallback((asyncResult) =>
                    {
                        try
                        {
                            var results = contract.EndGetInWardVTYTTHInPdfFormat(asyncResult);
        ...
        public void Handle(DrugDeptCloseSearchInwardIncoiceEvent message)
        {
            if (message != null && this.IsActive)
            {
                CurrentInwardVTYTTHMedDeptInvoice = message.SelectedInwardInvoice as InwardDrugMedDeptInvoice;
                InitDetailInward();
                DeepCopyInvoice();
                LoadInfoThenSelectedInvoice();
        ...
        private void InwardVTYTTHMedDeptInvoice_GetListCost(long inviID)
        {
            this.ShowBusyIndicator(eHCMSResources.Z0125_G1_DangXuLi);
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginInwardVTYTTHMedDeptInvoice_GetListCost(inviID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                var results = contract.EndInwardVTYTTHMedDeptInvoice_GetListCost(asyncResult);
                                CurrentInwardVTYTTHMedDeptInvoice.CostTableMedDeptLists = results.ToObservableCollection();
                                SumTotalPercent();
                            }
                            catch (Exception ex)
                            {
        ...
        {
            TotalPercent = 0;
            if (CurrentInwardVTYTTHMedDeptInvoice != null && CurrentInwardVTYTTHMedDeptInvoice.CostTableMedDeptLists != null)
            {
                for (int i = 0; i < CurrentInwardVTYTTHMedDeptInvoice.CostTableMedDeptLists.Count; i++)
                {
                    TotalPercent += CurrentInwardVTYTTHMedDeptInvoice.CostTableMedDeptLists[i].Rates;
                }
            }
        }
        #endregion
        ...
        public void ActualQD_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                if (CurrentInwardVTYTTHMedDeptInvoice != null && CurrentInwardVTYTTHMedDeptInvoice.ExchangeRates != 0)
                {
                    try
                    {
                        CurrentInwardVTYTTHMedDeptInvoice.TotalPriceActual_QĐ = Convert.ToDecimal((sender as TextBox).Text);
                    }
                    catch
                    {
                        Globals.ShowMessage(eHCMSResources.A0559_G1_Msg_InfoGTriKhHopLe, eHCMSResources.T0074_G1_I);
                    }
                    CurrentInwardVTYTTHMedDeptInvoice.TotalPriceActual = CurrentInwardVTYTTHMedDeptInvoice.TotalPriceActual_QĐ / (decimal)CurrentInwardVTYTTHMedDeptInvoice.ExchangeRates;
                }
            }
        }
        ...
        public void Actual_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                if (CurrentInwardVTYTTHMedDeptInvoice != null)
                {
                    try
                    {
                        CurrentInwardVTYTTHMedDeptInvoice.TotalPriceActual = Convert.ToDecimal((sender as TextBox).Text);
                    }
                    catch
                    {
                        Globals.ShowMessage(eHCMSResources.A0559_G1_Msg_InfoGTriKhHopLe, eHCMSResources.T0074_G1_I);

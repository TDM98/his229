 ...
 * 20211102 #004 QTD: Lọc kho theo cấu hình trách nhiệm
 */

namespace aEMR.DrugDept.ViewModels
{
    [Export(typeof(IChemicalMedDeptInwardSupplier)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class InwardChemicalMedDeptSupplierViewModel : ViewModelBase, IChemicalMedDeptInwardSupplier
        ...
        , IHandle<DrugDeptCloseEditInwardEvent>
    {
        ...
        public InwardChemicalMedDeptSupplierViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventAggregator, ISalePosCaching salePosCaching)
        {
            ...
            InwardChemicalMedDeptList = new PagedSortableCollectionView<InwardDrugMedDept>();
            InwardChemicalMedDeptList.OnRefresh += new EventHandler<RefreshEventArgs>(InwardChemicalMedDeptList_OnRefresh);
            InwardChemicalMedDeptList.PageSize = Globals.PageSize;
        ...
        void InwardChemicalMedDeptList_OnRefresh(object sender, RefreshEventArgs e)
        {
            InwardChemicalDetails_ByID(inviID, InwardChemicalMedDeptList.PageIndex, InwardChemicalMedDeptList.PageSize);
        }
        ...
        private InwardDrugMedDeptInvoice _CurrentInwardChemicalMedDeptInvoice;
        public InwardDrugMedDeptInvoice CurrentInwardChemicalMedDeptInvoice
        {
            get
            {
                return _CurrentInwardChemicalMedDeptInvoice;
            }
            set
            {
                if (_CurrentInwardChemicalMedDeptInvoice != value)
                {
                    _CurrentInwardChemicalMedDeptInvoice = value;
                    ...
                    NotifyOfPropertyChange(() => CurrentInwardChemicalMedDeptInvoice);
                }
            }
        }
        ...
        private PagedSortableCollectionView<InwardDrugMedDept> _InwardChemicalMedDeptList;
        public PagedSortableCollectionView<InwardDrugMedDept> InwardChemicalMedDeptList
        {
            get
            {
                return _InwardChemicalMedDeptList;
            }
            set
            {
                if (_InwardChemicalMedDeptList != value)
                {
                    _InwardChemicalMedDeptList = value;
                    NotifyOfPropertyChange(() => InwardChemicalMedDeptList);
                }
            }
        }
        ...
        private long _V_MedProductType = (long)AllLookupValues.MedProductType.HOA_CHAT;
                    ...
                    using (var serviceFactory = new CommonService_V2Client())
                    {
                        ...
                        contract.BeginGetAllCurrency(value, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                ...
                                CurrentInwardChemicalMedDeptInvoice.SelectedCurrency = Currencies.FirstOrDefault();
                            }
                            catch (Exception ex)
                            {
        ...
        private IEnumerator<IResult> DoGetStore_MedDept()
        {
            ...
            {
                CurrentInwardChemicalMedDeptInvoice.SelectedStorage = StoreCbx.FirstOrDefault();
            }
            else
            {
        ...
        {
            CurrentInwardChemicalMedDeptInvoice = new InwardDrugMedDeptInvoice
            {
            ...
            CurrentInwardChemicalMedDeptInvoice.SelectedCurrency.CurrencyID = (long)AllLookupValues.CurrencyTable.VND;
            ...
            IsHideAuSupplier = true;
            if (InwardChemicalMedDeptList != null)
            {
                InwardChemicalMedDeptList.Clear();
            }
            DeepCopyInvoice();
            InitDetailInward();
            TotalPercent = 0;
        ...
        {
            CurrentInwardInvoiceCopy = CurrentInwardChemicalMedDeptInvoice.DeepCopy();
        }
        ...
        private void DeleteInwardInvoice()
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginDeleteInwardChemicalMedDeptInvoice(CurrentInwardChemicalMedDeptInvoice.inviID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndDeleteInwardChemicalMedDeptInvoice(asyncResult);
                                if (results == 0)
                                {
                                    InitializeInvoice();
        ...
        {
            if (CurrentInwardChemicalMedDeptInvoice.SelectedCurrency == null || CurrentInwardChemicalMedDeptInvoice.SelectedCurrency.CurrencyID == 0)
            {
            ...
            if (CurrentInwardChemicalMedDeptInvoice.SelectedCurrency.CurrencyID != (long)AllLookupValues.CurrencyTable.VND)
            {
                if (CurrentInwardChemicalMedDeptInvoice.ExchangeRates <= 0)
                {
            ...
            this.ShowBusyIndicator(eHCMSResources.Z0125_G1_DangXuLi);
            CurrentInwardChemicalMedDeptInvoice.TypID = TypID;
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginUpdateInwardChemicalMedDeptInvoice(CurrentInwardChemicalMedDeptInvoice, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndUpdateInwardChemicalMedDeptInvoice(asyncResult);
                                if (results == 0)
                                {
                                    DeepCopyInvoice();
                                    CheckIsPercentAll();
                                    Load_InwardChemicalDetails(CurrentInwardChemicalMedDeptInvoice.inviID);
                                    InwardChemicalMedDeptInvoice_GetListCost(CurrentInwardChemicalMedDeptInvoice.inviID);
        ...
        public void BtnEdit(object sender, RoutedEventArgs e)
        {
            if (MessageBox.Show(string.Format(eHCMSResources.Z0583_G1_CoMuonChinhSuaKg, eHCMSResources.Z0578_G1_PhNhap), eHCMSResources.G0442_G1_TBao, MessageBoxButton.OKCancel) == MessageBoxResult.OK)
            {
                if (CheckValidate())
                {
                    //▼===== #002
                    string ErrorMsg = "";
                    if (!Globals.CheckLimitCharaterOfInwardInvoice(out ErrorMsg, CurrentInwardChemicalMedDeptInvoice.InvInvoiceNumber, CurrentInwardChemicalMedDeptInvoice.SerialNumber))
                    {
                        MessageBox.Show(ErrorMsg, eHCMSResources.G0449_G1_TBaoLoi);
                        return;
                    }
                    //▲===== #002
                    if (CurrentInwardChemicalMedDeptInvoice.SelectedStorage != null)
                    {
                        CurrentInwardChemicalMedDeptInvoice.StoreID = CurrentInwardChemicalMedDeptInvoice.SelectedStorage.StoreID;
                    }
                    if (CurrentInwardChemicalMedDeptInvoice.SelectedCurrency != null)
                    {
                        CurrentInwardChemicalMedDeptInvoice.CurrencyID = CurrentInwardChemicalMedDeptInvoice.SelectedCurrency.CurrencyID;
                    }
        ...
        {
            CurrentInwardChemicalMedDeptInvoice.TotalPriceNotVAT = TongTienSPChuaVAT;
            CurrentInwardChemicalMedDeptInvoice.TotalDiscountOnProduct = CKTrenSP;//tong ck tren hoan don
            CurrentInwardChemicalMedDeptInvoice.TotalDiscountInvoice = CKTrenSP + TongCKTrenHoaDon;
            CurrentInwardChemicalMedDeptInvoice.TotalPrice = TongTienSPChuaVAT - (CKTrenSP + TongCKTrenHoaDon);
            CurrentInwardChemicalMedDeptInvoice.TotalHaveCustomTax = TongTienHoaDonCoThueNK;
            CurrentInwardChemicalMedDeptInvoice.TotalPriceVAT = TongTienHoaDonCoVAT;
            CurrentInwardChemicalMedDeptInvoice.TotalVATDifferenceAmount = TotalVATDifferenceAmount;
            CurrentInwardChemicalMedDeptInvoice.TotalVATAmountActual = CurrentInwardChemicalMedDeptInvoice.TotalVATAmount + CurrentInwardChemicalMedDeptInvoice.TotalVATDifferenceAmount;
        }

        private void Load_InwardChemicalDetails(long ID)
        {
            inviID = ID;
            InwardChemicalMedDeptList.PageIndex = 0;
            InwardChemicalDetails_ByID(CurrentInwardChemicalMedDeptInvoice.inviID, 0, Globals.PageSize);
        }

        private void InwardChemicalDetails_ByID(long ID, int PageIndex, int PageSize)
        {
            this.ShowBusyIndicator(eHCMSResources.Z0125_G1_DangXuLi);
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginGetInwardChemicalMedDept_ByIDInvoice(ID, PageSize, PageIndex, true, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                var results = contract.EndGetInwardChemicalMedDept_ByIDInvoice(out int total, out decimal TongTienSPChuaVAT, out decimal CKTrenSP
                                ...
                                InwardChemicalMedDeptList.Clear();
                                InwardChemicalMedDeptList.TotalItemCount = total;
                                if (results != null)
                                {
                                    foreach (InwardDrugMedDept p in results)
                                    {
                                        InwardChemicalMedDeptList.Add(p);
                                    }
                                }
        ...
        {
            if (CurrentInwardChemicalMedDeptInvoice.SelectedSupplier != null)
            {
                PharmacyPurchaseOrder_BySupplierID(CurrentInwardChemicalMedDeptInvoice.SelectedSupplier.SupplierID);
            }
            else
            {
        ...
        private void GetInwardInvoiceDrugByID(long ID)
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginGetInwardChemicalMedDeptInvoice_ByID(ID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                CurrentInwardChemicalMedDeptInvoice = contract.EndGetInwardChemicalMedDeptInvoice_ByID(asyncResult);
                                DeepCopyInvoice();
                            }
                            catch (Exception ex)
                            {
        ...
        private void AddInwardInvoiceDrug()
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginAddInwardChemicalMedDeptInvoice(CurrentInwardChemicalMedDeptInvoice, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndAddInwardChemicalMedDeptInvoice(out long ID, asyncResult);
                                if (results == 0)
                                {
        ...
        {
            if (CurrentInwardChemicalMedDeptInvoice == null)
            {
                return false;
            }
            return CurrentInwardChemicalMedDeptInvoice.Validate();
        }
        ...
        public void BtnAdd(object sender, RoutedEventArgs e)
        {
            ...
            if (CheckValidate())
            {
                ...
                if (CurrentInwardChemicalMedDeptInvoice.VAT < 1 && CurrentInwardChemicalMedDeptInvoice.VAT > 0)
                {
                    Globals.ShowMessage(eHCMSResources.K0262_G1_VATKhongHopLe, eHCMSResources.G0442_G1_TBao);
                    return;
                }
                if (CurrentInwardChemicalMedDeptInvoice.DiscountingByPercent < 1 && CurrentInwardChemicalMedDeptInvoice.DiscountingByPercent > 0)
                {
                ...
                //▲===== #002
                CurrentInwardChemicalMedDeptInvoice.CurrencyID = CurrentInwardChemicalMedDeptInvoice.SelectedCurrency.CurrencyID;
                CurrentInwardChemicalMedDeptInvoice.V_MedProductType = V_MedProductType;
        ...
        {
            CurrentInwardChemicalMedDeptInvoice.IsForeign = false;
        }
        public void rdtNgoaiNuoc_Checked(object sender, RoutedEventArgs e)
        {
            CurrentInwardChemicalMedDeptInvoice.IsForeign = true;
        }
        ...
        {
            if (CurrentInwardChemicalMedDeptInvoice == null || CurrentInwardChemicalMedDeptInvoice.SelectedSupplier == null || CurrentInwardInvoiceCopy == null || CurrentInwardInvoiceCopy.SelectedSupplier == null)
            {
                MessageBox.Show(string.Format("{0}!", eHCMSResources.Z0585_G1_PhNhapKgDuTTin), eHCMSResources.G0442_G1_TBao, MessageBoxButton.OK);
                return false;
            }

            if (CurrentInwardChemicalMedDeptInvoice.SelectedSupplier.SupplierID != CurrentInwardInvoiceCopy.SelectedSupplier.SupplierID)
            {
                MessageBox.Show(string.Format("{0}!", eHCMSResources.Z0586_G1_NCCDaThayDoi), eHCMSResources.G0442_G1_TBao, MessageBoxButton.OK);
                return false;
            }

            if (CurrentInwardChemicalMedDeptInvoice.CurrencyID != CurrentInwardInvoiceCopy.CurrencyID || CurrentInwardChemicalMedDeptInvoice.ExchangeRates != CurrentInwardInvoiceCopy.ExchangeRates || CurrentInwardChemicalMedDeptInvoice.VAT != CurrentInwardInvoiceCopy.VAT || CurrentInwardChemicalMedDeptInvoice.IsForeign != CurrentInwardInvoiceCopy.IsForeign || CurrentInwardChemicalMedDeptInvoice.Notes != CurrentInwardInvoiceCopy.Notes)
            {
                if (MessageBox.Show(eHCMSResources.Z0587_G1_CoMuonCNhatHD, eHCMSResources.G0442_G1_TBao, MessageBoxButton.OKCancel) == MessageBoxResult.OK)
                {
                    ...
                    {
                        CurrentInwardChemicalMedDeptInvoice = CurrentInwardInvoiceCopy;
                    }
                }
                else
                {
        ...
        private void InwardDrug_InsertList()
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginInwardChemicalMedDept_InsertList(DrugDeptPurchaseOrderDetailList.ToList(), CurrentInwardChemicalMedDeptInvoice.inviID, DrugDeptPoID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                contract.EndInwardChemicalMedDept_InsertList(asyncResult);
        ...
        private void AddBlankRow()
        {
            if (CheckBlankRow())
            {
                ...
                //    p.VAT = CurrentInwardChemicalMedDeptInvoice.VAT - 1;
                //}
        ...
        {
            long? SupplierID = 0;
            if (CurrentInwardChemicalMedDeptInvoice != null && CurrentInwardChemicalMedDeptInvoice.SelectedSupplier != null)
            {
                SupplierID = CurrentInwardChemicalMedDeptInvoice.SelectedSupplier.SupplierID;
            }
            int totalCount = 0;
            var t = new Thread(() =>
            {
        ...
        private void DeleteInwardDrug(long InID)
        {
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginDeleteInwardChemicalMedDept(InID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                int results = contract.EndDeleteInwardChemicalMedDept(asyncResult);
                                if (results == 0)
                                {
                                    Load_InwardChemicalDetails(CurrentInwardChemicalMedDeptInvoice.inviID);
                                    InwardChemicalMedDeptInvoice_GetListCost(CurrentInwardChemicalMedDeptInvoice.inviID);
        ...
        {
            if (CurrentInwardChemicalMedDeptInvoice.CanEditAndDelete)
            {
                if (MessageBox.Show(eHCMSResources.A0118_G1_Msg_ConfXoaDong, eHCMSResources.G0442_G1_TBao, MessageBoxButton.OKCancel) == MessageBoxResult.OK)
                {
        ...
        {
            if (CurrentInwardChemicalMedDeptInvoice.DrugDeptSupplierPaymentReqID != null && CurrentInwardChemicalMedDeptInvoice.DrugDeptSupplierPaymentReqID > 0)
            {
            ...
            {
                if (CurrentInwardChemicalMedDeptInvoice.SelectedCurrency != null && CurrentInwardChemicalMedDeptInvoice.SelectedCurrency.CurrencyID != (long)AllLookupValues.CurrencyTable.VND)
                {
                ...
                if (CurrentInwardChemicalMedDeptInvoice.CheckedPoint)
                {
        ...
        private void CheckEnableSupplier()
        {
            if ((DrugDeptPurchaseOrderDetailList != null && DrugDeptPurchaseOrderDetailList.Count > 0
                ...
                || (InwardChemicalMedDeptList != null && InwardChemicalMedDeptList.Count > 0))
            {
        ...
        public void OpenPopUpSearchInwardInvoice(IList<InwardDrugMedDeptInvoice> results, int Totalcount)
        {
            ...
            void onInitDlg(IDrugDeptInwardDrugSupplierSearch proAlloc)
            {
                ...
                {
                    proAlloc.strHienThi = eHCMSResources.R0816_G1_VTYTTieuHao.ToUpper();
                }
                ...
                {
                    proAlloc.strHienThi = eHCMSResources.T1616_G1_HC.ToUpper();
                }
                else
                {
        ...
        private void SearchInwardInvoiceChemical(int PageIndex, int PageSize)
        {
            if (SearchCriteria == null)
            {
                return;
            ...
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginSearchInwardChemicalMedDeptInvoice(SearchCriteria, TypID, V_MedProductType, PageIndex, PageSize, true, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                var results = contract.EndSearchInwardChemicalMedDeptInvoice(out int Totalcount, asyncResult);
                                if (results != null && results.Count > 0)
                                {
                                    if (results.Count > 1)
                                    {
                                    ...
                                    {
                                        CurrentInwardChemicalMedDeptInvoice = results.FirstOrDefault();
                                        InitDetailInward();
                                        DeepCopyInvoice();
        ...
        public void tbx_Search_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                ...
                SearchInwardInvoiceChemical(0, Globals.PageSize);
            }
        }
        ...
        public void Handle(DrugDeptCloseSearchSupplierEvent message)
        {
            ...
            {
                CurrentInwardChemicalMedDeptInvoice.SelectedSupplier = message.SelectedSupplier as DrugDeptSupplier;
                PharmacyPurchaseOrder_BySupplierID();
            }
        }
        ...
        public void btnPreview()
        {
            Action<IDrugDeptReportDocumentPreview> onInitDlg = delegate (IDrugDeptReportDocumentPreview proAlloc)
            {
                ...
                if (CurrentInwardChemicalMedDeptInvoice != null && CurrentInwardChemicalMedDeptInvoice.SelectedStaff != null)
                {
                    proAlloc.StaffFullName = CurrentInwardChemicalMedDeptInvoice.SelectedStaff.FullName;
                }
            };
        ...
        public void btnPrint()
        {
            ...
            var t = new Thread(() =>
            {
                using (var serviceFactory = new ReportServiceClient())
                {
                    ...
                    contract.BeginGetInWardChemicalInPdfFormat(CurrentInwardChemicalMedDeptInvoice.inviID, Globals.DispatchCallback((asyncResult) =>
                    {
                        try
                        {
                            var results = contract.EndGetInWardChemicalInPdfFormat(asyncResult);
        ...
        public void Handle(DrugDeptCloseSearchInwardIncoiceEvent message)
        {
            if (message != null && this.IsActive)
            {
                CurrentInwardChemicalMedDeptInvoice = message.SelectedInwardInvoice as InwardDrugMedDeptInvoice;
                InitDetailInward();
                DeepCopyInvoice();
                LoadInfoThenSelectedInvoice();
        ...
        private void InwardChemicalMedDeptInvoice_GetListCost(long inviID)
        {
            this.ShowBusyIndicator(eHCMSResources.Z0125_G1_DangXuLi);
            var t = new Thread(() =>
            {
                try
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginInwardChemicalMedDeptInvoice_GetListCost(inviID, Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
                                var results = contract.EndInwardChemicalMedDeptInvoice_GetListCost(asyncResult);
                                CurrentInwardChemicalMedDeptInvoice.CostTableMedDeptLists = results.ToObservableCollection();
                                SumTotalPercent();
                            }
                            catch (Exception ex)
                            {
        ...
        {
            TotalPercent = 0;
            if (CurrentInwardChemicalMedDeptInvoice != null && CurrentInwardChemicalMedDeptInvoice.CostTableMedDeptLists != null)
            {
                for (int i = 0; i < CurrentInwardChemicalMedDeptInvoice.CostTableMedDeptLists.Count; i++)
                {
                    TotalPercent += CurrentInwardChemicalMedDeptInvoice.CostTableMedDeptLists[i].Rates;
                }
            }
        }
        #endregion
        ...
        public void ActualQD_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                if (CurrentInwardChemicalMedDeptInvoice != null && CurrentInwardChemicalMedDeptInvoice.ExchangeRates != 0)
                {
                    try
                    {
                        CurrentInwardChemicalMedDeptInvoice.TotalPriceActual_QĐ = Convert.ToDecimal((sender as TextBox).Text);
                    }
                    catch
                    {
                        Globals.ShowMessage(eHCMSResources.A0559_G1_Msg_InfoGTriKhHopLe, eHCMSResources.T0074_G1_I);
                    }
                    CurrentInwardChemicalMedDeptInvoice.TotalPriceActual = CurrentInwardChemicalMedDeptInvoice.TotalPriceActual_QĐ / (decimal)CurrentInwardChemicalMedDeptInvoice.ExchangeRates;
                }
            }
        }
        ...
        public void Actual_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter)
            {
                if (CurrentInwardChemicalMedDeptInvoice != null)
                {
                    try
                    {
                        CurrentInwardChemicalMedDeptInvoice.TotalPriceActual = Convert.ToDecimal((sender as TextBox).Text);
                    }
                    catch
                    {
                        Globals.ShowMessage(eHCMSResources.A0559_G1_Msg_InfoGTriKhHopLe, eHCMSResources.T0074_G1_I);

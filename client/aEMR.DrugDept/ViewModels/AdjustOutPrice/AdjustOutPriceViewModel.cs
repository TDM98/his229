...
{
    [Export(typeof(IAdjustOutPrice)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class AdjustOutPriceViewModel : Conductor<object>, IAdjustOutPrice
    {
        ...
        public AdjustOutPriceViewModel(IWindsorContainer container, INavigationService navigationService, ISalePosCaching salePosCaching)
        {
            ...
            InwardDrugMedDeptGrid = new ObservableCollection<InwardDrugMedDept>();
        ...
        public void btnSave()
        {
            ...
            ObservableCollection<InwardDrugMedDept> inwardSave = InwardDrugMedDeptGrid.Where(x => x.EntityState == EntityState.MODIFIED).ToObservableCollection();
        ...
        private void CheckInwardDrugMedDeptModified(ObservableCollection<InwardDrugMedDept> inwardDrugs)
        {
            ...
            foreach (InwardDrugMedDept item in inwardDrugs)
            {
        ...
        private void SaveMedDeptAdjustOutPrice(ObservableCollection<InwardDrugMedDept> inwardSave)
        {
            ...
            var t = new Thread(() =>
            {
                using (var serviceFactory = new PharmacyMedDeptServiceClient())
                {
                    ...
                    contract.BeginMedDeptAdjustOutPrice(inwardSave, Globals.DispatchCallback((asyncResult) =>
                    {

                        try
                        {
                            bool results = contract.EndMedDeptAdjustOutPrice(asyncResult);
        ...
        private ObservableCollection<InwardDrugMedDept> _InwardDrugMedDeptList;
        public ObservableCollection<InwardDrugMedDept> InwardDrugMedDeptList
        {
        ...
        private ObservableCollection<InwardDrugMedDept> _InwardDrugMedDeptGroup;
        public ObservableCollection<InwardDrugMedDept> InwardDrugMedDeptGroup
        {
        ...
        private InwardDrugMedDept _SelectedInwardDrugMedDept;
        public InwardDrugMedDept SelectedInwardDrugMedDept
        {
        ...
        private InwardDrugMedDept _SelectedInwardDrugInGrid;
        public InwardDrugMedDept SelectedInwardDrugInGrid
        {
        ...
        private ObservableCollection<InwardDrugMedDept> _InwardDrugMedDeptGrid;
        public ObservableCollection<InwardDrugMedDept> InwardDrugMedDeptGrid
        {
        ...
        private void SearchInwardDrugMedDept(string Name, bool IsCode)
        {
            ...
            var t = new Thread(() =>
            {
                ...
                {
                    var contract = serviceFactory.ServiceInstance;
                    contract.BeginGetInwardDrugMedDeptForAdjustOutPrice(StoreID, IsCode, Name, V_MedProductType, Globals.DispatchCallback((asyncResult) =>
                    {

                        try
                        {
                            var results = contract.EndGetInwardDrugMedDeptForAdjustOutPrice(asyncResult);
        ...
        private void ListDisplayAutoComplete(bool IsCode)
        {
            ...
            InwardDrugMedDeptGroup = new ObservableCollection<InwardDrugMedDept>();
            foreach (var i in inwardGroup)
            {
                InwardDrugMedDept inward = new InwardDrugMedDept();
        ...
        public void AddItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            ObservableCollection<InwardDrugMedDept> tempList = InwardDrugMedDeptList.Where(x => x.RefGenMedProductDetails.GenMedProductID == SelectedInwardDrugMedDept.RefGenMedProductDetails.GenMedProductID).ToObservableCollection();
            ...
            foreach (InwardDrugMedDept item in tempList)
            {               

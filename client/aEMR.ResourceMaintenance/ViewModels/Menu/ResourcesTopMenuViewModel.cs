...
{
    [Export(typeof(IResourcesTopMenu)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class ResourcesTopMenuViewModel : Conductor<object>, IResourcesTopMenu
    {
        ...
        public ResourcesTopMenuViewModel(IWindsorContainer container, INavigationService navigationService, ISalePosCaching salePosCaching)
        {

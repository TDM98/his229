...
{
    [Export(typeof (ISATQuaThucQuanQuyTrinh)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class SATQuaThucQuanQuyTrinhViewModel : Conductor<object>, ISATQuaThucQuanQuyTrinh
    {
        ...
        public SATQuaThucQuanQuyTrinhViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventAggregator, ISalePosCaching salePosCaching)
        {

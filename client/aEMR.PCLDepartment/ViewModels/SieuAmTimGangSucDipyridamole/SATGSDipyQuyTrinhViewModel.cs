...
{
    [Export(typeof (ISATGSDipyQuyTrinh)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class SATGSDipyQuyTrinhViewModel : Conductor<object>, ISATGSDipyQuyTrinh
    {
        ...
        public SATGSDipyQuyTrinhViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventArg)
        {
            LstYear = GetLstYear();

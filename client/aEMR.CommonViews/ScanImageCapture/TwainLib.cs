//////////////////////////////////////////////////////////////////
///
/// Written by: http://www.codeproject.com/Members/NETMaster 
/// Published: http://www.codeproject.com/KB/dotnet/twaindotnet.aspx
/// 
/// Minor modifications - Baruch Nissenbaum, Jan 2011 rnd@ibn-labs.com
/// 
...
namespace aEMR.CommonViews
{
    ...
    public class Twain
	{
	    ...
	    public TwainCommand PassMessage( ref Message m )
		{
		    ...
		    int pos = Win32.GetMessagePos();

		    winmsg.hwnd		= m.HWnd;
		    winmsg.message	= m.Msg;
		    winmsg.wParam	= m.WParam;
		    winmsg.lParam	= m.LParam;
		    winmsg.time		= Win32.GetMessageTime();
		    winmsg.x		= (short) pos;
        ...
        */
        ...
        //    get {
        //        IntPtr screenDC = Win32.CreateDC( "DISPLAY", null, null, IntPtr.Zero );
        //        int bitDepth = Win32.GetDeviceCaps(screenDC, 12);
        //        bitDepth *= Win32.GetDeviceCaps(screenDC, 14);

...
/// 
/// Additional information about twain definitions can be found at http://twain.org/devfiles/twain.h
/// 
...
// ------------------- STRUCTS --------------------------------------------
	...
	{									// TW_CAPABILITY
	    ...
	    public TwCapability( TwCap cap, short sval )
		{
		    ...
		    Handle = Win32.GlobalAlloc( 0x42, 6 );
            IntPtr pv = Win32.GlobalLock(Handle);

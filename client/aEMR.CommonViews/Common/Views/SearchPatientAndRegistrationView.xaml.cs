...
{
    public partial class SearchPatientAndRegistrationView : UserControl, ISearchPatientAndRegistrationView
    {
        public SearchPatientAndRegistrationView()
        {
            InitializeComponent();
            authorization();
        }
        ...
        public Button SearchAppointmentsKSKButton
        {
            get { return this.SearchAppointmentKSKCmd; }
        }
        ...
        public void InitButtonVisibility(SearchRegButtonsVisibility values)
        {
            ...
            SearchAppointmentsKSKButton.Visibility = BoolToVisibility((values & SearchRegButtonsVisibility.SHOW_SEARCH_APPOINTMENT) == SearchRegButtonsVisibility.SHOW_SEARCH_APPOINTMENT);
        }

...
//{
//    [Export(typeof(IeInPrescriptionOld)), PartCreationPolicy(CreationPolicy.NonShared)]
//    public partial class eInPrescriptionOldViewModel : ViewModelBase, IeInPrescriptionOld
...
//        public eInPrescriptionOldViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventArg, ISalePosCaching salePosCaching)
//        {
...
//            DrugList.OnRefresh += new EventHandler<RefreshEventArgs>(DrugList_OnRefresh);
...
//        void DrugList_OnRefresh(object sender, RefreshEventArgs e)
//        {
...
//                    NotifyOfPropertyChange(() => PrintInfoBH);
//                }
//            }
//        }
...
//                //if (idx == (int)DataGridCol.HI)
//                //{
//                //    PrescriptionDetail tmp = e.Row.DataContext as PrescriptionDetail;
//                //    if (!tmp.isHICheck)
//                //    {
//                //        CheckBox obj = grdPrescription.Columns[idx].GetCellContent(e.Row) as CheckBox;
//                //        obj.IsChecked = false;
//                //        obj.IsEnabled = false;
//                //    }
//                //    else
...
//        private void SearchDrugForPrescription_Paging(long? StoreID, int PageIndex, int PageSize, bool CountTotal, bool IsSearchByGenericName = false)
//        {
//            DrugList.Clear();
...
//        {
//            if (grdPrescription != null && grdPrescription.SelectedItem != null && AutoGenMedProduct != null && AutoGenMedProduct.SelectedItem != null)
//            {
...
//            }
//        }
//        public void DrugInstructionNotes_SelectionChanged(object sender, SelectionChangedEventArgs e)
//        {
//            if (grdPrescription != null && grdPrescription.SelectedItem != null && ((AxAutoComplete)sender) != null)
//            {
//                if (((AxAutoComplete)sender).SelectedItem != null)
...
//            }
//        }
//        public void DrugAdministration_SelectionChanged(object sender, SelectionChangedEventArgs e)
//        {
//            if (grdPrescription != null && grdPrescription.SelectedItem != null && ((AxAutoComplete)sender) != null)
//            {
//                if (((AxAutoComplete)sender).SelectedItem != null)
...
//                    MessageBox.Show(string.Format("{0} {1}!", eHCMSResources.K0077_G1_ThuocUongTheoLichTuan, eHCMSResources.K0078_G1_VaoLichTuanDeChSua));
//                    return false;
//            }
//            return true;
//        }
...
//                                    default:
//                                        {
//                                            MessageBox.Show(OutError + Environment.NewLine + eHCMSResources.I0924_G1_I);
//                                            break;
//                                        }
//                                }
//                            }
...
//                                {
//                                    if (xNgayBHToiDa_NgoaiTru > item.SelectedDrugForPrescription.MaxDayPrescribed)
//                                    {
//                                        item.DayRpts = tmp;
//                                        item.DayExtended = 0;
//                                    }
...
//                            if (item.SelectedDrugForPrescription.MaxDayPrescribed != null && item.SelectedDrugForPrescription.MaxDayPrescribed != 0)
//                            {
//                                //if (item.SelectedDrugForPrescription.MaxDayPrescribed > tmp)//----check lai cho nay
//                                {
//                                    if (xNgayBHToiDa_NoiTru > item.SelectedDrugForPrescription.MaxDayPrescribed)
//                                    {
//                                        item.DayRpts = tmp;
//                                        item.DayExtended = 0;
//                                    }
...
//            {
//                MessageBox.Show(string.Format("{0} {1}", eHCMSResources.K0063_G1_ThuocNgoaiDMuc, eHCMSResources.K0062_G1_KhongDuocPhepChSua), eHCMSResources.G0442_G1_TBao, MessageBoxButton.OK);
//                return;
//            }
//            if (!SelectedPrescriptionDetail.HasSchedules)
//            {
//                MessageBox.Show(eHCMSResources.Z1019_G1_ChonLoaiThuocUongTheoLich, eHCMSResources.G0442_G1_TBao, MessageBoxButton.OK);
//                return;
//            }
...
//                        typeInfo.IsMaxDay = typeInfo.ObjPrescriptionDetail.SelectedDrugForPrescription != null
...
//                                {
//                                    if (item.SelectedDrugForPrescription.MaxDayPrescribed != null && item.SelectedDrugForPrescription.MaxDayPrescribed > 0 && item.SelectedDrugForPrescription.MaxDayPrescribed < (item.DayExtended + item.DayRpts))
//                                    {
...
//                        if (Math.Abs(Tong - Objtmp.Qty) > 0.0001)
//                        //==== 20161205 CMN End.
//                        {
//                            return true;
//                        }
...
//            {
//                if (
//                    MessageBox.Show(eHCMSResources.A0982_G1_Msg_ConfCNhatSoNgDungThuoc2, eHCMSResources.G0442_G1_TBao,
...
//                    {
//                        if (MessageBox.Show(eHCMSResources.A0982_G1_Msg_ConfCNhatSoNgDungThuoc2, eHCMSResources.G0442_G1_TBao, MessageBoxButton.OKCancel) == MessageBoxResult.OK)
//                        {
//                            AutoAdjustCancelDrugShortDays();
//                            SoNgayDungThuoc_Root = LatestePrecriptions.NDay;
//                        }
...
//            {
//                MessageBox.Show(string.Format(eHCMSResources.Z0989_G1_ThuocDaCoCDinhUongTheoTuan, SelectedPrescriptionDetail.SelectedDrugForPrescription.BrandName.Trim()));
//                return;
//            }
...
//        {
//            get { return Globals.PatientAllDetails.PtRegistrationInfo != null && LatestePrecriptions != null && LatestePrecriptions.ServiceRecID.GetValueOrDefault() > 0 && LatestePrecriptions.PtRegistrationID.GetValueOrDefault() == Globals.PatientAllDetails.PtRegistrationInfo.PtRegistrationID && Globals.PatientAllDetails.PtRegistrationInfo.HisID > 0; }
//        }

...
{
    [Export(typeof(ICMDrugList)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class CMDrugListViewModel : Conductor<object>, ICMDrugList
        , IHandle<Drug_AddEditViewModel_Save_Event>
    {
        [ImportingConstructor]
        public CMDrugListViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventArg, ISalePosCaching salePosCaching)
        {

 ...
 * 20230408 #008 QTD: Thêm nhóm thầu
 */
namespace aEMR.Common.ViewModels
{
    [Export(typeof(IDrugDept_MedDevAndChem_AddEdit)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class DrugDept_MedDevAndChem_AddEditViewModel : ViewModelBase, IDrugDept_MedDevAndChem_AddEdit
        ...
        , IHandle<ChooseDrugClass>
    {
        ...
        public DrugDept_MedDevAndChem_AddEditViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventArg, ISalePosCaching salePosCaching)
        {
        ...
        public ObservableCollection<string> HIGroupCodeCollection { get { return _HIGroupCodeCollection; }
            set {
        ...
        //▼====:008
        public bool IsShowBidGroup
        {
            get
            {
                return Globals.ServerConfigSection.CommonItems.ApplyReport130 && V_MedProductType == (long)AllLookupValues.MedProductType.Y_CU;
            }
        }
        //▲====:008
    }

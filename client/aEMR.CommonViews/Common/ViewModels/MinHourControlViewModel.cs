...
{
    [Export(typeof(IMinHourControl)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class MinHourControlViewModel : Conductor<object>, IMinHourControl
    {
        private readonly INavigationService _navigationService;
        private readonly ISalePosCaching _salePosCaching;
        private readonly ILogger _logger;
        [ImportingConstructor]
        public MinHourControlViewModel(IWindsorContainer container, INavigationService navigationService, ISalePosCaching salePosCaching)
        {

...
{
    [Export(typeof(IRegistrationSummaryV3)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class RegistrationSummaryV3ViewModel : Conductor<object>, IRegistrationSummaryV3
        ...
        , IHandle<ItemSelected<Patient>>
    {
        ...
        public RegistrationSummaryV3ViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventAggregator, ISalePosCaching salePosCaching)
        {
        ...
        //private bool _isSavingRegistration;
        //public bool IsSavingRegistration
        //{
        //    get { return _isSavingRegistration; }
        //    set
        //    {
        //        _isSavingRegistration = value;
        //        NotifyOfPropertyChange(() => IsSavingRegistration);
        //        NotifyOfPropertyChange(() => CanSaveAndPayForNewServiceCmd);
        //        NotifyOfPropertyChange(() => CanSaveNewServicesAndPclCmd);
        //        NotifyOfPropertyChange(() => CanSaveAndPayForOldServiceCmd);
        //        NotifyOfPropertyChange(() => CanUpdateRegistrationCmd);
        ...
        public IEnumerator<IResult> PayForNewService()
        {
            ...
            if (Globals.ServerConfigSection.HealthInsurances.UseConfirmRecalcHIOutPt)
            {
                Action<IComplicatedPay> onInitDlg = delegate (IComplicatedPay vm)
                {
                ...
                GlobalsNAV.ShowDialog<IComplicatedPay>(onInitDlg);
            }
            else
            {
        ...
        //KMx: Sửa lại thành Coroutine để làm cảnh báo hết hạn BH khi tính tiền (12/11/2014 14:23).
        //public void PayForNewServiceCmd()
        //{
        //    if (CurrentRegistration == null)
        //    {
        ...
        //    bool HIExpired = CheckHIExpired();
        //    if (HIExpired)
        //    {
        //        if (_currentRegistration.PatientRegistrationDetails != null)
        //        {
        //            if (_currentRegistration.PatientRegistrationDetails.Any(item => item.PaidTime == null && item.HIBenefit > 0))
        //            {
        //                MessageBox.Show("Thẻ bảo hiểm đã hết hạn ngày " + _currentRegistration.HealthInsurance.ValidDateTo.GetValueOrDefault().ToShortDateString() + " nên không thể tính tiền những dịch vụ được tính bảo hiểm. Hãy xóa dịch vụ được tính bảo hiểm và thêm vào lại", eHCMSResources.G0442_G1_TBao, MessageBoxButton.OK);
        //                return;
        //            }
        //        }
        ...
        //                    continue;
        //                }
        //                if (request.PatientPCLRequestIndicators.Any(item => item.PaidTime == null && item.HIBenefit > 0))
        //                {
        //                    MessageBox.Show("Thẻ bảo hiểm đã hết hạn ngày " + _currentRegistration.HealthInsurance.ValidDateTo.GetValueOrDefault().ToShortDateString() + " nên không thể tính tiền những dịch vụ được tính bảo hiểm. Hãy xóa dịch vụ được tính bảo hiểm và thêm vào lại", eHCMSResources.G0442_G1_TBao, MessageBoxButton.OK);
        //                    return;
        ...
        //    if (bMustRefund)
        //    {
        //        MessageBox.Show("Đã có một vài dịch vụ bị xóa mà chưa hoàn tiền. Hãy chuyển sang Tab \"Các Dịch vụ đã thanh toán\" để hoàn tiền cho bệnh nhân. Sau đó mới thanh toán nốt những dịch vụ này.");
        //        return;
        //    }
        //    /////////////////////////////////////////////////////////////
        //    List<PatientRegistrationDetail> lsRegDetails = null;
        ...
        private IEnumerator<IResult> DoAddRegItem(RefMedicalServiceItem serviceItem, DeptLocation deptLoc, RefMedicalServiceType serviceType)
        {
            ...
            if (serviceItem.RefMedicalServiceType.V_RefMedicalServiceTypes != (long)AllLookupValues.V_RefMedicalServiceTypes.CANLAMSANG)
            {
                ...
                AddNewRegistrationDetails(serviceItem, deptLoc, serviceType);
        ...
        private void AddNewRegistrationDetails(RefMedicalServiceItem serviceItem, DeptLocation deptLoc, RefMedicalServiceType serviceType)
        {
        ...
        public void AddNewService(RefMedicalServiceItem serviceItem, DeptLocation deptLoc, RefMedicalServiceType serviceType)
        {
            Coroutine.BeginExecute(DoAddRegItem(serviceItem, deptLoc, serviceType));
        }
        ...
        public void Count15HIPercentCmd()
        {
            ...
            ////IsSavingRegistration = true;
            //this.ShowBusyIndicator("Đang lưu đăng ký");
            //Coroutine.BeginExecute(CountAgainDoSaveAndPayOldServices(true), null, (o, e) =>
            //{
            //    //IsSavingRegistration = false;
            //    this.HideBusyIndicator();
            //});

...
{
    [Export(typeof(IChemicalListing)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class ChemicalListingViewModel : Conductor<object>, IChemicalListing
    {
        ...
        public ChemicalListingViewModel(IWindsorContainer container, INavigationService navigationService, ISalePosCaching salePosCaching)
        {
            ...
            _searchCriteria.MedProductType = AllLookupValues.MedProductType.HOA_CHAT;
        }
        ...
        public void PopulatingCmd(object source, PopulatingEventArgs eventArgs)
        {
            ...
            {
                MessageBox.Show(eHCMSResources.Z0614_G1_ChonKhoTruocKhiTimDSHChat);
                return;
            }

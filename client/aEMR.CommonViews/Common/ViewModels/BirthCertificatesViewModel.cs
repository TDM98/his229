...
{
    [Export(typeof(IBirthCertificates)), PartCreationPolicy(CreationPolicy.NonShared)]
    public partial class BirthCertificatesViewModel : Conductor<object>, IBirthCertificates
    {
        ...
        public BirthCertificatesViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventArg, ISalePosCaching salePosCaching)
        {
            BirthDate = Globals.GetViewModel<IMinHourDateControl>();
            BirthDate.DateTime = null;

            _eventArg = eventArg;
            TitleForm = eHCMSResources.Z3115_G1_GiayChungSinh;
            LoadCountries();
            LoadEthnicsList();
            LoadGenders();
            //▼====: #005
        ...
        private void SaveBirthCertificates(bool IsDelete)
        {
            ...
            if (String.IsNullOrEmpty(PtRegistration.Patient.IDNumber.Trim()))
            {

...
{
    [Export(typeof(IInPatientSelectGeneralSugery)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class InPatientSelectGeneralSugeryViewModel : Conductor<object>, IInPatientSelectGeneralSugery
    {
        ...
        public InPatientSelectGeneralSugeryViewModel(IWindsorContainer container, INavigationService navigationService, ISalePosCaching salePosCaching)
        {
                ...
                try
                {
                    using (var serviceFactory = new PatientRegistrationServiceClient())
                    {
                        ...
                        contract.BeginGetAllMedicalServiceItemsByType(serviceTypeID, CurrentInPatientAdmDisDetail == null ? null : CurrentInPatientAdmDisDetail.MedServiceItemPriceListID,
                            (long)AllLookupValues.V_RefMedicalServiceTypes.THUTHUAT, Globals.DispatchCallback((asyncResult) =>
                            {

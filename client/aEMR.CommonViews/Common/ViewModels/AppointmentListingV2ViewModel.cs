...
{
    [Export(typeof(IAppointmentListingV2)),PartCreationPolicy(CreationPolicy.NonShared)]
    public class AppointmentListingV2ViewModel : ViewModelBase, IAppointmentListingV2
        ...
        , IHandle<UpdateCompleted<PatientAppointment>>
    {
        ...
        public AppointmentListingV2ViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventAgr, ISalePosCaching salePosCaching)
        {

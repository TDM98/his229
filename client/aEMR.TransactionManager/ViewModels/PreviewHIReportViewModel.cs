...
{
    [Export(typeof(IPreviewHIReport)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class PreviewHIReportViewModel : ViewModelBase, IPreviewHIReport
    {
        [ImportingConstructor]
        public PreviewHIReportViewModel(IWindsorContainer aContainer, INavigationService aNavigation, ISalePosCaching aCaching)
        {
        }

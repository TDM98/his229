...
/*
* 20210704 #001 TNHX:   385 Lấy giờ tạo STT từ QMS làm giờ vào viện nếu có
*/
namespace aEMR.Registration.ViewModels
{
    [Export(typeof(IPatientRegistrationNew)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class PatientRegistrationNewViewModel : HandlePayCompletedViewModelBase, IPatientRegistrationNew
        ...
        
    {
        ...
        public PatientRegistrationNewViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventArg)
        {
            _eventArg = eventArg;
            Initialize();
        ...
        private List<ScanImageFileStorageDetail> ScanImageFilesToDeleted = null;

        public void TestScanCmd()
        {
            ...
            Action<IScanImageCapture> onInitDlg = delegate (IScanImageCapture vm)
            {
                ...
                vm.PtRegistrationID = (CurRegistration != null && CurRegistration.PtRegistrationID > 0 ? CurRegistration.PtRegistrationID : 0);
            };
        ...
        public void TestSaveScanCmd()
        {
            SaveScanImageFiletoServer();
        }


        private void SaveScanImageFiletoServer()
        {
            ...
            var t = new Thread(() =>
            {
                using (var serviceFactory = new PCLsImportClient())
                {
                    ...
                    try
                    {
                        contract.BeginAddScanFileStorageDetails(Globals.LoggedUserAccount.StaffID.GetValueOrDefault(), CurrentPatient.PatientID, CurRegistration.PtRegistrationID,
                            CurrentPatient.PatientCode, NewScanImageFilesToBeSave, new List<ScanImageFileStorageDetail>(), Globals.DispatchCallback((asyncResult) =>
                            {
                                try
                                {
            ...
            if (message != null)
            {
                ...
                if (result == MessageBoxResult.OK)
                {
                    ...
                    if (criteria != null)
                    {
                        ...
                        if (PatientDetailsContent.QRCode != null)
                        {
        ...
        public void DoCreateNewRegistration(bool forNewPatient = true, bool confirm = false)
        {
            ...
            if (_currentView == null)
                _currentView = (IPatientRegistrationNewView)GetView();
            if (_currentView != null)
            {

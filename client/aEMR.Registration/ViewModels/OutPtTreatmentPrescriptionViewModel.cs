...
* 20200619 #010 TTM:    BM 0039267: Bán thuốc cho điều trị ngoại trú
*/

namespace aEMR.Registration.ViewModels
{
    [Export(typeof(IOutPtTreatmentPrescription)), PartCreationPolicy(CreationPolicy.NonShared)]
    public partial class OutPtTreatmentPrescriptionViewModel: Common.ViewModels.PharmacyHandlePayCompletedViewModelBase, IOutPtTreatmentPrescription
        ...
        , IHandle<RemoveItem<InPatientBillingInvoice>>
    {
        ...
        public OutPtTreatmentPrescriptionViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventArg)
        {
            authorization();
            //==== #001
        ...
        private void LoadInfoCommon()
        {
            if (SelectedPrescription != null)
            {
                ...
                strNgayDung = "";
                ((OutPtTreatmentPrescriptionView)this.GetView()).AutoDrug_Text.Text = "";
                ((OutPtTreatmentPrescriptionView)this.GetView()).chbBH.IsChecked = false;
                //---------------------------------------------------------
                SelectedOutInvoice = null;
                SelectedOutInvoice = new OutwardDrugInvoice();
                SelectedOutInvoice.OutDate = Globals.ServerDate.Value;
        ...
        public void btnPrint12()
        {
            ...
            {
                proAlloc.ID = SelectedOutInvoice.PtRegistrationID.GetValueOrDefault(0);
                // Điều trị ngoại trú thì áp trực tiếp

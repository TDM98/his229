...
using resources = aEMR.Controls.Data.Input.Resources;
...
namespace aEMR.Controls
{
    ...
    public class DescriptionViewer : Control
    {
        ...
        /// </summary>
        new public static readonly DependencyProperty IsFocusedProperty =
            DependencyProperty.Register(
            "IsFocused",
            typeof(bool),
            typeof(DescriptionViewer),
        ...
        private static void OnTargetPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (dv != null)
            {
                bool targetFocused = e.NewValue == System.Windows.Input.FocusManager.GetFocusedElement(dv);
                ...
                if (oldElement != null)
                {
                    // TxD 18/05/2018 FrameworkElement in WPF DOES NOT HAVE BindingValidationError
                    //      BECAUSE the way WPF Validate Data Object Error is different to Silverlight
                    //      The following is COMMENTED OUT for now ==> To Be Reviewed and REDO

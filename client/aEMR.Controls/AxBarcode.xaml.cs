...
{
    public partial class AxBarcode : UserControl, INotifyPropertyChanged
    {
        ...
        public ObservableCollection<BarcodeItem> BarCodeItems
        {
            get
            {
    ...
    public class BarcodeEngine
    {
        ...
        private string codeType = BarCodeType.Code128A;
        public string CodeType
        {
            get
            {
    ...
    public static class BarCodeType
    {
        ...
        public const string Code128A = "Code128A";
        public const string Code128B = "Code128B";
        public const string Code128C = "Code128C";
    }
}
    ...
    public class TextBoxEnterButtonInvoke : TargetedTriggerAction<ButtonBase>
    {
        ...
        protected override void Invoke(object parameter)
        {
            ...
            if (null != keyEventArgs && keyEventArgs.Key == Key.Enter)
            {
                ...
                {
                    if (keyEventArgs.OriginalSource as PasswordBox!=null)
                    {
                        var binding = ((PasswordBox)this.AssociatedObject).GetBindingExpression(PasswordBox.DataContextProperty);
                        if (binding != null)
                    ...
                    {
                        var binding = ((TextBox)this.AssociatedObject).GetBindingExpression(TextBox.TextProperty);
                        if (binding != null)
                            binding.UpdateSource();

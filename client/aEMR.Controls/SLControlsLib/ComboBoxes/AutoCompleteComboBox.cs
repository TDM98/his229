        ...
        protected override void OnPopulated(PopulatedEventArgs e)
        {
            ...
            if (listBox != null)
            {
                ...
                if (this.ItemsSource!=null && this.SelectedItem != null)
                {
                    ...
                    //    //listBox.UpdateLayout();
                    //});
                    // TxD 25/05/2018 Modified the above to create an action of delegate type then pass it to BeginInvoke.
                    Action actDelegate = delegate()
                    {
                        listBox.UpdateLayout();
                        listBox.ScrollIntoView(listBox.SelectedItem);
                    };
                    listBox.Dispatcher.BeginInvoke(actDelegate);
                }
            }
        }
                ...
                if (!string.IsNullOrEmpty(propertyPath))
                {
                    ...
                    {                        
                        ...
                        if (bindingExpression != null)
                        {
                            ...
                            if (dataItem.GetType().GetProperty(propertyPathForSelectedValue) != null)
                            {

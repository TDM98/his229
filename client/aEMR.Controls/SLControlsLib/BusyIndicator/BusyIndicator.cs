...
namespace aEMR.Controls
{
    ...
    /// </summary>
    [TemplateVisualState(Name = BusyIndicator_VisualStates.StateIdle, GroupName = BusyIndicator_VisualStates.GroupBusyStatus)]
    [TemplateVisualState(Name = BusyIndicator_VisualStates.StateBusy, GroupName = BusyIndicator_VisualStates.GroupBusyStatus)]
    [TemplateVisualState(Name = BusyIndicator_VisualStates.StateVisible, GroupName = BusyIndicator_VisualStates.GroupVisibility)]
    [TemplateVisualState(Name = BusyIndicator_VisualStates.StateHidden, GroupName = BusyIndicator_VisualStates.GroupVisibility)]
    ...
    public class BusyIndicator : ContentControl
    {
        ...
        {
            VisualStateManager.GoToState(this, IsBusy ? BusyIndicator_VisualStates.StateBusy : BusyIndicator_VisualStates.StateIdle, useTransitions);
            VisualStateManager.GoToState(this, IsContentVisible ? BusyIndicator_VisualStates.StateVisible : BusyIndicator_VisualStates.StateHidden, useTransitions);
        }

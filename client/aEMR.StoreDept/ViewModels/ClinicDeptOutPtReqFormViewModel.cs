...
{
    [Export(typeof(IClinicDeptOutPtReqForm)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class ClinicDeptOutPtReqFormViewModel : Conductor<object>, IClinicDeptOutPtReqForm
        ...
        , IHandle<ReloadInPatientRequestingDrugListByReqID>
    {
        ...
        public ClinicDeptOutPtReqFormViewModel(IWindsorContainer container, INavigationService navigationService, IEventAggregator eventArg)
        {
            Authorization();
        ...
        private void GetInPatientRequestingDrugListByReqID(long RequestID, bool bCreateNewListFromOld = false)
        {
            ...
            try
            {
                var t = new Thread(() =>
                {
                    ...
                    {
                        var contract = serviceFactory.ServiceInstance;
                        contract.BeginGetReqOutwardDrugClinicDeptPatientByID(RequestID, bCreateNewListFromOld, (long)AllLookupValues.RegistrationType.NGOAI_TRU
                            , Globals.DispatchCallback((asyncResult) =>
                        {
                            try
                            {
        ...
        {
            if (((ClinicDeptOutPtReqFormView)this.GetView()).grdReqOutwardDetails != null)
            {
                ...
                {
                    RemoveMark(((ClinicDeptOutPtReqFormView)this.GetView()).grdReqOutwardDetails.SelectedItem);
        ...
        {
            if (((ClinicDeptOutPtReqFormView)this.GetView()).grdReqOutwardDetails != null) // && ((ClinicDeptOutPtReqFormView)this.GetView()).grdReqOutwardDetails.IsValid)
            {
                if (CheckValidGrid())
                {
                    SaveRequest();
        ...
        public void Handle(PatientSelectedGoToKhamBenh_InPt<PatientRegistration> message)
        {
            if (GetView() != null && message != null && message.Item != null)
            {
                ...
                CurrentReqOutwardDrugClinicDeptPatient.OutPtRegistrationID = message.Item.PtRegistrationID;
        ...
        {
            if (((ClinicDeptOutPtReqFormView)GetView()).grdReqOutwardDetails != null)
            {
                if (RequestDrug.CanSave)
                {
                    ((ClinicDeptOutPtReqFormView)GetView()).grdReqOutwardDetails.Columns[(int)DataGridCol.ColDelete].Visibility = Visibility.Visible;
                    ((ClinicDeptOutPtReqFormView)GetView()).grdReqOutwardDetails.Columns[(int)DataGridCol.ColMultiDelete].Visibility = Visibility.Visible;
                }
                else
                {
                    ((ClinicDeptOutPtReqFormView)GetView()).grdReqOutwardDetails.Columns[(int)DataGridCol.ColDelete].Visibility = Visibility.Collapsed;
                    ((ClinicDeptOutPtReqFormView)GetView()).grdReqOutwardDetails.Columns[(int)DataGridCol.ColMultiDelete].Visibility = Visibility.Collapsed;
                }
            }
        }
        ...
        private void CloseOrOpenGroups(bool bClosed)
        {
            ...
            //AxDataGridNy theGrid = ((ClinicDeptOutPtReqFormView)this.GetView()).grdReqOutwardDetails;
            ////ChangedWPF - CMN

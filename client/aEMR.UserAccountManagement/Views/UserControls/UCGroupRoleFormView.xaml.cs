...
{
    public partial class UCGroupRoleFormView : UserControl
    {
        
        public UCGroupRoleFormView()
        {
            InitializeComponent();
        ...
        public void ModulesTreeVM_AddNewGroupRolesCompleted(object sender, EventArgs e)
        {

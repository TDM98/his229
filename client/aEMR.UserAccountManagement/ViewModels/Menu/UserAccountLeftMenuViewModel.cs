...
{
    [Export(typeof(IUserAccountLeftMenu)), PartCreationPolicy(CreationPolicy.NonShared)]
    public class UserAccountLeftMenuViewModel : Conductor<object>, IUserAccountLeftMenu
    {
        ...
        public UserAccountLeftMenuViewModel(IWindsorContainer container, INavigationService navigationService, ISalePosCaching salePosCaching)
        {
        ...
        public void authorization()
        {
            ...
            bUserConfigCmd = Globals.CheckFunction(Globals.listRefModule, (int)eModules.mUserAccount
                        , (int)eUserAccount.mPtUserConfig);
